...
The main folders are:
    ...
    (this folder)   Where the Python3 scripts/programs to handle the data are stored
                        ...
                        Python may automatically generate .pyc files when these scripts/programs are run
    ...
    Tests           Where the Python3 scripts to test the above are stored
                        The test scripts should not be run from this folder, but rather from the containing folder.
