...
#
# Greek.py
#   Last modified: 2013-05-07 (also update versionString below)
#
...
morphgntBooks = ['MAT', 'MRK', 'LUK', 'JHN', 'ACT', \
                    'ROM', 'CO1', 'CO2', 'GAL', 'EPH', 'PHP', 'COL', 'TH1', 'TH2', 'TI1', 'TI2', 'TIT', 'PHM', \
                    'HEB', 'JAM', 'PE1', 'PE2', 'JN1', 'JN2', 'JN3', 'JDE', 'REV' ]

morphgntFilenames = OrderedDict( [ ('MAT','61-Mt-morphgnt.txt'), ('MRK','62-Mk-morphgnt.txt'), ('LUK','63-Lk-morphgnt.txt'), ('JHN','64-Jn-morphgnt.txt'), ('ACT','65-Ac-morphgnt.txt'),
                    ('ROM','66-Ro-morphgnt.txt'), ('CO1','67-1Co-morphgnt.txt'), ('CO2','68-2Co-morphgnt.txt'), ('GAL','69-Ga-morphgnt.txt'), ('EPH','70-Eph-morphgnt.txt'),
                    ('PHP','71-Php-morphgnt.txt'), ('COL','72-Col-morphgnt.txt'), ('TH1','73-1Th-morphgnt.txt'), ('TH2','74-2Th-morphgnt.txt'),
                    ('TI1','75-1Ti-morphgnt.txt'), ('TI2','76-2Ti-morphgnt.txt'), ('TIT','77-Tit-morphgnt.txt'), ('PHM','78-Phm-morphgnt.txt'), ('HEB','79-Heb-morphgnt.txt'),
                    ('JAM','80-Jas-morphgnt.txt'), ('PE1','81-1Pe-morphgnt.txt'), ('PE2','82-2Pe-morphgnt.txt'),
                    ('JN1','83-1Jn-morphgnt.txt'), ('JN2','84-2Jn-morphgnt.txt'), ('JN3','85-3Jn-morphgnt.txt'), ('JDE','86-Jud-morphgnt.txt'), ('REV','87-Re-morphgnt.txt' ) ] )
