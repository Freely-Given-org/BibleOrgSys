...
def GoBibleFileCheck( givenPathname, strictCheck=True, autoLoad=False, autoLoadBooks=False ):
    """
    ...
    if givenPathname.endswith( GOBIBLE_FILENAME_END ): # it's a zipped Java object
...
def demo():
    ...
    testFolders =  (
        '../../../../../Data/Work/Bibles/GoBible modules/Haiola GoBible test versions/',
