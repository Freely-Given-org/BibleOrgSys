...
class USFM2MarkersConverter:
    ...
    def __load( self, XMLFileOrFilepath ):
        ...
        vPrint( 'Info', DEBUGGING_THIS_MODULE, f"Loading USFM2Markers XML file from {self.__XMLFileOrFilepath!r}…" )
    ...
    def importDataToPython( self ):
        ...
        for element in self._XMLTree:
            ...
            if  closed not in ( 'No', 'Always', 'Optional' ): logging.error( f"Unexpected {closed!r} closed field for marker {marker!r}" )
    ...
    def exportDataToPython( self, filepath=None ):
        ...
        with open( filepath, 'wt', encoding='utf-8' ) as myFile:
            ...
            myFile.write( f"# This UTF-8 file was automatically generated by USFM2Markers.py V{PROGRAM_VERSION} on {datetime.now()}\n#\n" )
    ...
    def exportDataToC( self, filepath=None ):
        ...
        with open( hFilepath, 'wt', encoding='utf-8' ) as myHFile, \
            ...
            lines = f"// This UTF-8 file was automatically generated by USFM2Markers.py V{PROGRAM_VERSION} on {datetime.now()}\n//\n"
