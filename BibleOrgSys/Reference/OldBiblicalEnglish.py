...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' hym silf',' hym selfe',' him selfe',' him sylfe',' him silf',' hem silf',' himsilfe',' himselfe',' hymselfe',' hemsilf'),' himself'),
    ...
    (('sea syde','sea side','seesyde' ,'seeside'),'seaside'),
    ...
    (('Aarons',),'Aaron’s'),
        ...
        ((' auncient',),' ancient'),
            ...
            (('Angell',),'Angel'),((' aungel',' angell'),' angel'),
                ((' angred',),' angered'), ((' angrie ',),' angry '),((' angrie,',),' angry,'),((' angrie?',),' angry?'),((' angrie!',),' angry!'),((' angrie:',),' angry:'),
                ((' angwischid',' angwisched'),' anguished'),((' angwische ',' anguishe '),' anguish '),
            ((' anoiede',),' annoyed'),
    ...
    ((' backes',' backis'),' backs'),((' backe ',' bak '),' back '),((' backe,',' bak,'),' back,'),((' backe.',),' back.'),((' backe?',),' back?'),((' backe:',),' back:'),((' bak;',),' back;'),
        ...
        (('Bee ',),'Be '),((' bee ',),' be '),((' bee,',),' be,'),((' bee?',),' be?'), #(('>bee<',),'>be<'),((' bee<',),' be<'),
            ...
            ((' beanes',),' beans'),
                ((' bearest',' berist'),' bearest/bear'),
                    ...
                    ((' beerdes',),' beards'),((' beerd',' berd'),' beard'),((' bearde,',' beerde,'),' beard,'), ((' beareth',' berith',' bereth'),' beareth/bears'), ((' bearinge',' bearynge',' beringe',' berynge'),' bearing'),
            ...
            ((' beddes',' beddis'),' beds'),((' beed ',' bedde '),' bed '),((' bedde,',' bedd,'),' bed,'),((' bedde.',' beed.'),' bed.'),
        ...
        ((' blackenesse',' blacknesse'),' blackness'), ((' blackere',),' blacker'), ((' blacke ',' blake '),' black '),((' blacke,',' blak,'),' black,'),((' blacke:',),' black:'),
                ((' blamelesse',),' blameless'), ((' blameden',' blamyde'),' blamed'),((' blamyngi',' blamyng',),' blaming'),
                 ((' blasfemyes',),' blasphemies'),((' blasphemie ',' blasfemye '),' blasphemy '),((' blasfemye,',),' blasphemy,'),((' blasphemie:',),' blasphemy:'),((' blasfemye;',),' blasphemy;'),
                    ...
                    ((' blastinge',),' blasting'),
            ((' blemishe',),' blemish'),
                (('Blessid ','Blissid '),'Blessed '),(('blessiden','blesside','blessid','blissid','blissed'),'blessed'),((' blessist',),' blessest/bless'), (('blessinge','blessynge','blessyngi','blessyng'),'blessing'), (('Blesse ',),'Bless '),((' blessen ',' blesse '),' bless '),((' blesse,',),' bless,'),((' blesse:',),' bless:'),
                ((' blewe ',),' blew '),
        ...
        ((' buckis',),' bucks'),((' bucke ',' buc '),' buck '),
            ...
            ((' burthen',' birthun',' burthe'),' burden'),
                ((' burgler',),' burglar'),
                ((' buriest',' biriest'),' buriest/bury'),((' buriall',' biriel'),' burial'),((' birieden',' biriede',' biried',' buryed',' biryed'),' buried'),((' buryinge',' biriyng'),' burying'),((' burie ',' byrie ',' burye ',' birie '),' bury '),
            ...
            ((' busshell',' bushell',' buschel'),' bushel'),
    ...
    ((' kab ',),' cab '),
            ...
            ((' kunne ',' kan ',' ca '),' can '),
                ...
                (('candlestickes','candelstickes','candelstyckes','candlestyckes','candilstikis'),'candlesticks'),(('candilstike','candelsticke','candlesticke'),'candlestick'), ((' candell',' candel'),' candle'),#((' candell ',),' candle '),((' cadle,',),' candle,'),((' candell:',),' candle:'),
...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
        ...
        (('chaffe',),'chaff'),
            ...
            ((' cristen',),' Christian'), (('Christes',),'Christ’s'),(('Christe','Crist'),'Christ'), (('Cronicles',),'Chronicles'),(('cronyclis',),'chronicles'),
        ...
        ((' coales',' coolis',' coles'),' coals'),((' cole ',),' coal '),((' cole:',),' coal:'),
            ...
            (('Comest ','Commest '),'Comest/Come '),((' comest ',' commest '),' comest/come '),((' comest,',' commest,'),' comest/come,'),
                ...
                ((' commynge',' comynge',' commyng',' commyge',' comming',' cominge',' comyng',' comen'),' coming'),((' comun ',),' coming '), ((' comon ',),' come '),((' comun,',),' come,'),((' comun;',),' come;'),
            ...
            (('Couenant',),'Covenant'),((' couenannt',' couenaunt',' couenaut',' couenant'),' covenant'),
                ((' couerdest',' couered'),' covered'), ((' covereth',' couereth',),' covereth/covers'),((' coverest',' couerest',),' coverest/cover'), ((' coueringe',' couerynge',' couering'),' covering'), (('Couer',),'Cover'),((' couer',),' cover'),
                    ((' couert',),' covert'),
                (('couetousnesse','coueitise'),'covetousness'),(('cuvetousnes.',),'covetousness.'),((' couetous',' coueytise'),' covetous'), ((' coueitide',' coueted'),' coveted'),((' coveteth',' coueitith',' coueteth'),' coveteth/covets'), ((' coueyte ',),' covet '),((' couet',),' covet'),
        ...
        ((' cubytes',' cubites',' cubitis'),' cubits'),((' cubite ',),' cubit '),((' cubite,',),' cubit,'),((' cubite.',),' cubit.'),
            ...
            ((' cuppis',' cuppe',),' cup'),
            ((' keuered',),' cured'),
                (('Cursid',),'Cursed'),((' cursiden',' curside',' cursid'),' cursed'),((' curseth',' cursith'),' curseth/curses'),((' cursyngi',' cursynge',),' cursing'),
    ...
    ((' dayly',' daylie'),' daily'),
            (('dammage',),'damage'),
                (('dampnacioun','dampnacion','dampnation'),'damnation'),
                (('dampned',),'dampened'),
            ...
            ((' daies',' dayes',' dais'),' days'), (('Daye',),'Day'),((' daye ',' daie ',' dai '),' day '),((' daye,',' daie,',' dai,'),' day,'),((' daye.',' daie.',' dai.'),' day.'),((' daye?',' dai?'),' day?'),((' daye:',' daie:',' dai:'),' day:'),((' dai;',),' day;'),
        ((' dekene',),' deacon'),
                ((' deedly',' dedly'),' deadly'),
            ...
            ((' decaye ',),' decay '),((' decaye.',),' decay.'),((' decaye:',),' decay:'),
                (('deceytfulness',),'deceitfulness'),(('disseytfulnes ','disceatfulnes ','deceitfulnes '),'deceitfulness '),
                        (('deceitfull ','disceatfull ','disceatful ','deceytfull ','deceiptfull '),'deceitful '),(('deceitfull.',),'deceitful.'),(('disceatfull:',),'deceitful:'), ((' deceite',' deceipt',' disceate',' disceipt',' disseit'),' deceit'),
            ...
            (('descendinge',),'descending'),(('descende ',),'descend '),(('descende,',),'descend,'),
                ...
                ((' despaire ',' dispare '),' despair '),
                    ((' despisinge',' dispisyng',' dispising'),' despising'),((' dispisiden',' dispiseden',' dispiside',' despysed',' dispisid'),' despised'),((' despiseth',' dispisith'),' despiseth/despises'),((' dispisen',' despyse',' dispise'),' despise'),
                        ((' despitefull ',' dispitefull '),' despiteful '),((' despyte',),' despite'),
                ((' destrieden',' distriede',' destriede',' destroied',' destried',' distried'),' destroyed'), (('destroyethe',),'destroyeth'),(('distriynge','distriyng','destrien'),'destroying'), (('Destroie ',),'Destroy '),((' distrie ',' destrie ',' destroye ',' distroye ',' distruye ',' destroie ',' destoy '),' destroy '),((' destroye,',' distrie,'),' destroy,'),
                    (('destruccios',),'destructions'),(('destruccion','distruction'),'destruction'),(('destruccio ',),'destruction '),
            ((' determyne',),' determine'),
            ((' deuyces',),' devices'),
                ((' deuelis',' devylles',' devvyls',' deuils',' deuyls',' deuels',' diuels',' devyls'),' devils'),((' devyll',' deuell',' deuyll',' devill',' deuill',' deuel'),' devil'),
        ...
        ((' doere',),' doer'), (('Dost ','Doest '),'Dost/Do '), ((' doth',' doeth',' doith'),' doth/does'), (('Doe ',),'Do '),((' doe ',),' do '),((' doe,',),' do,'),((' doe.',),' do.'),((' doe?',),' do?'),((' doe:',),' do:'),
            ...
            ((' doublid',),' doubled'),((' dubble',),' double'),
                ((' douteful,',),' doubtful,'), ((' doubtlesse',' doutlesse',' doutles'),' doubtless'), ((' doutide',),' doubted'), ((' doute ',),' doubt '),((' doute,',),' doubt,'),((' doute)',),' doubt)'),
        ...
        ((' draffis',),' drafts'),
            ...
            (('dreadfull ','dreedful '),'dreadful '),(('dreadfull.',),'dreadful.'),(('dreadfull:',),'dreadful:'),(('dredeful;',),'dreadful;'),
                ...
                ((' drewest',),' drewest/drew'),((' drewe ',' drue ',' drow '),' drew '),
    ...
    ((' facis',),' faces'),
        ...
        ((' foale ',),' foal '), ((' fome ',),' foam '),
            ...
            ((' foldid',),' folded'),((' foldeth',' foldith'),' foldeth/folds'),
                ...
                (('Folkis',),'Folks/People'),((' folkis',' folkes'),' folks/people'), ((' folke ',' folc '),' folk/people '),((' folke,',' folc,',),' folk/people,'),((' folke.',' folc.'),' folk/people.'),((' folke:',),' folk/people:'),
        ...
        ((' fraile ',),' frail '),
            ...
            (('fruitfull ','frutefull ','fruytful '),'fruitful '),(('fruitfull,','frutefull,'),'fruitful,'),(('fruitfull.','fruitefull.','frutefull.','frutfull.'),'fruitful.'),(('fruitefull:',),'fruitful:'),
        ...
        ((' fewell',),' fuel'),
            ((' fugitiues',),' fugitives'),
            ((' fulleste',),' fullest'),((' fulli',),' fully'), ((' fulle ',' ful '),' full '),((' ful.',),' full.'),((' ful;',),' full;'), (('fulfillid','fulfylled'),'fulfilled'),(('fulfillynge','fulfyllyng'),'fulfilling'), ((' fulfill ',' fulfyll '),' fulfil '), ((' fulnesse ',' fulness ',' fulnes '),' fullness '),((' fulnesse,',' fulness,'),' fullness,'),((' fulnesse.',' fulness.'),' fullness.'),
    ...
    (('habitaciouns','habitacios'),'habitations'),(('habitacioun','habitacion','habitacio'),'habitation'),
        ...
        (('Hee ',),'He '),((' hee ',),' he '),((' hee,',),' he,'),((' hee?',),' he?'),((' hee)',),' he)'),
            ...
            ((' heysfer',' heyffer',' heyfer'),' heifer'),
                ((' hights',),' heights'),((' heiythe',' heiyte',' heyght',' heigth',' heyth'),' height'),((' eiris',),' heirs'), ((' heyre ',' heire ',' eir '),' heir '),((' heire,',),' heir,'),
        ...
        ((' hiliden ',' hidde ',' hyd '),' hid '),((' hyd,',),' hid,'),((' hidest',' hydest',' hidist'),' hidest/hide'),((' hideth',' hydeth',' hidith'),' hideth/hides'), (('Hyde ',),'Hide '),((' hyde ',),' hide '),
        ...
        ((' hoar ',' hoare ',' hoore '),' hoar/grey '),
            ((' holdeth',' holdith'),' holdeth/holds'),((' helden ',),' holding '),(('Holde ',),'Hold '),((' hoolde ',' holde '),' hold '),((' houlde,',' holde,'),' hold,'),
                (('HOLINES ',),'HOLINESS '),(('Holinesse',),'Holiness'),(('Holines ',),'Holiness '),((' holynesse',' holinesse',' holynes'),' holiness'),((' holines ',),' holiness '),((' holines,',),' holiness,'),((' holines:',),' holiness:'),
                    ((' HOLI ',),' HOLY '), ((' hooli ',' holie ',' holye ',' holi '),' holy '),((' hooli,',),' holy,'),((' hooli.',' holie.'),' holy.'),((' hooli;',' holi;'),' holy;'),
            ((' hoom',),' home'),
            ...
            (('Hou ','Howe '),'How '),((' hou ',' howe '),' how '),((' howe.',),' how.'),
    ...
    ((' iawes',),' jaws'),
        ...
        ((' ioyning',),' joining'), ((' ioyned',' ioined'),' joined'),((' ioyne ',),' join '), ((' ioints',' ioyntes',' ioynts'),' joints'),((' ioynt',),' joint'),
            (('Iorney',),'Journey'),(('iourney','iournei'),'journey'),
    ...
    (('Keepers','Keperis',),'Keepers/Watchmen'),((' keepers',' keperis',),' keepers/watchmen'), ((' kepere',' keper'),' keeper'),((' keepest',' kepest',' kepist'),' keepest/keep'),((' keepeth',' kepith',' kepeth'),' keepeth/keeps'),((' kepynge',' kepyng',' keping'),' keeping'), ((' kepten',' kepte'),' kept'), (('Keepe ','Kepe '),'Keep '),((' kepen ',' keepe ',' kepe '),' keep '),((' keepe,',' kepe,'),' keep,'),
        ...
        ((' killidist',' killiden',' killide',' kylled',' kyllide',' kyllid'),' killed'),((' kyll ',),' kill '),((' kyll.',),' kill.'), ((' kilne',' kylne'),' kiln'),
            ...
            ((' kissiden',' kisside',' kissid',' kyssed',' kiste'),' kissed'),((' kisse ',' kysse '),' kiss '),((' kysse,',),' kiss,'),
    ...
    ((' labored',),' laboured'),((' labourest',),' labourest/labour'),((' labouringe',),' labouring'),((' laboures',),' labours'),((' laboure ',' labor '),' labour '),((' laboure,',' labor,'),' labour,'),((' laboure.',),' labour.'),((' laboure?',),' labour?'),
            ...
            ((' landes',' londes',' londis'),' lands'),((' lande ',' loond ',' londe ',' lond ',' lode '),' land '),((' loond,',' lande,',' londe,',' lond,'),' land,'),((' loond.',' lande.',' londe.',' lond.'),' land.'),((' lond?',),' land?'),((' lande:',' londe:'),' land:'),((' lande;',' londe;',' loond;',' lond;'),' land;'),((' londe)',),' land)'),
        ...
        ((' leeder',' ledere'),' leader'), (('leadest','laddest','leedist','ledest'),'leadest/lead'),(('leadeth','ledith','ledeth'),'leadeth/leads'), (('Leade ','Lede '),'Lead '),((' leade ',' leede ',' lede '),' lead '),((' leade,',' leed,',' lede,'),' lead,'),((' leed.',),' lead.'),
            ...
            ((' ledden ',' ledde ',' leden '),' led '),((' ledde,',),' led,'),
        ...
        ((' liberall ',),' liberal '), (('lyberte','libertie'),'liberty'), ((' librarie ',),' library '),
            ((' licke ',),' lick '),
            ((' lyers',' liers'),' liars'),((' lier',' lyer'),' liar'), ((' lieden',' lyed'),' lied'),((' lieth',' lyeth'),' lieth/lies'),((' ligynge',' lyinge',' lyenge',' lyege'),' lying'),((' lyes ',),' lies '),((' lyes,',),' lies,'),((' lyes.',),' lies.'),((' lyes?',),' lies?'),((' lyes:',),' lies:'),((' lyes)',),' lies)'),((' lye ',),' lie '),((' lye,',),' lie,'),
            ...
            (('liuely',),'lively'), ((' lyueden',' lyuede',' livede',' liued',' lyued'),' lived'),((' liveth',' liueth',' lyueth'),' liveth/lives'),((' liues',' lyues'),' lives'),((' lyuynge',' livynge',' lyuinge',' lyunge',' lyuing',' lyuyng',' liuing',' lyuen'),' living'),((' liue ',' lyue '),' live '),((' liue,',' lyue,'),' live,'),((' liue.',' lyue.'),' live.'),((' liue?',' lyue?'),' live?'),((' liue:',' lyue:'),' live:'),((' liue;',' lyue;'),' live;'),
                ((' liuer',),' liver'),
        (('Loe,',),'Lo,'),
            ((' loe ',),' lo '),((' loe,',),' lo,'),
            ((' loof',),' loaf'),
    ...
    ((' madnesse',),' madness'),((' madnes ',),' madness '), ((' madde ',' madd '),' mad '),((' madde,',' madd,'),' mad,'),
            ...
            ((' marre ',),' mar '),
                ...
                ((' mariage',' maryage'),' marriage'), ((' maried',' maryed'),' married'),((' marrieth',' marieth',' maryeth'),' marrieth/marries'), ((' marrie ',' marie ',),' marry '),
            ...
            ((' masoun',),' mason'),
                ((' maistrie',' maistri'),' mastery'), (('Maister','Maistir'),'Master'),((' maister',),' master'), ((' mastes',),' masts'),
    ...
    ((' naled',),' nailed'),((' nailis',' nailes',' nayles',' nales'),' nails'),((' naile ',' nale '),' nail '),((' naile,',),' nail,'),
        ...
        ((' neere ',' neare '),' near '),((' neere,',' neare,',' nye,'),' near,'),((' neere.',' neare.'),' near.'),((' neere:',' neare:'),' near:'),((' neere;',' niy;'),' near;'),
            ...
            ((' neiyboresse',' neiyboris',' neghboures',' neghbours',' neyghbours',' neygbours'),' neighbours'),((' neiybore',' neyghbour',' neghboure',' neighbor'),' neighbour'),
                (('nethermost',),'lowest'), # Psa 86:13
                    (('Nether ','Nethir '),'Neither '),((' nenether',' neyther',' nether',' nethir'),' neither'),(('(nether',),'(neither'),
            ((' nephewes',),' nephews'),
            ((' nestes',),' nests'),((' neste ',),' nest '),
        ...
        (('noumbride','noumbrid','noumbred','numbred','nombred'),'numbered'),(('numbereth','noumbrith'),'numbereth/numbers'),(('noumbre','nombre','nomber','numbre'),'number'),
        ...
        ((' of;',),' off;'),
                ((' offende ',),' offend '),((' offende,',),' offend,'),((' offende.',),' offend.'),
                    (('offryngis','offeringes','offrynges'),'offerings'),((' offerynge',' offeryng',' offeringe',' offringe',' offring',' offryng',' offren'),' offering'),
                        ((' offriden',' offeride',' offride',' offrid',' offred'),' offered'),((' offerest',' offridist'),' offerest/offer'),((' offereth',' offreth'),' offereth/offers'), (('Offre ',),'Offer '),((' offre ',' ofre '),' offer '),((' offre,',),' offer,'),
    ...
    ((' paiede',' payde',' payed',' payd'),' paid'),
        ...
        ((' pesible',),' peaceable'),(('Pees',),'Peace'),((' pees',),' peace'),
            ...
            (('peradventure','peraduenture','perauenture'),'peradventure/perhaps'),
                ...
                ((' perfitli',' perfitly'),' perfectly'),((' perfaicte ',' perfit '),' perfect '), ((' performyden',' perfourmed'),' performed'),(('perfourmeth ','performeth '),'performeth/performs ' ),((' perfourme ',' performe '),' perform '),((' performe,',),' perform,'),((' perfourme.',' performe.'),' perform.'),
                ((' periurie',),' perjury'),
        ...
        (('preisiden','praysed','preiside','preisid','preysid'),'praised'),(('preisynge','praysinge','praysing','praysyng','preysyng','preisyng'),'praising'),(('Prayse',),'Praise'),(('prayse','preise','preyse'),'praise'),
                ...
                (('preyeden','preiede','praied','prayde'),'prayed'), (('preieris',),'prayers'), (('Praier ','Preier '),'Prayer '),(('preier','praier','preyer'),'prayer'),(('preyng',),'praying'),((' preye ',' praye ',' preie '),' pray '),((' preye,',),' pray,'),((' praye.',),' pray.'),((' praye:',),' pray:'),
            ...
            (('pryce ','prijs '),'price '),
                ...
                (('priuately','pryuately','pryuatly','pryuely'),'privately'), ((' privy ',' priuie ',' pryuy ',' preuy ',' prevy '),' privy/private '),((' privy,',' priuie,',' pryuey,'),' privy/private,'), ((' privily',' priuily',' preuely',' priuilie',' priuely',' priueli'),' privily/secretly'),
            (('proceaded',),'proceeded'),(('proceede ','procede '),'proceed '),
                ...
                (('prophane',),'profane'), # (('prophaned',),'profaned'),
                    (('profitabli',),'profitably'), (('profitide',),'profited'),(('profiteth','profitith'),'profiteth/profits'),(('proffet ','profite '),'profit '),
                    (('profounde',),'profound'),
                (('prolonge ','prologe '),'prolong '),
                ((' promyse',),' promise'),
                (('profesie ','profecie '),'prophecy '),(('profesie,',),'prophecy,'),
                        (('Prophecie ','Prophesie '),'Prophesy '),(('prophecieden','prophecied','profeciede','profesiede'),'prophesied'),(('prophesieth','prophecieth'),'prophesieth/prophesies'),(('prophecienge','prophecying'),'prophesying'),(('prophesie ','prophecie '),'prophesy '),
    ...
    (('Rabi',),'Rabbi'),
        ...
        ((' reache ',),' reach '),
            ...
            ((' redde ',' reed '),' red '),((' redde:',),' red:'),
                (('Redeemr',),'Redeemer'),((' redemer',),' redeemer'), ((' redemed',),' redeemed'), (('Redeeme',),'Redeem'),((' redeeme ',' redeme '),' redeem '),((' redeeme,',),' redeem,'),((' redeeme.',),' redeem.'),((' redeeme?',),' redeem?'),((' redeeme:',),' redeem:'),
        ...
        ((' rored',),' roared'),((' roaringe',),' roaring'),((' roare ',' rore '),' roar '),((' roare,',' rore,'),' roar,'),
            ...
            ((' rooffe',' roofe',' roufe',' rofe'),' roof'),
                ...
                ((' roted',),' rooted'),((' rotynge',),' rooting'), ((' rootis',' rootes',' rotes'),' roots'),((' roote ',' rote '),' root '),((' roote,',' rote,'),' root,'),((' roote.',),' root.'),
            ((' ropis',),' ropes'),
            ((' risiden ',' roos ',),' rose '),((' roos,',),' rose,'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
            ...
            ((' sattest ',' saten ',' sate ',),' sat '), (('Sathanas','Satanas','Sathan','Satha'),'Satan'), ((' satisfie ',),' satisfy '),
        ...
        ((' sealeth',),' sealeth/seals'),((' seelide',),' sealed'),((' seale ',),' seal '),((' seale,',),' seal,'),
            ...
            ((' secounde ',' seconde ',' secunde '),' second '),((' secounde;',),' second;'), ((' secundarie',),' secondary'),
                ...
                ((' sikur ',),' secure '),
            ((' sedicio',),' sedition'),
            ((' seest ',' siest ',' seyst '),' seest/see '),((' seeth ',' seeeth ',' seyth '),' seeth/sees '), (('Seynge','Seinge','Seyng'),'Seeing'),((' seynge',' seinge',' seyng',' seing', ' sien'),' seeing'),
                ...
                (('Seekest ',),'Seekest/Seek '),((' seekest',' sekest'),' seekest/seek'), ((' seeketh',' seketh',' sekith'),' seeketh/seeks'),((' sekynge',' sekyng'),' seeking'),(('Seeke ','Seke '),'Seek '),((' seken ',' secke ',' seeke ',' seke '),' seek '),((' seeke,',' seke,'),' seek,'),((' seken.',' seeke.',' seke.'),' seek.'),
                ((' semyde',),' seemed'),((' semeth',),' seemeth/seems'),((' semeli',' semely'),' seemly'), ((' semen ',' seeme ',' seme '),' seem '),
                ((' seyn ',' seene ',' sene ',' sien '),' seen '),((' seyn,',' seene,',' sene,',' sien,'),' seen,'),((' seene.',' sene.',' seyn.'),' seen.'),((' seene:',),' seen:'),
            ...
            ((' separateth',),' separateth/separates'),((' seperate',),' separate'),
            ...
            ((' sermoun',),' sermon'),
                ...
                (('Seruants',),'Servants'),(('seruauntis','seruauntes','seruautes','servauntes','seruantes','servantes','seruants','seruats'),'servants'),((' seruaunte',' seruaunt',' servaunt',' seruant',' seruaut',' servaut'),' servant'),
                    ...
                    ((' serueden',' seruyden',' seruyde',' seruede',' serued'),' served'),
                        ((' seruice',' seruyce',' seruyse'),' service'), ((' seruile',),' servile'), ((' seruynge',),' serving'),
        ...
        ((' schadewi',' shadewi',' schadewe',' schadowe',' shadowe',' shadewe',' schadow'),' shadow'),
            ...
            ((' shieldes',' scheeldis',' scheldis',' sheldes',' shyldes',' shildes'),' shields'),((' shielde ',' shylde ',' scheeld ',' scheld '),' shield '),((' shielde,',' scheeld,',' shylde,'),' shield,'),((' shielde.',' shilde.'),' shield.'),((' shielde:',' shylde:'),' shield:'),((' shielde;',' scheld;'),' shield;'),
                ...
                (('shipmaister',),'shipmaster'),((' shippmen',),' shipmen'), (('Schippis',),'Ships'),((' schippis',' shippis',' shippes',' schipis'),' ships'), ((' shyppe',' shyp',' shippe',' schip'),' ship'),
        ...
        ((' slacke',),' slack'),
            ...
            ((' sleddis',),' sleds'),
                ((' sleepest',' slepest',' slepist'),' sleepest/sleep'),((' sleepeth',' slepeth',' slepith',),' sleepeth/sleeps'), ((' slepinge',' slepynge',' slepen'),' sleeping'), ((' slepten ',' slepte '),' slept '),
        ...
        ((' sokettes',' sockettes'),' sockets'),((' sokett',),' socket'),
            ...
            ((' sowun ',' sowen ',' sowne '),' sown '),((' sowne,',' sowen,'),' sown,'),((' sowen:',),' sown:'),((' soweth',' sowith'),' soweth/sows'),((' sowinge',' sowynge'),' sowing'), (('Sowe ',),'Sow '),((' sowe ',),' sow '),((' sowe,',),' sow,'),((' sowe.',),' sow.'),((' sowe:',),' sow:'),
    ...
    ((' tabering',' tabring'),' tabering/beating'), (('tabernaclis',),'tabernacles/tents'),
        ...
        ((' techere',' techeri'),' teacher'),(('techyng','teching'),'teaching'), (('teachest','techist'),'teachest/teach'),(('teacheth','techith'),'teacheth/teaches'),(('Teache ',),'Teach '),((' teache ',' techen ',' teche '),' teach '),((' teache:',),' teach:'),
            ...
            ((' temperid',),' tempered'),((' tempre ',),' temper '), ((' tepest',),' tempest'),
                ((' templis',),' temples'),
                (('temptacioun','temptacion','teptacion','tentation','tentacion'),'temptation'), ((' temptiden',' temptid',' temped'),' tempted'), ((' tempte ',' tepte '),' tempt '),
        ...
        ((' thankfull ',),' thankful '),(('thankefull.','thankfull.'),'thankful.'), (('Thankes',),'Thanks'),(('thanckes','thankes','thakes'),'thanks'),(('thanke ',),'thank '),
            ...
            ((' threede',' threed'),' thread'), (('thretenede',),'threatened'),(('threatning',),'threatening'), ((' thre ',),' three '),((' thre,',),' three,'),((' thre:',),' three:'),
                ...
                (('thrusteth','throusteth'),'thrusteth/thrusts'),
    ...
    ((' wagginge',),' wagging'),((' wagge ',),' wag '),
        ...
        (('Wee ',),'We '),((' wee ',),' we '),((' wee?',),' we?'),((' wee:',),' we:'),
            ...
            ((' weddid',),' wedded'), ((' weddyngi',' weddyngy',),' wedding'), ((' wedlocke',),' wedlock'),
            ((' wedes',),' weeds'),
            ...
            ((' woukis',' weekes',' wekes'),' weeks'),((' weeke',' weke'),' week'),
                ((' weepeth',' wepeth',' wepith',),' weepeth/weeps'),((' weepyng',' wepyng',' weepinge',' wepinge',' wepige',' wepingi'),' weeping'),((' wepten',' weapte',' wepte',),' wept'),((' weepe ',' wepe '),' weep '),((' weepe,',' wepe,'),' weep,'),((' wepe.',),' weep.'),((' weepe?',' wepe?'),' weep?'),((' weepe:',' wepe:'),' weep:'),((' wepe;',),' weep;'),
        ...
        ((' wickidli',),' wickedly'), (('wickidnessis','wickednessis','wyckidnessis'),'wickednesses'), (('Wickednesse ','Wickednes '),'Wickedness '),(('wickidnesse ','wickednesse ','wyckednes ','wickednes '),'wickedness '),(('wickidnesse,','wickednesse,','wickednes,'),'wickedness,'),(('wickidnesse.','wickednesse.','wickednes.'),'wickedness.'),(('wickidnesse?','wickednes?'),'wickedness?'),(('wickednesse:','wickednes:'),'wickedness:'),(('wickidnesse;','wickednesse;','wickednes;'),'wickedness;'), ((' wickid',' wickyd'),' wicked'),
            ...
            (('Wielde ',),'Wild '),((' wielde ',' wilde ',' wylde ',' wyelde '),' wild '), (('wildernes.',),'wilderness.'),
                ...
                ((' willis',),' wills'), (('Wyll ',),'Will '),((' wyll ',' wyl ',' wille ',' wil ',' wole '),' will '),((' wille,',' wyll,',' wil,',' wole,'),' will,'),((' wille.',' wyll.'),' will.'),((' wyll:',),' will:'), (('Wilt ','Wylt '),'Wilt/Will '),((' wilt ',' wylt '),' wilt/will '),((' wilt,',' wylt,'),' wilt/will,'),
    ...
    (('Iaakob','Iacob'),'Yacob'), (('Iah,',),'Yah,'),(('Jah<',),'Yah<'), (('Iames','James'),'Yames/Yacob'), ((' yarne',),' yarn'), (('Iauan',),'Yavan'),
        (('Yee ','Ye '),'Ye/You_all '),((' ye ',' yee ',' yi '),' ye/you_all '),((' ye,',' yee,'),' ye/you_all,'),((' ye.',' yee.'),' ye/you_all.'),((' ye?',' yee?',),' ye/you_all?'),((' ye:',' yee:'),' ye/you_all:'),((' ye;',' yee;'),' ye/you_all;'), (('Thy ',),'Thy/Your '),((' thi ',' thy '),' thy/your '),#(('>thy ',),'>thy/your '),
    ...
    ((' abak',),' aback'),((' abac.',),' aback.'), # Psa 55:10, 113:3
        ...
        ((' axyngis',),' askings'),((' axyng',),' asking'), # Wycl Tob 7:10
    ((' beefes',' beeves',' beeues',),' cattle'), # Wycl 'Num 31:33
        ...
        ((' bitake',),' betake/give/grant'), # Wycl Jdg 15:12
    ...
    ((' capret',),' she-goat'), # Sng 4:5
        ...
        (('comlyngi','comeling'),'stranger'), # Wycl Tob 1:7, Isa 54:15
...
for wordMapEntry in ENGLISH_WORD_MAP:
    ...
    if newWord not in (' 40 ',' 60',
                       ' abated',' afar,',' among ',' between',' burial','ed ',' can ',' cattle',' cut ',
                       'grape-gatherers','immediately',' loved',
                       ' pasture',' power',' promised',
                       ' reckoned/counted',' ruins','stiff-necked','stranger',
...
def fullDemo() -> None:
    ...
    for testHTMLStr,expectedResultStr in (('Reioycing','Rejoicing'), ('COMMONLI CALLED','COMMONLY CALLED')):
