    ...
    (('Ech ',),'Each '),((' eche ',' ech '),' each '),((' ech,',),' each,'),
        ...
        ((' exalte ',),' exalt '),
            ...
            (('expectingly',),'expectantly'),
                    ...
                    ((' expownyng',),' expounding'),((' expowne ',),' expound '),
    ...
    (('Keepers','Keperis',),'Keepers/Watchmen'),((' keepers',' keperis',),' keepers/watchmen'), ((' kepere',' keper'),' keeper'),((' keepest',' kepest',' kepist'),' keepest/keep'),((' keepeth',' kepith',' kepeth'),' keepeth/keeps'),((' kepynge',' kepyng',' keping'),' keeping'), ((' kepten',' kepte'),' kept'), (('Keepe ','Kepe '),'Keep '),((' kepen ',' keepe ',' kepe '),' keep '),((' keepe,',' kepe,'),' keep,'),
        ...
        (('kniues','knyues'),'knives'),(('knyfe',),'knife'),
            (('knocke ',),'knock '),(('knocke,',),'knock,'),
                (('Knowest','Knowist'),'Knowest/Know'),(('knowest','knowist','knowst'),'knowest/know'),(('knoweth','knowith'),'knoweth/knows'),(('knowynge','knowyng'),'knowing'), (('Knouleche',),'Knowledge'),(('knowlege','knouleche'),'knowledge'), (('knowne','knowun','knowen'),'known'), (('Knowen ','Knowe ',),'Know '),((' knowe ',' woot '),' know '),((' knowe,',),' know,'),((' knowe.',),' know.'),((' knowe?',),' know?'),((' knowe:',),' know:'),((' knowe;',),' know;'),((' knowe)',),' know)'),
    ...
    ((' paiede',' payde',' payed',' payd'),' paid'),
        ...
        (('preisiden','praysed','preiside','preisid','preysid'),'praised'),(('preisynge','praysinge','praysing','praysyng','preysyng','preisyng'),'praising'),(('Prayse',),'Praise'),(('prayse','preise','preyse'),'praise'),
            ...
            (('pryce ','prijs '),'price '),
                ...
                (('priuately','pryuatly','pryuely'),'privately'), ((' privy ',' priuie ',' pryuy ',' preuy '),' privy/private '),((' privy,',' priuie,',' pryuey,'),' privy/private,'), ((' privily',' priuily',' preuely',' priuilie',' priuely',' priueli'),' privily/secretly'),
...
for wordMapEntry in ENGLISH_WORD_MAP:
    ...
    if newWord not in (' 40 ',' 60',
                       ' afar,',' among ',' between',' burial','ed ',' can ',' cattle',' cut ',
