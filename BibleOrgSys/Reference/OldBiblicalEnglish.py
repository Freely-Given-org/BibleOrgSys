...
ENGLISH_WORD_MAP = ( # Place longer words first,
        ...
        (('chaffe',),'chaff'),
            ...
            ((' chidden',),' chided/disputed/scolded'), # Lam 4:15
                ...
                (('childberyng',),'childbearing'),
                    ...
                    (('childrens','chyldrens','childres'),'children\'s'),(('chyldren',),'children'),(('childre ',),'children '),(('childre,',),'children,'),(('childre.',),'children.'),
    ...
    (('Ech ',),'Each '),((' eche ',' ech '),' each '),((' ech,',),' each,'),
        ...
        ((' vnequall?',),' unequal?'),((' equall ',),' equal '),((' equall.',),' equal.'),((' equall?',),' equal?'), ((' equitie',' equytee',' equite',' equyte'),' equity'),
        ((' ere ',' yer '),' ere/before '),
    ...
    ((' facis',),' faces'),
        ...
        ((' failiden',' failide',' failid',' fayled'),' failed'),((' failest',' faylest'),' failest/fail'),((' faileth',' fayleth',' faeleth',' failith'),' faileth/fails'),((' failinge',),' failing'), ((' fayle ',' faile '),' fail '),((' failen,',' fayll,',' faile,',' fayle,'),' fail,'),((' faile.',' fayle.'),' fail.'),((' faile:',),' fail:'),((' faile;',),' fail;'),
            ...
            ((' fatnesse',),' fatness'),((' fatnes.',),' fatness.'),((' fatnes:',),' fatness:'), ((' fatte ',' fatt '),' fat '),
                (('fatherlesse','fadirles','faderles'),'fatherless'), (('Fadris',),'Fathers'),((' fadris',),' fathers'), (('Fadir',),'Father'),((' fadir',),' father'),
    ...
    ((' labored',),' laboured'),((' labourest',),' labourest/labour'),((' labouringe',),' labouring'),((' laboures',),' labours'),((' laboure ',' labor '),' labour '),((' laboure,',' labor,'),' labour,'),((' laboure.',),' labour.'),((' laboure?',),' labour?'),
        ...
        ((' liberall ',),' liberal '), (('lyberte','libertie'),'liberty'), ((' librarie ',),' library '),
            ...
            (('liuely',),'lively'), ((' lyueden',' livede',' liued',' lyued'),' lived'),((' liveth',' liueth',' lyueth'),' liveth/lives'),((' liues',' lyues'),' lives'),((' lyuynge',' livynge',' lyuinge',' lyuyng',' liuing',' lyuen'),' living'),((' liue ',' lyue '),' live '),((' liue,',' lyue,'),' live,'),((' liue.',' lyue.'),' live.'),((' liue?',' lyue?'),' live?'),((' liue:',' lyue:'),' live:'),((' liue;',' lyue;'),' live;'),
        (('Loe,',),'Lo,'),
            ((' loe ',),' lo '),((' loe,',),' lo,'),
            ((' loof',),' loaf'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
        ...
        ((' syckle',),' sickle'),
            ...
            (('Sens ',),'Since '),((' sence ',' sithen '),' since '), (('Synneris',),'Sinners'),((' synners',' synneris'),' sinners'),((' synnere',' synner'),' sinner'), ((' synfull',' synful'),' sinful'),((' sinnes',' synnes'),' sins'),((' synneden',' synnede',' synned'),' sinned'),((' synne ',' sinne '),' sin '),((' synne,',' sinne,'),' sin,'),((' synne.',' sinne.'),' sin.'),((' synne?',' sinne?'),' sin?'),((' synne:',' sinne:'),' sin:'),((' synne;',' sinne;'),' sin;'),
            (('Syr,',),'Sir,'),
    ...
    (('vnauenged',),'unavenged'), (('vnaduisedly',),'unadvisedly'), (('vnawarres','vnwares'),'unawares'),
        ...
        ((' vp ',),' up '),((' vp,',),' up,'),((' vp.',),' up.'),
            ...
            (('Vpon ',),'Upon '),((' vppon ',' vpon ',' upo ',' vpo ',' apon '),' upon '),((' upo:',),' upon:'),
    ...
    (('nativity','natyuyte','natiuitie'),'nativity/birth'),
        (('neiyidist','neiyede'),'came_near'), # Lam 3:57, 4:18
            ((' neiyeth',),' approacheth/approaches'), # Eze 18:6
    ...
    ((' waxed',),' waxed/grew'),((' wexe ',),' wax/grow '), # Psa 89:6
        ...
        (('wroughtest','wrouytist'),'wroughtest/do'),(('wrought','wrouyten','wrouyte','wrouyt'),'wrought/done'), # Eze 18:19
