...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    (('Aarons',),'Aaron\'s'),
            ...
            (('abhominably',),'abominably/revoltingly'),(('abominable','abhomynable','abhominable','abhomible'),'abominable/revolting'), (('abomination','abhomynacioun','abhomynacoun','abhominacion','abhomination'),'abomination/disgusting_thing'),
    ...
    (('Baalim','Baalym'),'Baals'),
        ...
        ((' buckis',),' bucks'),
                ...
                ((' buylders',' bilderis'),' builders'), ((' builded',' buylded',' bildiden',' bildide',' bildid',' builte',' buylt'),' built'),
                    ((' buildest',' buyldest',' byldest'),' buildest/build'),((' buildeth',' buyldeth',' bildith'),' buildeth/builds'),(('buyldynges','buildynges','bildyngis'),'buildings'), (('Buylding',),'Building'),(('buyldinge','buylding','bilden'),'building'),
    ...
    ((' facis',),' faces'),
        ...
        ((' fidelitie ',),' fidelity '),
            ...
            ((' fillest',' fyllest'),' fillest/fill'),((' filleth',' fylleth',' fillith'),' filleth/fills'),((' filliden',' fillide',' fillid',' fylled'),' filled'),#((' fillid,',),' filled,'),((' fillid.',),' filled.'),((' fillid:',' fylled:'),' filled:'),
                ...
                (('fylthynesse','filthinesse','fylthinesse','filthynes','fylthines'),'filthiness'),((' filthines ',),' filthiness '), ((' filthie ',' fylthie ',' fylthy '),' filthy '), ((' filthis',),' filths'), ((' filthe',),' filth'),
    ...
    ((' madnesse',),' madness'),((' madnes ',),' madness '), ((' madde ',' madd '),' mad '),((' madde,',' madd,'),' mad,'),
        ...
        (('Mee ',),'Me '),((' mee ',),' me '),((' mee,',),' me,'),((' mee.',),' me.'),((' mee?',),' me?'),((' mee:',),' me:'),((' mee;',),' me;'),
            ((' medowe',),' meadow'),
                ...
                ((' metis',' meates'),' meats'),((' meate ',),' meat '),((' meate,',),' meat,'),((' meate.',),' meat.'),((' meate:',),' meat:'),
            ((' meddlid',' medled'),' meddled'),((' medlyng',),' meddling'),((' medle ',),' meddle '),
    ...
    (('O ',),'Oh '),
        ...
        ((' of;',),' off;'),
                ((' offende ',),' offend '),((' offende,',),' offend,'),((' offende.',),' offend.'),
                    (('offryngis','offeringes'),'offerings'),((' offerynge',' offeryng',' offeringe',' offringe',' offring',' offryng',' offren'),' offering'), ((' offriden',' offride',' offred'),' offered'),((' offerest',' offridist'),' offerest/offer'),((' offereth',' offreth'),' offereth/offers'), (('Offre ',),'Offer '),((' offre ',),' offer '),((' offre,',),' offer,'),
                ((' offycer',),' officer'),
    ...
    ((' paiede',' payed'),' paid'),
        ...
        (('preisiden','praysed','preiside','preisid','preysid'),'praised'),(('preisynge','praysinge','praysing','praysyng','preysyng','preisyng'),'praising'),(('Prayse',),'Praise'),(('prayse','preise','preyse'),'praise'),
            ...
            (('proceaded',),'proceeded'),(('proceede ','procede '),'proceed '),
                ...
                ((' prooued',' proued',' preued'),' proved'),(('Proue ',),'Prove '),((' prooue ',' proue ',' preue '),' prove '), (('prouerbe','prouerb'),'proverb'),
...
for wordMapEntry in ENGLISH_WORD_MAP:
    ...
    if newWord not in ('grape-gatherers',' loved',' power','themselves','throughout','whithersoever','whosoever',' hosts/armies','thyself/yourself'): # sometimes two→one and sometimes it's a single word
