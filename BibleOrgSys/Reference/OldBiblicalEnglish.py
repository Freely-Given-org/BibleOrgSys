...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
    ...
    ((' fablis',),' fables'),
        ...
        ((' flamyng',),' flaming'), ((' flambes ',' flammes '),' flames '),((' flawme',' flambe',' flamme'),' flame'),
            ...
            ((' fleddest',' fleddist'),' fleddest/fled'),((' fledden',' fledde'),' fled'), ((' fleynge',),' fleeing'), (('Fle ',),'Flee '),((' flye ',' fleen ',' fle '),' flee '),((' flye,',' fle,'),' flee,'),((' fle.',),' flee.'),((' fle)',),' flee)'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabboth',' saboth',' sabat'),' sabbath'),
            ...
            ((' sattest ',' saten ',' sate ',),' sat '), (('Sathanas','Satanas','Sathan','Satha'),'Satan'),
    ...
    ((' tabering',' tabring'),' tabering/beating'), (('tabernaclis',),'tabernacles/tents'),
        ...
        (('togidir','togidere','togydere','togidre','togedder'),'together'),
            ...
            ((' tongis',),' tongs'),
                ((' tungis',' tunges',' tonges',' toges'),' tongues'),((' tounge',),' tongue'),((' tonge ',' tunge ',' toge '),' tongue '),((' tonge,',' tunge,',' tuge,',' toge,'),' tongue,'),((' tonge.',' tunge.',' toge.'),' tongue.'),((' tonge?',),' tongue?'),((' tonge:',),' tongue:'),((' tunge;',),' tongue;'),
