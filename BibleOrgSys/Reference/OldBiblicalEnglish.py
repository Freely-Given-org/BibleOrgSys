...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    (('Ech ',),'Each '),((' eche ',' ech '),' each '),((' ech,',),' each,'),
        ...
        ((' vnequall ',),' unequal '),((' vnequall?',),' unequal?'),((' equall ',),' equal '),((' equall.',),' equal.'),((' equall?',),' equal?'),((' equall:',),' equal:'),
    ...
    ((' wagginge',),' wagging'),((' wagge ',),' wag '),
            (('Weilyng',),'Wailing'),(('Weile ',),'Wail '), ((' weilynge',' weilyngi',' weilyng',' weiling'),' wailing'),((' waile ',),' wail '),
    ...
    ((' purueiede',),' purveyed/supplied'), # Wyc Eze 20:6
