...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    (('Baalim','Baalym'),'Baals'),
        ...
        (('Bee ',),'Be '),((' bee ',),' be '),((' bee,',),' be,'),((' bee?',),' be?'), #(('>bee<',),'>be<'),((' bee<',),' be<'),
            ...
            (('beseeching','besechyng','bisechyng','biseching'),'beseeching/imploring'),(('beseeche ','beseech ','biseche ','beseche '),'beseech/implore '),(('biseche,','beseech,'),'beseech/implore,'),
                ((' besydes',' besidis',' bisidis'),' besides'), (('Besyde',),'Beside'),((' besyde',),' beside'), ((' bisegid',),' besieged'),((' bisege ',' besege '),' besiege '),
    ...
    ((' kab ',),' cab '),
        ...
        ((' coales',' coolis',' coles'),' coals'),((' cole:',),' coal:'),
            ...
            ((' coutche ',' couche '),' couch '),((' couche.',),' couch.'),
                ...
                ((' councelide',),' counselled'),(('Counseller',),'Counsellor'),((' counsellour',' counselour',' counseller',' counceler'),' counsellor'),
                    ...
                    ((' couted',),' counted'),((' counte ',),' count '),
                        ...
                        ((' countreyes',' countreys',' countreis',' cuntreis',' countrees',' coutrees',' countres'),' countries'),((' cuntree',' countrey',' cuntrey',' cuntrei',' countre',' cuntre',' coutre'),' country'),
            ...
            (('Couenant',),'Covenant'),((' couenannt',' couenaunt',' couenaut',' couenant'),' covenant'),
                ...
                (('couetousnesse','coueitise'),'covetousness'),(('cuvetousnes.',),'covetousness.'),((' couetous',),' covetous'), ((' coueted',),' coveted'),((' coveteth',' coueitith',' coueteth'),' coveteth/covets'), ((' coueyte ',' couet '),' covet '),
    ...
    (('Ech ',),'Each '),((' eche ',' ech '),' each '),((' ech,',),' each,'),
        ...
        ((' exalte ',),' exalt '),
            ...
            ((' exceaded',),' exceeded'), (('excedyngly','exceadingly','exceedyngly'),'exceedingly'),((' exceadinge',),' exceeding'),((' exceade ',),' exceed '),
    ...
    (('Rabi',),'Rabbi'),
            ...
            (('Rauen',),'Raven'),((' rauen',),' raven'),
                ((' ravin',' rauine',' raueyn'),' ravin/plunder_or_prey'), ((' rauished',),' ravished'),((' rauyschinge',' rauyshinge',),' ravishing'),
    ...
    ((' wagginge',),' wagging'),((' wagge ',),' wag '),
            ...
            (('walkynge','walkinge'),'walking'),((' walkide',' walkid'),' walked'),(('Walke ',),'Walk '),((' walke ',),' walk '),((' walke,',),' walk,'),((' walke:',),' walk:'), ((' wallid',),' walled'),((' walles',' wallis',' wals'),' walls'),((' wal ',),' wall '),((' wal,',),' wall,'),((' wal.',),' wall.'),((' wal;',),' wall;'),
             ...
             ((' wass ',),' was '),
                ...
                ((' wastide',' waysted',' wastyd',' waastid',' wastid'),' wasted'),((' waistinge',),' wasting'),((' waaste ',),' waste '), (('wastenesse ','wasteness '),'wasteness/disaster '),
...
for wordMapEntry in ENGLISH_WORD_MAP:
    ...
    if newWord not in ('ed ','grape-gatherers',' loved',' power','themselves','throughout','whithersoever','whosoever',' hosts/armies','thyself/yourself'): # sometimes two→one and sometimes it's a single word
