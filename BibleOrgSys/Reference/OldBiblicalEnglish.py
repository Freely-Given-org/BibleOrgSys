...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' dayly',' daylie'),' daily'),
        ...
        (('Dyall ',),'Dial '),((' diall ',),' dial '),
            ...
            ((' dieth',' dyeth'),' dieth/dies'), ((' dieden ',' dyed '),' died '),((' diede,',' dyed,'),' died,'),((' dyed.',),' died.'),((' diede;',),' died;'),((' diynge',' dien'),' dying'), ((' dye.',),' die.'),
            ...
            ((' dyuerse ',' diverse ',' divers ',' dyvers ',' diuerse ',' diuers '),' diverse/various '), ((' dyuersitee',),' diversity'),
                (('devided','deuided','deuyded','diuided'),'divided'),(('Diuide ',),'Divide '),((' diuid',' devid',' deuyd'),' divid'),
                    ((' diuinatios',),' divinations'), ((' dyuynyngi',),' divining'), ((' diuin',' deuin',' dyuyn'),' divin'),
                    ((' diuis',),' divis'),
    ...
    ((' gaine ',),' gain '),((' gaine,',),' gain,'),((' gaine.',),' gain.'), (('Gayus',),'Gaius'),
        ...
        ((' guardeth',' gardeth'),' guardeth/guards'),((' garde ',),' guard '),
            ...
            ((' gesside',),' guessed'), ((' gessinge',),' guessing'),
    ...
    ((' labored',),' laboured'),((' labourest',),' labourest/labour'),((' labouringe',),' labouring'),((' laboures',),' labours'),((' laboure ',' labor '),' labour '),((' laboure,',' labor,'),' labour,'),((' laboure.',),' labour.'),((' laboure?',),' labour?'),
        ...
        ((' liberall ',),' liberal '), (('lyberte','libertie'),'liberty'), ((' librarie ',),' library '),
            ...
            (('liuely',),'lively'), ((' lyueden',' livede',' liued',' lyued'),' lived'),((' liveth',' liueth',' lyueth'),' liveth/lives'),((' liues',' lyues'),' lives'),((' lyuynge',' livynge',' lyuinge',' lyuyng',' liuing',' lyuen'),' living'),((' liue ',' lyue '),' live '),((' liue,',' lyue,'),' live,'),((' liue.',' lyue.'),' live.'),((' liue:',' lyue:'),' live:'),((' liue;',' lyue;'),' live;'),
        (('Loe,',),'Lo,'),
            ((' loe ',),' lo '),((' loe,',),' lo,'),
            ((' loof',),' loaf'),
