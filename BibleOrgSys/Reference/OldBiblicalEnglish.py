...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    (('the toke,',),'the token/sign,'), # Cvdl Mrk 13:4
    ...
    (('the counsels',),'the councils'), # TNT Mrk 13:9
...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
        ...
        ((' coales',' coolis',' coles'),' coals'),((' cole ',),' coal '),((' cole:',),' coal:'),
            ...
            ((' coutche ',' couche '),' couch '),((' couche.',),' couch.'),
                ...
                ((' councelide',),' counselled'),(('Counseller',),'Counsellor'),((' counsellour',' counselour',' counseller',' counceler'),' counsellor'),
                        ((' counsayles',' councels'),' councils/counsels'), (('Councill,',),'Council,'),((' counsell ',' counsel ',' councill ',' councell ',' councel '),' council/counsel '),((' counsel,',' counsell,',' coucel,'),' council/counsel,'),((' counsell.',' councell.'),' council/counsel.'),((' counsell:',' counsel:',' counsayle:'),' council/counsel:'),((' counsell;',),' council/counsel;'),
    ...
    ((' nailide',' naled'),' nailed'),((' nailis',' nailes',' nayles',' nales'),' nails'),((' naile ',' nayle ',' nale '),' nail '),((' naile,',),' nail,'),
        ...
        ((' neere ',' neare '),' near '),((' neere,',' neare,',' nye,'),' near,'),((' neere.',' neare.'),' near.'),((' neere:',' neare:'),' near:'),((' neere;',' niy;'),' near;'),
            ...
            ((' needeful ',' needfull ',' nedefull ',' nedeful '),' needful '),((' nedeful.',),' needful.'),
                ...
                ((' needeth',' nedeth',' nedith'),' needeth/needs'), ((' needes',' nedes'),' needs'),((' neede ',' neade ',' nede '),' need '),((' nede;',),' need;'),
    ...
    ((' paiede',' payde',' payed',' payd'),' paid'),
        ...
        (('preisiden','praysed','preiside','preisid','preysid'),'praised'),(('preisynge','praysinge','praysing','praysyng','preysyng','preisyng'),'praising'),(('Prayse',),'Praise'),(('prayse','preise','preyse'),'praise'),
                ...
                (('preyeden','preieden','preiede','preyede','praied','prayde','prayd'),'prayed'), (('preieris',),'prayers'), (('Praier ','Preier '),'Prayer '),(('preier','praier','preyer'),'prayer'),(('prayinge','preiden','preynge','preyng',),'praying'),((' preye ',' praye ',' preie '),' pray '),((' preye,',' praye,'),' pray,'),((' praye.',' preye.'),' pray.'),((' praye:',),' pray:'),((' praye)',),' pray)'),
    ...
    (('Rabi',),'Rabbi'),
        ...
        ((' reache ',),' reach '),
                ((' readeth',' redeth',' redith'),' readeth/reads'),((' reade ',' rede '),' read '),
                    ((' readie ',' redye ',' redie ',' redi ',' redy '),' ready '),(('(redy ',),'(ready '),((' readie,',' redi,',' redy,'),' ready,'),((' readie.',' redie.',' redy.',' redi.'),' ready.'),((' redy:',),' ready:'),((' redy;',' redi;'),' ready;'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabboth',' saboth',' sabat'),' sabbath'),
        ...
        ((' scabbe',),' scab'),
            ...
            ((' scoffe ',),' scoff '),
                ...
                ((' scourgd',),' scourged'),
            (('Scrybe',),'Scribe'), ((' scryuen',' scribi',' scrybe'),' scribe'), ((' scripturis',' scryptures'),' scriptures'),
            ((' scomme ',),' scum '),
    ...
    ((' tabering',' tabring'),' tabering/beating'), (('tabernaclis',),'tabernacles/tents'),
        ...
        (('togedder','togidir','togidere','togydere','togidre','togider'),'together'),
            ((' token',' tokene',' tokyn',' tokne'),' token/sign'),
