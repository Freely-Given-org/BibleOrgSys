...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' kab ',),' cab '),
            ...
            (('Captaine','Captayne'),'Captain'),((' captaine',' captayne'),' captain'),(('(captaine',),'(captain'),
                (('captiuitie ','captiuyte ','captiuity ','captyuite ','captyuyte ','caitiftee ','caitifte '),'captivity '),(('captiuitie,','captiuity,','captiuyte,','captyuyte,','caitiftee,','caitifte,'),'captivity,'),(('captiuitie.','captiuite.','captiuyte.','caitiftee.','caitifte.'),'captivity.'),(('captiuitie:','captiuyte:'),'captivity:'),(('caytifte;','caitifte;'),'captivity;'),
    ...
    ((' dayly',' daylie'),' daily'),
        ...
        (('Dyall ',),'Dial '),((' diall ',),' dial '),
            (('Didst ','Diddest ',),'Didst/Did '),((' didst',' dyddest',' diddest',' didist',' dydst'),' didst/did'), (('Dyd ',),'Did '),((' dyd ',' diden ',' dide '),' did '),((' dide,',' dyd,'),' did,'),((' dide.',),' did.'),((' dide?',),' did?'),((' dyd:',),' did:'),
    ...
    (('habitaciouns','habitacios'),'habitations'),(('habitacion','habitacio'),'habitation'),
            ...
            ((' handes',' hondes',' hoondis',' hondys',' hondis',' hodes',' hades'),' hands'),((' hande ',' honde ',' hoond ',' hond ',' hode ',' hade '),' hand '),((' hande,',' honde,',' hond,',' hode,'),' hand,'),((' hande.',' honde.',' hond.',' hode.'),' hand.'),((' hande?',' honde?',),' hand?'),((' honde:',' hande:',' hade:'),' hand:'),((' hond;',),' hand;'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
            ...
            ((' sayest',' saiest',' seist'),' sayest/say'),((' seiynge',' sayenge',' sayege',' sayinge',' saynge'),' saying'), ((' saith',' saieth',' sayeth',' seyeth',' seith',' sayth',' seyth'),' saith/says'),(('(saith','(saieth','(sayeth',),'(saith/says'), (('(saye ',),'(say '),(('Seie ','Sei '),'Say '),((' seie ',' seye ',' saye ',' saie '),' say '),((' seie,',' saie,',' saye,'),' say,'),((' seie:',' saye:'),' say:'),((' saye)',' saie)'),' say)'),
        ...
        ((' syckle',),' sickle'),
            ...
            ((' sighinge',),' sighing'), ((' sighes',),' sighs'),
                ((' syght ',' sighte ',' siyt '),' sight '),((' sighte,',' siyt,'),' sight,'),((' syght.',' siyt.'),' sight.'),((' syght:',),' sight:'),((' siyt;',),' sight;'), ((' signes',),' signs'),((' signe ',),' sign '),((' signe:',),' sign:'),
