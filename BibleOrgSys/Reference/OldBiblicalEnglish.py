...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' backes',' backis'),' backs'),((' backe ',' bak '),' back '),((' backe,',' bak,'),' back,'),((' backe.',),' back.'),((' backe?',),' back?'),((' backe:',),' back:'),((' bak;',),' back;'),
        ...
        ((' blackenesse',' blacknesse'),' blackness'), ((' blackere',),' blacker'), ((' blacke ',' blake '),' black '),((' blacke,',' blak,'),' black,'),((' blacke:',),' black:'),
                ((' blamelesse',),' blameless'), ((' blameden',' blamyde'),' blamed'),((' blamyngi',' blamyng',),' blaming'),
                 ((' blasfemyes',),' blasphemies'),((' blasphemie ',' blasfemye '),' blasphemy '),((' blasfemye,',),' blasphemy,'),((' blasphemie:',),' blasphemy:'),((' blasfemye;',),' blasphemy;'),
                        ((' blasfemed',),' blasphemed'),(('blasphemeth ','blasfemeth '),'blasphemeth/blasphemes '),(('blasphemethe,',),'blasphemeth/blasphemes,'),
                    ((' blastinge',),' blasting'),
            ((' blemishe',),' blemish'),
        ...
        ((' bordes',' bords'),' boards'),
            ...
            ((' bowiden',' bowide',' bowede',' bowid',' bowen'),' bowed'),((' bowynge',' bowyng'),' bowing'),((' bowes',),' bows'),((' boweth',' bowith'),' boweth/bows'),(('Bouwe ','Bowe '),'Bow '),((' bouwe ',' bowe '),' bow '),((' bouwe,',' bowe,'),' bow,'),((' bowe.',),' bow.'),((' bowe:',),' bow:'), ((' bowles',' boules'),' bowls'),((' bowle,',' boule,',' boll,'),' bowl,'),
            ((' boxe ',),' box '),
            ((' boyes',),' boys'),
        ((' bracelette',),' bracelet'),
            ((' braynes',),' brains'),
...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
    ...
    ((' gaine ',),' gain '),((' gaine,',),' gain,'),((' gaine.',),' gain.'), (('Gayus',),'Gaius'),
            (('Galilea ','Galile ',),'Galilee '),(('Galile,',),'Galilee,'),(('Galile.','Galil.'),'Galilee.'),
                ((' galaries',),' galleries'), ((' galoun',),' gallon'), ((' gall ',' galle ',' gal '),' gall/bile '),((' gall,',),' gall/bile,'),((' gall.',' galle.',),' gall/bile.'),
    ...
    ((' Y ',),' I '),((' Y,',),' I,'),((' Y;',),' I;'),
        ...
        ((' ynne ',' yn '),' in '),((' ynne,',),' in,'),((' ynne?',),' in?'),
            ...
            (('enclyned','inclyned'),'inclined'), (('Encline','Enclyne','Inclyne'),'Incline'),((' encline',' enclyne'),' incline'),
                (('encreesside','encreessid','encreased'),'increased'),(('increaseth','encreessith','encressith'),'increaseth/increases'),((' increasinge',' encreessen'),' increasing'), ((' encreesse',' encrease'),' increase'),
    ...
    (('Keepers','Keperis',),'Keepers/Watchmen'),((' keepers',' keperis',),' keepers/watchmen'), ((' kepere',' keper'),' keeper'),((' keepest',' kepest',' kepist'),' keepest/keep'),((' keepeth',' kepith',' kepeth'),' keepeth/keeps'),((' kepynge',' kepyng',' keping'),' keeping'), ((' kepten',' kepte'),' kept'), (('Keepe ','Kepe '),'Keep '),((' kepen ',' keepe ',' kepe '),' keep '),((' keepe,',' kepe,'),' keep,'),
        ...
        ((' killidist',' killiden',' killide',' kylled',' kyllide',' kyllid'),' killed'),((' kyll ',),' kill '),((' kyll.',),' kill.'), ((' kilne',' kylne'),' kiln'),
            ...
            ((' kisside',' kissid',' kyssed',' kiste'),' kissed'),((' kisse ',' kysse '),' kiss '),((' kysse,',),' kiss,'),
        ...
        (('kniues','knyues'),'knives'),(('knyfe',),'knife'),
            (('knocke ',),'knock '),(('knocke,',),'knock,'),
                (('Knowest','Knowist'),'Knowest/Know'),(('knowest','knowist','knowst'),'knowest/know'),(('knoweth','knowith'),'knoweth/knows'),(('knowynge','knowyng'),'knowing'), (('Knouleche',),'Knowledge'),(('knowlege','knouleche'),'knowledge'), (('knowne','knowun','knowen'),'known'), (('Knowen ','Knowe ',),'Know '),((' knowe ',' woot '),' know '),((' knowe,',),' know,'),((' knowe.',),' know.'),((' knowe?',),' know?'),((' knowe:',),' know:'),((' knowe;',),' know;'),
    ...
    ((' madnesse',),' madness'),((' madnes ',),' madness '), ((' madde ',' madd '),' mad '),((' madde,',' madd,'),' mad,'),
        ...
        ((' mocke ',),' mock '),
            ...
            ((' mouyte ',),' moth '),
                (('modirles',),'motherless'), ((' modris ',),' mothers '),((' moder ',' modir '),' mother '),((' modir,',),' mother,'),((' modir.',),' mother.'),((' modir?',),' mother?'),((' modir;',),' mother;'), # don't mess up moderate
    ...
    ((' paiede',' payde',' payed',' payd'),' paid'),
        ...
        ((' pesible',),' peaceable'),(('Pees',),'Peace'),((' pees',),' peace'),
            ...
            (('peradventure','peraduenture','perauenture'),'peradventure/perhaps'),
                ...
                ((' perlous',),' perilous'), ((' perelis',' perels'),' perils'),((' perel ',),' peril '),((' perel.',),' peril.'),
                    ((' perischiden',' perischide',' perischid'),' perished'),((' perischyng',' perisching'),' perishing'), ((' perischen ',' perische ',' perisshe ',' perishe '),' perish '),((' perische,',' perishe,'),' perish,'),((' perische.',' perishe.'),' perish.'),((' perishe?',),' perish?'),((' perisshe:',' perishe:'),' perish:'),((' perische;',),' perish;'),
        ...
        ((' pointes',),' points'),((' poynte ',),' point '),((' poynte,',),' point,'),((' poynt',),' point'), ((' poyson ',),' poison '),
            ...
            (('possessyoun','possessioun'),'possession'),(('possessio:',),'possession:'), (('possessours',),'possessors'), (('possest',),'possessed'), (('possesse ',),'possess '),(('possesse.',),'possess.'),(('possesse,',),'possess,'),(('possesse:',),'possess:'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
        ...
        ((' sealeth',),' sealeth/seals'),((' seelide',),' sealed'),((' seale ',),' seal '),((' seale,',),' seal,'),
            ...
            ((' seest ',' siest ',' seyst '),' seest/see '),((' seeth ',' seeeth ',' seyth '),' seeth/sees '), (('Seynge','Seinge','Seyng'),'Seeing'),((' seynge',' seinge',' seyng',' seing', ' sien'),' seeing'),
                ...
                ((' seede ',' sede '),' seed '),((' seede,',' sede,'),' seed,'),((' seede.',' sede.'),' seed.'),((' seede:',' sede:'),' seed:'),
    ...
    ((' wagginge',),' wagging'),((' wagge ',),' wag '),
        ...
        (('Wee ',),'We '),((' wee ',),' we '),((' wee?',),' we?'),((' wee:',),' we:'),
            ...
            ((' weddid',),' wedded'), ((' weddyngy',),' wedding'), ((' wedlocke',),' wedlock'),
            ((' wedes',),' weeds'),
    ...
    (('Nephthali','Neptalym','Nephtali'),'Naphtali'),
        ...
        (('Nineueh','Niniue','Nynyue','Nineue'),'Nineveh'),(('Nineve,',),'Nineveh,'),(('Ninive.',),'Nineveh.'),
...
for wordMapEntry in ENGLISH_WORD_MAP:
    ...
    if newWord not in (' 40 ',' 60',
                       ' among ',' between',' burial','ed ',' can ',' cut ','grape-gatherers',' loved',
