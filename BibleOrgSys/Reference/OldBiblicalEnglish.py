...
LAST_MODIFIED_DATE = '2026-03-17' # by RJH
...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    (('drynck offerynge','drinke offering','drink offering','drinke offring','drynkofferinge','drinkofferinge','drynkofferynge','drynkoffrynge'),'drink-offering'),
    ...
    (('Aarons',),'Aaron’s'),
            ...
            (('Abyde ',),'Abide '),((' abidest',' abydest'),' abidest/abide'),((' abideth',' abydeth'),' abideth/abides'),(('abydinge','abidynge','abidinge'),'abiding'),((' abiden',),' abiding'), ((' abyde ',),' abide '),((' abyde,',),' abide,'),
    ...
    ((' backes',' backis'),' backs'),((' backe ',' bak '),' back '),((' backe,',' bak,'),' back,'),((' backe.',),' back.'),((' backe?',),' back?'),((' backe:',),' back:'),((' bak;',),' back;'),
        ...
        (('Bee ',),'Be '),((' bee ',),' be '),((' bee,',),' be,'),((' bee?',),' be?'), #(('>bee<',),'>be<'),((' bee<',),' be<'),
            ...
            ((' beanes',),' beans'),
                ...
                ((' betun',),' beaten'),((' beatinge',' beeten'),' beating'), (('Beate ','Beete '),'Beat '),((' beate ',' beete ',' bete '),' beat '),
        ...
        ((' bracelette',),' bracelet'),
            ...
            ((' brussed',),' bruised'),
                ((' bruite',),' brute'),
        ((' boket',' bokat'),' bucket'), ((' buckis',),' bucks'),((' bucke ',' buc '),' buck '),
...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
        ...
        ((' coales',' coolis',' coles'),' coals'),((' cole ',),' coal '),((' cole:',),' coal:'),
            ...
            (('conceiled',),'concealed'),((' conceale ',),' conceal '),
                ...
                (('conueniently','coueniently'),'conveniently'), (('conuenient','couenable'),'convenient'),
    ...
    ((' dayly',' daylie'),' daily'),
        ...
        ((' dekene',),' deacon'),
            ...
            ((' departiden',' departide',' departid'),' departed'),((' departynge',),' departing'),
                    (('Departe ',),'Depart '),((' departe ',),' depart '),((' departe,',),' depart,'),
        ...
        (('Dyall ',),'Dial '),((' diall ',),' dial '),
            ...
            ((' disalowing',),' disallowing'),((' dispoynted',),' disappointed'),(('disappointeth','dispoynteth'),'disappointeth/disappoints'),
                ...
                ((' dische ',),' dish '),((' disch,',),' dish,'),((' dissche.',' dysshe.',' disshe.'),' dish.'),
    ...
    ((' facis',),' faces'),
        ...
        ((' failiden',' failide',' failid',' fayled'),' failed'),((' failest',' faylest'),' failest/fail'),((' faileth',' fayleth',' faeleth',' failith',' faylith'),' faileth/fails'),((' failinge',),' failing'), ((' fayle ',' faile '),' fail '),((' failen,',' fayll,',' faile,',' fayle,'),' fail,'),((' faile.',' fayle.'),' fail.'),((' faile:',),' fail:'),((' faile;',),' fail;'),
            ...
            ((' fallun',),' fallen'),((' falle:',),' fallen:'),((' fallinge',' fallynge',' fallyng'),' falling'), ((' falles',),' falls'), (('Falle ',),'Fall '),((' falle ',' fal '),' fall '),((' falle,',' fal,'),' fall,'),
        ...
        ((' fewell',),' fuel'),
            ((' fugitiues',),' fugitives'),
            ((' fulleste',),' fullest'),((' fulli',),' fully'), ((' fulle ',' ful '),' full '),((' ful,',),' full,'),((' ful.',),' full.'),((' ful;',),' full;'), (('fulfillid','fulfylled'),'fulfilled'),(('fulfillynge','fulfyllyng'),'fulfilling'), ((' fulfill ',' fulfyll '),' fulfil '), ((' fulnesse ',' fulness ',' fulnes '),' fullness '),((' fulnesse,',' fulness,'),' fullness,'),((' fulnesse.',' fulness.'),' fullness.'),
    ...
    ((' gaine ',),' gain '),((' gaine,',),' gain,'),((' gaine.',),' gain.'), (('Gayus',),'Gaius'),
        ...
        ((' gratiouslye',),' graciously'), (('Gratious',),'Gracious'),((' gratious',),' gracious'),
                ...
                (('graved','grauyde','graued'),'graved/carved'),(('graven','grauen','grauun'),'graven/carved'),((' graving',' grauing'),' graving/carving'),((' graue',),' grave'),#((' graue,',),' grave,'),((' graue.',),' grave.'),((' graue:',),' grave:'),
                    ((' grauell ',),' gravel '),
                ((' graye ',' graie '),' gray '),
            (('grettere','gretter'),'greater'),(('grettest',),'greatest'), (('greetli','greetly','gretli'),'greatly'), (('greatnesse','greetnesse'),'greatness'),(('greatnes ',),'greatness '),(('greatnes.',),'greatness.'), (('Greate ',),'Great '),(('greate ','grete ','greet ','grett ','gret '),'great '),(('greate,','greet,'),'great,'),(('grett.','greate.','greet.'),'great.'),(('greate:',),'great:'),
    ...
    (('habitaciouns','habitacios'),'habitations'),(('habitacioun','habitacion','habitacio'),'habitation'),
            ...
            ((' handes',' hondes',' hoondis',' hondys',' hondis',' hodes',' hades'),' hands'),((' hande ',' honde ',' hoond ',' hond ',' hode ',' hade '),' hand '),((' hande,',' honde,',' hoond,',' hond,',' hode,',' hade,'),' hand,'),((' hande.',' honde.',' hond.',' hode.',' hade.'),' hand.'),((' hande?',' honde?',' hade?'),' hand?'),((' honde:',' hande:',' hode:',' hade:'),' hand:'),((' hond;',),' hand;'),((' honde)',),' hand)'),
                ...
                ((' hangid',),' hanged'),((' hangeth',' hangith'),' hangeth/hangs'), ((' hanginges',),' hangings/curtains'), ((' hangma ',),' hangman '),
                    ((' hange ',' hage '),' hang '),
    ...
    (('Keepers','Keperis',),'Keepers/Watchmen'),((' keepers',' keperis',),' keepers/watchmen'), ((' kepere',' keper'),' keeper'),((' keepest',' kepest',' kepist'),' keepest/keep'),((' keepeth',' kepith',' kepeth'),' keepeth/keeps'),((' kepynge',' kepyng',' keping'),' keeping'), ((' kepten',' kepte'),' kept'), (('Keepe ','Kepe '),'Keep '),((' kepen ',' keepe ',' kepe '),' keep '),((' keepe,',' kepe,'),' keep,'),
        ...
        ((' killidist',' killiden',' killide',' kylled',' kyllide',' kyllid',' killid'),' killed'),((' kyll ',),' kill '),((' kyll.',),' kill.'), ((' kilne',' kylne'),' kiln'),
            ((' kyndle',),' kindle'),((' kyndlide',' kyndelid',' kindeled',' kyndlid'),' kindled'), ((' kindenesse ',' kyndnesse ',' kindenes ',' kindnes ',' kyndnes '),' kindness '),((' kyndnesse,',' kindenesse,',' kindnesse,',' kindnes,',' kyndnes,'),' kindness,'),((' kyndnesse.',),' kindness.'),((' kyndnesse:',),' kindness:'),
                    ((' kynreddes',' kynredis',' kinredis',' kinreds'),' kindreds'),((' kinrede',' kynrede',' kynred',' kinred'),' kindred'), ((' kyndes',' kindes',' kyndis'),' kinds'),((' kynde ',' kinde ',' kyn '),' kind '),((' kinde,',' kynde,'),' kind,'),((' kynde.',),' kind.'),((' kynde:',),' kind:'),((' kynde;',),' kind;'),
    ...
    ((' labored',),' laboured'),((' labourest',),' labourest/labour'),((' labouringe',),' labouring'),((' laboures',),' labours'),((' laboure ',' labor '),' labour '),((' laboure,',' labor,'),' labour,'),((' laboure.',),' labour.'),((' laboure?',),' labour?'),
            ...
            ((' lambes',' lambren'),' lambs'), (('Lambe',),'Lamb'),((' lomb ',' lambe ',' labe '),' lamb '),((' lambe,',' lomb,'),' lamb,'),((' lambe.',' lomb.'),' lamb.'),((' lambe?',),' lamb?'),((' lambe:',),' lamb:'),((' lomb;',),' lamb;'),
        ...
        (('Loe,',),'Lo,'),
            ...
            ((' lokide',' loked'),' looked'),((' looketh',' loketh',' lokith'),' looketh/looks'),((' lykynge',' lokynge',' lokinge',' lokyng',' loking'),' looking'),(('Lokyng ',),'Looking '),((' lookes',' lokes'),' looks'),
                    (('Looke','Loke',),'Look'),((' looke ',' loke '),' look '),((' looke,',),' look,'),((' looke.',' loke.'),' look.'),((' loke?',),' look?'),
    ...
    ((' nailide',' naled'),' nailed'),((' nailis',' nailes',' nayles',' nales'),' nails'),((' naile ',' nale '),' nail '),((' naile,',),' nail,'),
        ...
        (('noumbriden','noumbride','noumbrid','noumbred','numbred','nombred'),'numbered'),(('numbereth','noumbrith'),'numbereth/numbers'),(('noumbre','nombre','nomber','numbre'),'number'),
    ...
    ((' TO ',),' T_o_ '),(('I O N',),'I_O_N'),(('T O B I T',),'T_O_B_I_T'),(('ALSO ',),'ALSO_ '),(('O ',),'Oh '),(('ALSO_ ',),'ALSO '),(('T_O_B_I_T',),'T O B I T'),(('I_O_N',),'I O N'),((' T_o_ ',),' TO '),
        (('Okes',),'Oaks'),((' okes',),' oaks'), (('Oke ',),'Oak '),(('Oke,',),'Oak,'),(('Oke.',),'Oak.'),((' oke ',' ook '),' oak '),((' oke,',' ook,'),' oak,'),((' oke.',' ook.'),' oak.'),((' oke;',' ook;'),' oak;'),((' oke:',),' oak:'),
            ((' oori',' oare'),' oar'),
            ((' oathes',' oothes',' othes',' othis'),' oaths'),((' othe ',' ooth ',' oth '),' oath '),((' othe,',' ooth,'),' oath,'),
    ...
    ((' paiede',' payde',' payed',' payd'),' paid'),
        ...
        (('preisiden','praysed','preiside','preisid','preysid'),'praised'),(('preisynge','praysinge','praysing','praysyng','preysyng','preisyng'),'praising'),(('Prayse',),'Praise'),(('prayse','preise','preyse'),'praise'),
                ...
                (('preyeden','preieden','preiede','preyede','praied','prayde','prayd'),'prayed'), (('preieris',),'prayers'), (('Praier ','Preier '),'Prayer '),(('preier','praier','preyer'),'prayer'),(('preyng',),'praying'),((' preye ',' praye ',' preie '),' pray '),((' preye,',),' pray,'),((' praye.',' preye.'),' pray.'),((' praye:',),' pray:'),
    ...
    (('Rabi',),'Rabbi'),
            ...
            ((' runnen ', ' ranne ',' rane '),' ran '),((' ranne,',),' ran,'),((' ranne.',),' ran.'),
                ((' ranke',),' rank'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
        ...
        ((' schadewi',' shadewi',' schadewe',' schadowe',' shadowe',' shadewe',' schadow'),' shadow'),
            ...
            (('Sche ','Shee '),'She '),((' sche ',' shee '),' she '),
                ...
                (('scheepherdis','schepherdis'),'shepherds'),(('Shepheard',),'Shepherd'),(('scheepherde','sheepherde','shepeherde','shepherde','sheephearde','shephearde','sheepheard','scheepherd','shepheard'),'shepherd'),
        ...
        ((' sokettes',' sockettes'),' sockets'),((' sokett',),' socket'),
            ...
            ((' souyten',' souyte',' souyt'),' sought'),
                ...
                ((' soundnesse',),' soundness'), ((' sownyng',),' sounding'), ((' sounde',' sownde'),' sound'),
                ((' soure',' sowre',),' sour'),
        ...
        ((' spak ',),' spake '),((' spak.',),' spake.'),((' spak;',),' spake;'),
            ...
            ((' spyces',),' spices'),((' spyce',),' spice'),
                ...
                (('spirituall ',),'spiritual '), (('spreted ',),'spirited '),((' spirites',' spiritis',' spretes'),' spirits'),(('Spirite','Spiryt'),'Spirit'),((' spirite ',' sprete '),' spirit '),((' spirite,',' sprete,'),' spirit,'),((' spirite.',' sprete.'),' spirit.'),((' spirite:',' sprete:'),' spirit:'),((' sprete)',),' spirit)'),
                    (('spotil','spetil','spettle'),'spittle'), ((' spyt ',),' spit '),
        ...
        ((' stabli ',),' stably '),((' stabli.',),' stably.'),
            ...
            (('straitnesse','straytnesse'),'straightness'), (('straitened','straitned'),'straightened'),(('strayght','streyght','streight','straite','strayte','streiyt','strate','streit'),'straight'),
                ...
                ((' streames',' streemys',' stremys'),' streams'),((' streame ',),' stream '),((' streame,',),' stream,'),((' streame.',' streem.'),' stream.'),
                    ...
                    (('strengthid','strengthned','strengthed'),'strengthened'), (('strengtheneth','strengthneth'),'strengtheneth/strengthens'), (('strenghten',),'strengthen'), (('strengthis',),'strengths'),(('strengthe ','streygth ','stregth '),'strength '),(('strengthe,','stregth,'),'strength,'),(('stregth.',),'strength.'),(('stregth:',),'strength:'),(('strengthe;',),'strength;'),
            ...
            ((' wychcraft',),' witchcraft'),
                (('withdrawne','withdrowen','withdrawen'),'withdrawn'), (('Withdrawe ',),'Withdraw '),((' withdrawe ',),' withdraw '),
                    ...
                    (('withholden','witholdun','withhelde','withelde'),'withheld'),(('withholde ','witholde '),'withhold '),
                        (('withouten ','withoute '),'without '), (('witnesside',),'witnessed'),(('witnessyng',),'witnessing'),(('witnessis',),'witnesses'),((' wytnesse ',' witnesse ',' witnes '),' witness '),((' wytnesse,',' witnesse,',' witnes,'),' witness,'),((' wytnesse.',),' witness.'),
    ...
    ((' beefes',' beeves',' beeues',),' cattle'), # Wycl 'Num 31:33
        ...
        ((' boorde ',' bourde '),' board/head_table '), # Mrk 6:22
    ...
    ((' manasside',),' menaced/threatened'), # Wycl Mrk 4:39
        ...
        ((' mansleyng',),' manslaying/murder'), # Wycl Num 35:21
    ...
    (('Galilea ','Galile ',),'Galilee '),(('Galile,',),'Galilee,'),(('Galile.','Galil.'),'Galilee.'),(('Galile:',),'Galilee:'),
    (('Grece',),'Greece'),
    (('Isaak',),'Isaac'),
    (('Israels',),'Israel\'s'),
