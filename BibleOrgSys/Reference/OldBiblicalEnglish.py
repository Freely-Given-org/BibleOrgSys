...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
        ...
        (('chaffe',),'chaff'),
            ...
            ((' chidden',),' chided/disputed/scolded'), # Lam 4:15
                ...
                (('childberyng',),'childbearing'),
                    ...
                    (('childes','chyldres'),'child’s'), (('childe ','chylde '),'child '),(('chylde,','childe,'),'child,'),(('chylde.','childe.'),'child.'),(('childe:',),'child:'),
    ...
    ((' nailide',' naled'),' nailed'),((' nailis',' nailes',' nayles',' nales'),' nails'),((' naile ',' nale '),' nail '),((' naile,',),' nail,'),
        ...
        ((' neere ',' neare '),' near '),((' neere,',' neare,',' nye,'),' near,'),((' neere.',' neare.'),' near.'),((' neere:',' neare:'),' near:'),((' neere;',' niy;'),' near;'),
            ...
            (('Neverthelesse ','Neuerthelesse ','Neuertheles ','Netheles '),'Nevertheless '),(('Neuerthelesse,','Neuertheles,','Netheles,'),'Nevertheless,'),(('neuerthelesse','neverthelesse'),'nevertheless'),(('neuertheles ','netheles '),'nevertheless '),(('neuertheles)',),'nevertheless)'), ((' neuere',' neuer'),' never'),
    ...
    ((' beefes',' beeves',' beeues',),' cattle'), # Wycl 'Num 31:33
        ...
        ((' boorde ',' bourde '),' board/head_table '),((' bord,',),' board/table,'), # Mrk 6:22, 7:28
