...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    (('Ech ',),'Each '),((' eche ',' ech '),' each '),((' ech,',),' each,'),
        ...
        ((' encampeth',' incampeth'),' encampeth/encamps'),((' encampe ',),' encamp '),
            ...
            ((' entise ',),' entice '),
                ((' entred',' entriden',' entride',' entrid'),' entered'),((' entereth',' entreth',' entrith'),' entereth/enters'),((' entryng',' entring',' entren'),' entering'), (('Entre ',),'Enter '),((' entre ',),' enter '),
        ...
        ((' of;',),' off;'),
                ((' offende ',),' offend '),((' offende,',),' offend,'),((' offende.',),' offend.'),
                    (('offryngis','offeringes','offrynges'),'offerings'),((' offerynge',' offeryng',' offeringe',' offringe',' offring',' offryng',' offren'),' offering'),
                        ((' offriden',' offride',' offred'),' offered'),((' offerest',' offridist'),' offerest/offer'),((' offereth',' offreth'),' offereth/offers'), (('Offre ',),'Offer '),((' offre ',),' offer '),((' offre,',),' offer,'),
                ((' offycer',),' officer'),
        ...
        (('whalfishes',),'whales'),
            ...
            ((' wheete',' wheate',' whete'),' wheat'),
                ...
                (('Wheras ',),'Whereas '), ((' wherby',),' whereby'), (('Wherfore','Wherfor'),'Wherefore'),((' wherfore ',),' wherefore '), ((' wherynne ',' wherin '),' wherein '), ((' wherof ',),' whereof '),
                    (('wheresoeuer','whersoeuer'),'wheresoever'), (('whervnto',),'whereunto'), (('wherevpon','whervpon','wherupon'),'whereupon'), (('wherwith',),'wherewith'),
    ...
    ((' defoulen',),' trampling_on'), # Psa 56:4
        ...
        ((' dom ',),' judgement '),((' dom,',),' judgement,'),((' dom;',),' judgement;'), # Lam 3:35,36, Psa 111:5
            ((' doomes',),' judgements'),((' doom',),' judgement'), # Eze 20:11,36
