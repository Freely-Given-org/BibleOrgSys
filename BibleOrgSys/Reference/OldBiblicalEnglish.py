...
LAST_MODIFIED_DATE = '2026-02-19' # by RJH
...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
        ...
        (('preisiden','praysed','preiside','preisid','preysid'),'praised'),(('preisynge','praysinge','praysing','praysyng','preysyng','preisyng'),'praising'),(('Prayse',),'Praise'),(('prayse','preise','preyse'),'praise'),
            ...
            (('prechiden','prechide','prechid'),'preached'), (('preachyng','prechynge','preachinge','prechen'),'preaching'), (('preche ','preache '),'preach '),(('preche,',),'preach,'),
                ...
                (('presentes',),'presents'),
                    ...
                    ((' pressours',),' presses'), ((' preasse ',' prease ',' presse ',' preace '),' press '),((' preasse,',' prease,',' presse,'),' press,'),((' presse?',),' press?'),
    ...
    (('Rabi',),'Rabbi'),
        ...
        ((' rored',),' roared'),((' roaringe',),' roaring'),((' roare ',' rore '),' roar '),((' roare,',' rore,'),' roar,'),
            ...
            (('Roude ',),'Round '),((' rounde ',' roude ',' roud '),' round '),
            ((' roouys',),' rooves'),
            ((' rowes',),' rows'),((' rowe ',),' row '),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
        ...
        ((' syckle',' syccle',' syckell',' sikil',' sykell'),' sickle'),
                (('sijknessis',),'sicknesses'),((' sijknesse ',' syknesse ',' sickenesse ',' sicknesse ',' sikenesse ',' sickeness ',' sickenes ',' sicknes '),' sickness '),((' sicknesse,',' sikenesse,',' sickeness,',' sickenes,'),' sickness,'),((' sicknesse.',' sijknesse.',' siknesse.',' sicknes.'),' sickness.'),((' sijknesse;',),' sickness;'),
    ...
    ((' tabering',' tabring'),' tabering/beating'), (('tabernaclis',),'tabernacles/tents'),
        ...
        ((' thankfull ',),' thankful '),(('thankefull.','thankfull.'),'thankful.'), (('Thankes',),'Thanks'),(('thanckes','thankes','thakes'),'thanks'),(('thanke ',),'thank '),
            ...
            ((' threede',' threed'),' thread'), (('thretenede',),'threatened'),(('threatning',),'threatening'), ((' thre ',),' three '),((' thre,',),' three,'),((' thre:',),' three:'),
                ...
                (('thrusteth','throusteth'),'thrusteth/thrusts'),((' thristynge',),' thrusting'),
