...
LAST_MODIFIED_DATE = '2026-02-20' # by RJH
...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
    ...
    (('habitaciouns','habitacios'),'habitations'),(('habitacioun','habitacion','habitacio'),'habitation'),
        ...
        (('Hee ',),'He '),((' hee ',),' he '),((' hee,',),' he,'),((' hee?',),' he?'),((' hee;',),' he;'),((' hee)',),' he)'),(('(hee ',),'(he '),
            ...
            (('Hir ',),'Her '), ((' hir ',' hyr '),' her '),((' hir,',' hyr,'),' her,'),((' hir.',),' her.'),((' hir;',),' her;'),
    ...
    ((' labored',),' laboured'),((' labourest',),' labourest/labour'),((' labouringe',),' labouring'),((' laboures',),' labours'),((' laboure ',' labor '),' labour '),((' laboure,',' labor,'),' labour,'),((' laboure.',),' labour.'),((' laboure?',),' labour?'),
            ...
            ((' layeth',' laieth',' laith'),' layeth/lays'),(('Laye ',),'Lay '),((' laye ',' lai '),' lay '),((' laye,',),' lay,'),((' laye.',),' lay.'),
    ...
    ((' madnesse',),' madness'),((' madnes ',),' madness '), ((' madde ',' madd '),' mad '),((' madde,',' madd,'),' mad,'),
            ...
            ((' masoun',),' mason'),
                ((' maistrie',' maistri'),' mastery'), (('Maister','Maistir'),'Master'),((' maister',' maistir'),' master'), ((' mastes',),' masts'),
        ...
        (('Michah ','Micha '),'Micah '),
            ...
            ((' mynded',),' minded'),((' myndefull ',' mindfull ',' mindefull ',' myndfull '),' mindful '),((' myndeful',),' mindful'), ((' myndes',' mindes'),' minds'), (('Mynde ',),'Mind '),((' mynde ',' minde '),' mind '),((' mynde,',' minde,'),' mind,'),((' minde.',' mynde.'),' mind.'),((' minde:',' mynde:'),' mind:'),((' mynde;',),' mind;'),
                ...
                ((' myngle',),' mingle'),
                ((' ministerie ',),' ministry '),((' ministery',),' ministry'), (('ministred','mynistred','mynystriden','mynistriden','mynystride'),'ministered'),((' ministring',),' ministering'),((' mynystris',),' ministers'),((' mynyster',' mynister',' mynystren',' mynystre'),' minister'),
                ((' minstrell',),' minstrel'),
            ((' myracles',),' miracles'),
    ...
    ((' TO ',),' T_o_ '),(('I O N',),'I_O_N'),(('T O B I T',),'T_O_B_I_T'),(('ALSO ',),'ALSO_ '),(('O ',),'Oh '),(('ALSO_ ',),'ALSO '),(('T_O_B_I_T',),'T O B I T'),(('I_O_N',),'I O N'),((' T_o_ ',),' TO '),
        ...
        ((' onne?',),' on?'),
            ((' onys,',),' once,'), ((' oon ',),' one '),((' oon.',),' one.'),((' oon,',),' one,'),((' oon;',),' one;'), (('Onely ','Oneli '),'Only '),((' onely ',' onlye ',' oneli ',' oonli '),' only '),((' onely,',),' only,'),((' onely.',),' only.'),
    ...
    ((' tabering',' tabring'),' tabering/beating'), (('tabernaclis',),'tabernacles/tents'),
        ...
        ((' traffique ',' traffick '),' traffic '),
                ...
                ((' traueilide',' trauailed',' traueiled'),' travailed'),(('travailest','trauelist','traueilist'),'travailest/travail'),(('travaileth','traueileth','trauaileth','traueilith','trauelleth','trauayleth','traualeth'),'travaileth/travails'),(('trauelinge','trauelynge','trauailing','traueiling'),'travailing'), ((' trauelis',),' travails'),(('trauayle','trauaile','traueile','trauell'),'travail'),
    ...
    ((' wagginge',),' wagging'),((' wagge ',),' wag '),
        ...
        (('Wee ',),'We '),((' wee ',),' we '),((' wee?',),' we?'),((' wee:',),' we:'),
            ...
            ((' woukis',' weekes',' wekes'),' weeks'),((' weeke',' weke'),' week'),
                ((' weepeth',' wepeth',' wepith',),' weepeth/weeps'),((' weepyng',' wepyng',' weepinge',' wepinge',' wepige',' wepingi',' wepen'),' weeping'),((' wepten',' weapte',' wepte',),' wept'),((' weepe ',' wepe '),' weep '),((' weepe,',' wepe,'),' weep,'),((' wepe.',),' weep.'),((' weepe?',' wepe?'),' weep?'),((' weepe:',' wepe:'),' weep:'),((' wepe;',),' weep;'),
