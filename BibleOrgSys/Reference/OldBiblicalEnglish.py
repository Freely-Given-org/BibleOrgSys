...
LAST_MODIFIED_DATE = '2026-02-13' # by RJH
...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    (('foule spirite','foule sprete','fowle sprete'),'foul spirit'), # Mrk 5:8
    (('fro God',),'from God'),
    ...
    ((' asunder',' a sunder',' in sunder',' in sonder',' asundre',' insunder'),' asunder/apart'), # Amos 6:11, Psa 46:9
    ...
    (('Aarons',),'Aaron’s'),
        ...
        ((' aparte',),' apart'),
            ...
            ((' apparell',),' apparel'), ((' apparaunt',),' apparent'),
                (('appearaunce',),'appearance'),(('appearynge','apperynge','apperinge','apperenge','appearyng'),'appearing'),((' apperiden',' appered',' apperide',' apeared',' apperid'),' appeared'),((' appeareth',' apeareth'),' appeareth/appears'), ((' appeare ',' appere '),' appear '),((' appeare,',' apeare,'),' appear,'),((' appeare:',),' appear:'),
    ...
    ((' backes',' backis'),' backs'),((' backe ',' bak '),' back '),((' backe,',' bak,'),' back,'),((' backe.',),' back.'),((' backe?',),' back?'),((' backe:',),' back:'),((' bak;',),' back;'),
        ...
        (('Bee ',),'Be '),((' bee ',),' be '),((' bee,',),' be,'),((' bee?',),' be?'), #(('>bee<',),'>be<'),((' bee<',),' be<'),
            ...
            ((' beanes',),' beans'),
                ...
                ((' betun',),' beaten'),((' beatinge',),' beating'), (('Beate ','Beete '),'Beat '),((' beate ',' beete '),' beat '),
...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
        ...
        ((' coales',' coolis',' coles'),' coals'),((' cole ',),' coal '),((' cole:',),' coal:'),
                ((' coostis',' coastes',' coostes',' costes'),' coasts'), ((' coost',),' coast'),
    ...
    ((' dayly',' daylie'),' daily'),
        ...
        ((' dekene',),' deacon'),
                ((' deedly',' dedly'),' deadly'),
                ((' deafe ',' deef '),' deaf '),((' deafe,',),' deaf,'),((' deafe.',),' deaf.'),((' deef;',),' deaf;'),((' deafe:',),' deaf:'),
            ...
            (('descendinge',),'descending'),(('descende ',),'descend '),(('descende,',),'descend,'),
                ...
                ((' deserte ',),' desert '),((' deserte,',),' desert,'),((' deserte.',),' desert.'),((' deserte?',),' desert?'),((' deserte:',),' desert:'),((' deseert',),' desert'),
                    ((' deserue',),' deserve'),
    ...
    ((' facis',),' faces'),
        ...
        ((' feares',),' fears'), (('Feare ',),'Fear '),(('Feare,',),'Fear,'),((' feare ',),' fear '),((' feare,',),' fear,'),((' feare.',),' fear.'),((' feare?',),' fear?'),((' feare:',),' fear:'),
            ...
            ((' feble',),' feeble'),#((' feble,',),' feeble,'),((' feble;',),' feeble;'),
                ((' feedeth',' fedeth'),' feedeth/feeds'),((' fedynge',' fedinge'),' feeding'), (('Feede ','Fede '),'Feed '),((' feede ',' fede '),' feed '),((' fede,',),' feed,'),((' feede.',),' feed.'),
                ((' feele ',),' feel '),
                ((' feete',' fete'),' feet'),
        ...
        ((' fidelitie ',),' fidelity '),
                ...
                ((' fiends',' feendis',),' fiends/devils'),((' fiend ',' fiende ',' feend ',' fende '),' fiend/devil '),((' fiend,',' fiende,',' feend,'),' fiend/devil,'),
    ...
    ((' gaine ',),' gain '),((' gaine,',),' gain,'),((' gaine.',),' gain.'), (('Gayus',),'Gaius'),
        ...
        ((' gratiouslye',),' graciously'), (('Gratious',),'Gracious'),((' gratious',),' gracious'),
                ...
                ((' graunted',' grauntide'),' granted'), (('Graunte ','Graunt '),'Grant '),((' graunte ',' graunt ',' grante ',' graut '),' grant '),
    ...
    (('habitaciouns','habitacios'),'habitations'),(('habitacioun','habitacion','habitacio'),'habitation'),
            ...
            ((' haye ',),' hay '),
        (('Hee ',),'He '),((' hee ',),' he '),((' hee,',),' he,'),((' hee?',),' he?'),((' hee;',),' he;'),((' hee)',),' he)'),(('(hee ',),'(he '),
            ((' hedling',' heedlinges'),' headlong'), ((' heades',' heddes',' heedis'),' heads'),((' heade ',),' head '),((' heade,',),' head,'),((' heade.',),' head.'),
                ...
                ((' heardest',' herdest',' herdist',' herdst'),' heardest/heard'),((' hearde',' herden'),' heard'),((' hearest',' herist'),' hearest/hear'),((' heareth',' herith'),' heareth/hears'),((' herynge',' hearyng',' heryng',' hearinge',' heringe',' heriyngi',' heriyng',' hering',' heren'),' hearing'),(('Heare ',),'Hear '),(('Heare,',),'Hear,'),((' heare ',' heere ',),' hear '),((' heare,',),' hear,'),((' heare.',),' hear.'),((' heare?',),' hear?'),((' heare:',),' hear:'),
            ...
            ((' heldeth',' heldith'),' heldeth/holds'), (('HOLDEN',),'HELD'),((' helde ',),' held '),((' holdun',' holden'),' held'),
            ...
            (('Hir ',),'Her '), ((' hir ',' hyr '),' her '),((' hir,',),' her,'),((' hir.',),' her.'),((' hir;',),' her;'),
                ...
                (('heardman','herdman'),'herdsman'), (('hirdmen','hyrdmen','heardmen','herdmen'),'herdsmen'), ((' heards',),' herds'),((' heerde',' heerd',),' herd'),
                ((' herafter',),' hereafter'),
        ...
        ((' hiliden ',' hidde ',' hyd '),' hid '),((' hyd,',),' hid,'),((' hidest',' hydest',' hidist'),' hidest/hide'),((' hideth',' hydeth',' hidith'),' hideth/hides'), (('Hyde ',),'Hide '),((' hyde ',),' hide '),
            ((' hygher ',' hiyere ',' hyer '),' higher '), (('Hyest',),'Highest'),((' hyghest',' hiyeste',' hiyest',' hyest',' hiest'),' highest'), ((' hyghly',' hyelie'),' highly'), ((' hiynessis',),' highnesses'),((' hiynesse',' hyynesse'),' highness'),
    ...
    ((' iawes',),' jaws'),
        ...
        ((' ioyning',),' joining'), ((' ioyned',' ioined'),' joined'),((' ioyne ',),' join '), ((' ioints',' ioyntes',' ioynts'),' joints'),((' ioynt',),' joint'),
            (('Iorney',),'Journey'),(('iourneye','iourney','iourneie','iournei'),'journey'),
    ...
    ((' labored',),' laboured'),((' labourest',),' labourest/labour'),((' labouringe',),' labouring'),((' laboures',),' labours'),((' laboure ',' labor '),' labour '),((' laboure,',' labor,'),' labour,'),((' laboure.',),' labour.'),((' laboure?',),' labour?'),
            ...
            ((' lambes',' lambren'),' lambs'), (('Lambe',),'Lamb'),((' lomb ',' lambe ',' labe '),' lamb '),((' lambe,',),' lamb,'),((' lambe.',),' lamb.'),((' lambe?',),' lamb?'),((' lambe:',),' lamb:'),
        ...
        ((' leeder',' ledere'),' leader'), (('leadest','laddest','leedist','ledest'),'leadest/lead'),(('leadeth','ledith','ledeth'),'leadeth/leads'), (('Leade ','Lede '),'Lead '),((' leade ',' leede ',' lede '),' lead '),((' leade,',' leed,',' lede,'),' lead,'),((' leed.',),' lead.'),
                ...
                ((' leeuys',' leeues',' leaues',' leves'),' leaves'), ((' leaveth',' leaueth',' leeueth'),' leaveth/leaves'), (('Leaue ',),'Leave '),((' leeue ',' leaue ',' leue ',' leve '),' leave '),((' leaue.',' leue.'),' leave.'),((' leaue:',),' leave:'),
    ...
    ((' madnesse',),' madness'),((' madnes ',),' madness '), ((' madde ',' madd '),' mad '),((' madde,',' madd,'),' mad,'),
            ...
            ((' marre ',),' mar '),
                ...
                (('marueyled','marueiled','merveled','marueled','merveyled','marveled'),'marvelled'), (('Marueylous','Maruelous','Maruelos',),'Marvellous'),(('marueilous','merueilis','marueylous','maruellous','maruelous','meruailous','merueiylis','meruaylous','marvelous'),'marvellous'), ((' merueils',),' marvels'), (('Marueyle ','Maruell '),'Marvel '),((' marueile',' merveyle',' maruayle',' maruell',),' marvel'),
        ...
        ((' mocke ',),' mock '),
            ...
            (('Mountayne','Mounteyn','Mountaine','Munteyn'),'Mountain'),((' mountaynes',' moutaynes',' mountaines',' mounteyns',' moutaines',' moutayns'),' mountains'),((' mountayne',' mounteyn',' mountaine'),' mountain'), ((' moute ',' moūt ',' mout '),' mount '),
    ...
    ((' TO ',),' T_o_ '),(('I O N',),'I_O_N'),(('T O B I T',),'T_O_B_I_T'),(('ALSO ',),'ALSO_ '),(('O ',),'Oh '),(('ALSO_ ',),'ALSO '),(('T_O_B_I_T',),'T O B I T'),(('I_O_N',),'I O N'),((' T_o_ ',),' TO '),
        ...
        ((' owid ',),' owed '), ((' owest',' owist'),' owest/owe'),
            (('Owle ','Oule '),'Owl '),((' owle',),' owl'), ((' awne ',' owne '),' own '),((' owne,',' awne,'),' own,'),((' owne.',),' own.'),((' owne:',),' own:'),((' owne;',),' own;'),
    ...
    ((' paiede',' payde',' payed',' payd'),' paid'),
        ...
        (('preisiden','praysed','preiside','preisid','preysid'),'praised'),(('preisynge','praysinge','praysing','praysyng','preysyng','preisyng'),'praising'),(('Prayse',),'Praise'),(('prayse','preise','preyse'),'praise'),
                ...
                (('preyeden','preieden','preiede','praied','prayde','prayd'),'prayed'), (('preieris',),'prayers'), (('Praier ','Preier '),'Prayer '),(('preier','praier','preyer'),'prayer'),(('preyng',),'praying'),((' preye ',' praye ',' preie '),' pray '),((' preye,',),' pray,'),((' praye.',),' pray.'),((' praye:',),' pray:'),
        ...
        ((' publique ',),' public '), (('Publicane',),'Publican'), (('puplischid','publysshed'),'published'),(('Publishe',),'Publish'),((' publyshe',' publisshe','puplishe ','publishe '),'publish '),
            ((' puft',),' puffed'),
    ...
    (('Rabi',),'Rabbi'),
        ...
        ((' rored',),' roared'),((' roaringe',),' roaring'),((' roare ',' rore '),' roar '),((' roare,',' rore,'),' roar,'),
            ...
            ((' rod ',' rodde ',' rodd '),' rod/staff '),((' rod,',' rodde,',),' rod/staff,'),((' rodde.',),' rod/staff.'),((' rodde:',),' rod/staff:'),
            (('Roo ',),'Roe/Gazelle '),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
        ...
        ((' sealeth',),' sealeth/seals'),((' seelide',),' sealed'),((' seale ',),' seal '),((' seale,',),' seal,'),
            ...
            ((' seest ',' siest ',' seyst '),' seest/see '),((' seeth ',' seeeth ',' seyth '),' seeth/sees '), (('Seynge','Seinge','Seyng'),'Seeing'),((' seynge',' seinge',' seyng',' seing', ' sien'),' seeing'),
                ...
                ((' seyn ',' seene ',' sene ',' sien '),' seen '),((' seyn,',' seene,',' sene,',' saien,',' sien,'),' seen,'),((' seene.',' sene.',' seyn.'),' seen.'),((' seene:',),' seen:'),
...
for wordMapEntry in ENGLISH_WORD_MAP:
    ...
    if newWord not in (' 40 ',' 60',
                       ...
                       ' feeding','grape-gatherers','immediately',' loved',
