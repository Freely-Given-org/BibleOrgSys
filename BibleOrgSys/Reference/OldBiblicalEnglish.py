...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' a councell',' a councel',' a consell'),' a council'), # Bshps Mrk 15:1, Mat 5:22
    ...
    (('brede doutes',),'breed doubts'), # Cvdl/TNT 1Tim 1:4
        (('breede in',),'breed in'), # Bshps Gen 8:17
        (('the breede of',),'the breadth of'), # Wycl Eze 41:26
    ...
    ((' his mete ',),' his meat/food '), # Wycl Mat 3:4
    ...
    ((' may breede',),' may breed'), # Gnva Gen 8:17
    ...
    (('the counsels',),'the councils'),(('the counsell ',),'the council '),(('the counseil;',),'the council;'), # Mrk 13:9, 14:55
    ...
    (('axe hym breed',),'asks him bread'),(('axed hym bred',),'asked him bread'), # Mat 7:9
    ...
    (('heuenes is herne.',),'heavens is theirs.'), # Wycl Mat 5:3
    ...
    (('corne floores','cornefloores','cornflooris'),'corn-floors/storage-barns'),(('corne floore','corn floor','corn flore','cornefloore','cornfloor'),'corn-floor/storage-barn'), # Hos 9:1
    ...
    (('hence forthe','hence forth','hece forth','hencefoorth','hensforth'),'henceforth'), # Also covers thenceforth
    ...
    ((' no thing ',),' nothing '), # Wycl Mat 5:13
    ((' no where ',),' nowhere '),
    ...
    (('Aarons',),'Aaron’s'),
            ...
            ((' abroade',' abroode',' abrode',' abrood'),' abroad'),
        ...
        (('Adde ',),'Add '),((' adde ',),' add '),((' adde,',),' add,'),((' adde)',),' add)'),
            ...
            ((' aduoutrers',),' adulterers'),(('auoutressis',),'adulteresses'),(('adulteresse)',),'adulteress)'),(('adultresse,','auoutresse,'),'adulteress,'), (('avowtresse','aduouterous','advoutrous'),'adulterous'),
                ((' auowtries',' auoutries'),' adulteries'),((' adulterie ',' aduoutrie ',' aduoutry ',' advoutrie ',' advantry ',' auowtri ',' adultry '),' adultery '),((' adulterie,',' aduoutrye,',' aduoutry,',' auoutrie,',' auowtrie,'),' adultery,'),((' aduoutrye.',' adulterie.',' aduoutrie.',' advoutrie.',' auowtrye.',' advoutry.',' adultry.'),' adultery.'),((' adulterie:',),' adultery:'),((' auowtrie;',),' adultery;'),
        ...
        (('ayenstonde',),'stand_against'), (('Agaynst',),'Against'),((' agaynste',' ageynste',' ageynst',' agaist',' ayenus',' ayenst',' ayens'),' against'),(('agaynst',),'against'), (('Agayne','Againe'),'Again'),((' ageine ',' ayen ',),' again '),((' ageyne,',' ayen,'),' again,'),((' ayen.',),' again.'),((' ayen?',),' again?'),((' ayen;',),' again;'),((' agayne',' ageyne',' againe'),' again'),
                ((' agaste',),' aghast'),
            ((' agonye',' agonie'),' agony'),
            ((' aggreed',),' agreed'),((' agrement',),' agreement'),((' agreeth',' agreth'),' agreeth/agrees'),(('Agre ',),'Agree '),
        (('Ahaua',),'Ahava'),
        ((' ayde ',' aide '),' aid '),((' ayde,',),' aid,'),((' ayde.',),' aid.'),((' ayde:',),' aid:'),
            ((' ayled',),' ailed'),((' aileth',' ayleth'),' aileth/ails'),
            ((' aire ',' ayre ',' eyr '),' air '),((' aire,',' ayre,',' eire,',' eir,'),' air,'),((' ayer.',' eir.'),' air.'),((' ayre:',' ayer:',' aire:'),' air:'),((' eir;',),' air;'),
        ((' alablaster',),' alabaster'),
            ...
            ((' altare',' aulter',' auteri',' auter',' altre'),' altar'), ((' alltogether',),' altogether'),
        (('amased',),'amazed'),
            (('Embassitour',),'Ambassador'),(('ambassadour','embassadour'),'ambassador'),
            ((' amendement',' amendemet'),' amendment'), ((' amendid',),' amended'),((' amendyng ',),' amending '),((' amendes',),' amends'), (('Amende ','Amede '),'Amend '),((' amende ',' amede ',),' amend '),
            ((' amisse',' amysse'),' amiss'),
        ...
        ((' auncient',),' ancient'),
            ...
            (('Angell',),'Angel'),((' aungeli',' aungel',' angell'),' angel'),
                ((' angred',),' angered'), ((' angrie ',' angre '),' angry '),((' angrie,',' angrye,'),' angry,'),((' angrie?',),' angry?'),((' angrie!',),' angry!'),((' angrie:',),' angry:'),
                ((' angwischid',' angwisched'),' anguished'),((' anguishe ',),' anguish '),((' angwische',' angwisch'),' anguish'),
            ((' anoiede',' anoyed'),' annoyed'),((' anoye ',),' annoy '),
            (('Annoynted','Annointed','Anoynted'),'Anointed'),(('anoyntiden','anoyntide','anoyntid','anointide','annoynted','anoynted','annointed'),'anointed'),((' annoynte',' annoynt',' annoint',' anoynte',' anoynt'),' anoint'),
        ...
        (('ascencioun',),'ascension'), ((' ascende ',),' ascend '),((' ascende,',),' ascend,'),
            ...
            ((' asleepe',' aslepe'),' asleep'),
             ((' askeden',' axeden',' axiden',' axide',' axed'),' asked'), (('Askest','Axist'),'Askest/Ask'),((' askest',' axist'),' askest/ask'),((' asketh',' axith'),' asketh/asks'), (('Aske',),'Ask'),((' aske ',),' ask '),((' aske.',' axen.',' axe.'),' ask.'),((' aske?',),' ask?'),((' aske:',),' ask:'), ((' to axe ',),' to ask '),
        ...
        ((' auailed',),' availed'),((' availeth',' auaileth'),' availeth/avails'),((' auaile ',),' avail '),
            ...
            (('Auen',),'Aven'),((' avengeth',' auengeth'),' avengeth/avenges'),((' aueng',' aueg'),' aveng'),
                ((' auerse',),' averse'),
            (('Auoyde','Avoyde','Avoyd'),'Avoid'),((' auoyd',' auoid'),' avoid'),
        (('Awaye ',),'Away '),((' awaye',' aweye',' awaie',' awei',' awey',),' away'),((' awai.',),' away.'),
    ((' bablynge',' bablinge'),' babbling'),((' bable',),' babble'),
    ((' backes',' backis'),' backs'),((' backe ',' bak '),' back '),((' backe,',' bak,'),' back,'),((' backe.',),' back.'),((' backe?',),' back?'),((' backe:',),' back:'),((' bak;',),' back;'),
            ...
            (('baptysed','baptisid'),'baptised'), (('baptisynge','baptisyng'),'baptising'), (('Baptisme',),'Baptism'),(('baptisme','baptyme','baptym','baptim'),'baptism'), ((' baptyse',),' baptise'),
            ((' barres',' barris'),' bars'),((' barre ',),' bar '),((' barre.',),' bar.'),
                ((' barbour',),' barber'),
                ((' barefoote',),' barefoot'),
                ((' barke ',),' bark '),
                ((' barlye',' barlie',' barli',' barly'),' barley'),
                ((' barne',' berne'),' barn'), #((' barne?',),' barn?'),
                ((' barrell',),' barrel'),
        ...
        (('Bee ',),'Be '),((' bee ',),' be '),((' bee,',),' be,'),((' bee?',),' be?'), #(('>bee<',),'>be<'),((' bee<',),' be<'),
            ...
            ((' beanes',),' beans'),
                ((' bearest',' berist'),' bearest/bear'),
                    (('Beares','Beeres'),'Bears'),((' beares ',' beeris '),' bears '), # Protect 'bearest'
                        (('Beare ',),'Bear '),(('Beare,','Bere,'),'Bear,'),((' beare ',' beere ',' bere '),' bear '),((' beare,',' bere,',),' bear,'),((' beare.',),' bear.'),((' beare:',),' bear:'),((' bere;',),' bear;'),
            ...
            (('Bifore ','Bifor '),'Before '),((' bifore ',' byfore ',' bifor ',' befor '),' before '),((' bifore,',' bifor,',),' before,'),((' bifore.',),' before.'),((' bifore;',),' before;'),
        ...
        ((' blackenesse',' blacknesse'),' blackness'), ((' blackere',),' blacker'), ((' blacke ',' blake '),' black '),((' blacke,',' blake,',' blak,'),' black,'),((' blacke.',),' black.'),((' blacke:',),' black:'),((' blacke;',),' black;'),
        ...
        ((' bordes',' bords'),' boards'),
                ((' boostinge',' boastyng'),' boasting'), ((' boastes',),' boasts'),
                 ((' bootys',' boates'),' boats'),
            ((' bodili ',' bodely '),' bodily '), ((' bodyes',),' bodies'), ((' boddy ',' bodye ',' bodie ',' bodi '),' body '),((' bodie,',' bodi,'),' body,'),((' bodie.',' bodi.'),' body.'),((' bodi;',),' body;'),
            ...
            ((' borderyng',' borderinge'),' bordering'),((' boordes',),' borders'),
                ((' borowe ',' borewe ',' borow '),' borrow '),((' borowe,',),' borrow,'),
        ...
        ((' bracelette',),' bracelet'),
            ((' braynes',),' brains'),
                ...
                ((' brawne',),' brawn'),
            ((' breed ',' brede ',' bred '),' bread '),((' breade',),' bread'), ((' bredth',),' breadth'),
            ...
            (('brickkiln','bricke-kill','brickyll'),'brick-kiln'), (('brycke','bricke','bryck'),'brick'),
                ...
                ((' brimme ',),' brim '),
                (('bringest','bryngest'),'bringest/bring'),(('bringeth','bryngethe','bryngeth','bringith','bryngith'),'bringeth/brings'),(('brynginge','bryngynge','bringinge','bringige','bryngyng','bringyng','bryngen'),'bringing'), (('Brynge ','Bringe ','Bryng '),'Bring '),((' brynge ',' bryng ',' bringe '),' bring '),
                ((' brinke ',),' brink '),
            (('broddere',),'broader'),(('broddeste',),'broadest'), ((' broade ',' brode '),' broad '),((' broode,',),' broad,'),((' brode.',),' broad.'),((' broade:',),' broad:'),
                ((' brokun',' breken'),' broken'), ((' braken ',' brak '),' broke '),((' brak,',),' broke,'),
                ((' brookes',' brokes'),' brooks'),((' brooke ',),' brook '),((' brooke,',),' brook,'),((' brooke.',),' brook.'),
                ((' brodel ',' bordel '),' brothel ' ), (('Brothir',),'Brother' ),((' brothir',),' brother' ),
        ...
        ((' boket',' bokat'),' bucket'), ((' buckis',),' bucks'),((' bucke ',' buc ',' buk '),' buck '),
            ...
            ((' busshell',' busschel',' busshel',' bushell',' buschel'),' bushel'), ((' busshe ',),' bush '),((' buysch,',' bushe,'),' bush,'),
                ((' bisili',),' busily'), ((' bysy ',' busie ',' bisi ',' bisy '),' busy '),((' bisi,',),' busy,'),((' bisye?',),' busy?'),((' bisi;',),' busy;'),
    ...
    ((' cabines',),' cabins'),((' kab ',),' cab '),
            ((' calamitie ',),' calamity '),((' calamitie,',),' calamity,'),((' calamitie.',),' calamity.'),((' calamitie:',),' calamity:'),
                ...
                ((' calme ',),' calm '),((' calme,',),' calm,'),((' calme.',),' calm.'),((' calme:',),' calm:'),
            ...
            ((' canst ',' canste '),' canst/can '),((' kunne ',' kan ',' ca '),' can '),
                ...
                (('candlestickes','candelstickes','candelstyckes','candlestyckes','candilstikis'),'candlesticks'), (('Candlesticke',),'Candlestick'),(('candilstike','candelsticke','candlesticke'),'candlestick'),
                    ((' candell',' candel',' cadell'),' candle'),#((' candell ',),' candle '),((' cadle,',),' candle,'),((' candell:',),' candle:'),
...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
        ...
        (('chaffe',),'chaff'),
            ...
            ((' chidden',),' chided/disputed/scolded'),((' chyde',),' chide'), # Lam 4:15, Mrk 8:32
                ...
                (('childberyng',),'childbearing'),
                    ...
                    (('childrens','chyldrens','childres'),'children’s'),(('chyldren','chyldern'),'children'),(('childre ','chyldre '),'children '),(('childre,',),'children,'),(('childre.',),'children.'),(('childre:',),'children:'),
        ...
        ((' claymed',),' claimed'),
            ...
            ((' cloocke',' cloake',' clooke',' cloke'),' cloak'),
                ((' cloddes',),' clods'),
                ((' closide',' closid'),' closed'),
                (('clothiden','clothide','cloathed','clothid'),'clothed'),((' clotheth',' clothith'),' clotheth/clothes'), ((' clothingis',' clothinge',' clothyng'),' clothing'), (('cloothis','clothis','cloathes'),'clothes'),((' cloutes',),' cloths'),((' clooth',),' cloth'),
        ...
        ((' coales',' coolis',' coles'),' coals'),((' cole ',),' coal '),((' cole:',),' coal:'),
                ...
                ((' cootis',' coottes',' coates',' cotes'),' coats'),((' coote ',' cote '),' coat '),((' coote,',' coate,',' cote,'),' coat,'),
            ...
            ((' commers',),' comers'), (('Comest ','Commest '),'Comest/Come '),((' comest ',' commest '),' comest/come '),((' comest,',' commest,'),' comest/come,'),
                ...
                ((' conforted',' coforted',' coumfortide',' coumfortid'),' comforted'),((' comforteth',' coumfortith'),' comforteth/comforts'),((' coumfortour',' coforter'),' comforter'),(('coumfortynge',),'comforting'), ((' cofortles ',),' comfortless '), (('Comforte ','Coumfort ','Coforte '),'Comfort '),((' coumforten ',' coumforte ',' comforte ',' coumfort ',' coforte '),' comfort '),((' comforte,',' comforth,',' coumfort,',' conforte,'),' comfort,'),((' comforte.',),' comfort.'),((' comforte:',' conforte:'),' comfort:'),
                    (('Commaundement','Commandement'),'Commandment'),(('commaundemeutes','commaundementes','comaundementis','commandementes','commandements','commandmentes','commaudemetes','commaundemetes','commaundmentes','comaundementes','comaundemetes','comaundmentes','comaudementes'),'commandments'),(('commaudement','commaundement','comaundement','commandement','commadement','commaundemet','comandement','comaundemet'),'commandment'),
                        ...
                        ((' commende ',),' commend '),
                        (('commytted','comytted'),'committed'),(('committeth','commytteth','comitteth'),'committeth/commits'), (('Comitte ',),'Commit '),((' committe ',' comitte ',' committ '),' commit '),((' commyt',' comit'),' commit'),
            ...
            (('conceiled',),'concealed'),((' conceale ',),' conceal '),
                ...
                ((' confederacie ',),' confederacy '), ((' cofederate ',),' confederate '),
                    ((' conferre ',),' confer '),
                        (('cofessynge','confessynge','confessyng','cofessing'),'confessing'), (('confessioun',),'confession'),(('Confesse',),'Confess'),((' confesse ',' cofesse '),' confess '),((' confesse,',),' confess,'),((' confesse.',),' confess.'),((' confesse:',),' confess:'),
                ...
                (('consentest','consentedst'),'consentest/consent'), ((' consente ',),' consent '),
                    ...
                    (('constitucioun',),'constitution'), ((' constrayned',' constreynede',' constreinede',' costrayned'),' constrained'),((' constraineth',' constreyneth'),' constraineth/constrains'),((' constreyne ',),' constrain '),
            ...
            (('Corall',),'Coral'),((' corall',),' coral'), ((' coarde',' coard',' corde'),' cord'), #((' coardes',' cordes'),' cords'), ((' coorde,',),' cord,'),((' coard',),' cord'),
                ...
                (('Corne ',),'Corn '),((' corne ',),' corn '),((' corne,',),' corn,'),((' corne.',),' corn.'),((' corne?',),' corn?'),((' corne:',),' corn:'),((' corne;',),' corn;'),
                    ((' cornerid',),' cornered'),((' corneris',),' corners'),
            ...
            ((' costis',),' costs'),
            ((' coutche ',' couche '),' couch '),((' couche,',),' couch,'),((' couche.',),' couch.'),
                ...
                ((' councellour',' councelour'),' councillor'),
                        ...
                        ((' counsayles',' councels'),' councils/counsels'), (('Councill ',),'Council '),(('Councill,',),'Council,'),(('Councill.',),'Council.'),((' counsell ',' counsel ',' councill ',' councell ',' councel '),' council/counsel '),((' counsel,',' counsell,',' coucel,'),' council/counsel,'),((' counsell.',' councell.',' cousell.'),' council/counsel.'),((' counsell:',' counsel:',' counsayle:'),' council/counsel:'),((' counsell;',),' council/counsel;'),
            ...
            (('Couenant',),'Covenant'),((' couenannt',' couenaunt',' couenaut',' couenant'),' covenant'),
                ((' couerdest',' couered'),' covered'), ((' covereth',' couereth',),' covereth/covers'),((' coverest',' couerest',),' coverest/cover'), ((' coueringe',' couerynge',' couering'),' covering'), (('Couer',),'Cover'),((' couer',),' cover'),
                    ((' couert',),' covert'),
                (('couetousnesse','coueteousnes','coueitise','couetousnes','cuvetousnes','coveteousnes'),'covetousness'),((' couetous',' coueytise'),' covetous'), ((' coueitide',' coueted'),' coveted'),((' coveteth',' coueitith',' coueteth'),' coveteth/covets'), ((' coueyte ',' coueite '),' covet '),((' couet',),' covet'), # (('cuvetousnes.',),'covetousness.'),
        ...
        ((' cubytes',' cubites',' cubitis'),' cubits'),((' cubite ',),' cubit '),((' cubite,',),' cubit,'),((' cubite.',),' cubit.'),
            ...
            ((' cuppis',' cuppe',),' cup'),
            ((' keuered',),' cured'),
                (('Cursid',),'Cursed'),((' cursedest',' cursedst',' cursidist',' cursiden',' curside',' cursid'),' cursed'),((' curseth',' cursseth',' cursith'),' curseth/curses'),((' cursyngi',' cursynge',),' cursing'),((' coursse ',' cursse ',),' curse '),
    ...
    ((' dayly',' daylie'),' daily'),
            ...
            (('darckened','darkned'),'darkened'),((' darcke ',' darke ',' derke ',' derk '),' dark '),((' darcke,',' darke,',' derk,'),' dark,'),((' darke.',' derk.'),' dark.'),((' darke?',),' dark?'),((' darke:',),' dark:'),((' darke;',),' dark;'),
                    (('darckenes ','darcknes ','darkenes ','darknes ','dercknes '),'darkness '),(('darckenes,','darkenes,','darcknes,','darknes,'),'darkness,'),(('darckenes.','derckenes.','darkenes.'),'darkness.'),(('darckenes:','darkenes:','darknes:'),'darkness:'),(('darcknesse','derknesse','derknessis','darkenesse','darknesse'),'darkness'),
                ((' derlingi',' dearlyng',' dearlinge',' dearling',' derlynge',' derlyng',' derlinge',' derling'),' darling'),
                ((' dartes',' dartis'),' darts'),((' darte ',),' dart '),
            ((' dasshed',),' dashed'),((' dashe ',),' dash '),
        ...
        ((' dekene',),' deacon'),
            ...
            ((' delaied',),' delayed'),((' delayes',),' delays'),
                ...
                (('delyueraunce','delyuerauce','deliueraunce','deliuerance','delyverauce'),'deliverance'), ((' delyuerer',' deliuerer'),' deliverer'),
                    (('deliueridist','delyueriden','delyueride','delyuerid','deliuered','delyuerede','delyuered','delyvered'),'delivered'),(('deliverest','delyuerest','deliuerest'),'deliverest/deliver'),(('delivereth','delyuereth','deliuereth'),'delivereth/delivers'), (('Deliuer ','Delyuere ','Delyuer '),'Deliver '),((' delyuere ',' diliuere ',' delyuer ',' deliuer ',' delivre ',' delyver '),' deliver '),((' delyuere.',),' deliver.'),((' delyuere?',),' deliver?'),((' deliuer',' delyuer',' delyvre'),' deliver'),
            ((' demaund',),' demand'),
            ...
            (('descendinge',),'descending'),((' descende ',' descede '),' descend '),((' descende,',),' descend,'),
                ...
                ((' destroier',),' destroyer'), ((' destroyest',' distriest'),' destroyest/destroy'),((' destrieden',' distriede',' destriede',' destroied',' destried',' distried'),' destroyed'),(('destroyethe','destrieth','distrieth'),'destroyeth/destroys'),(('distriynge','distriyng','destrien','distrien'),'destroying'), (('Destroie ',),'Destroy '),((' distrie ',' destrie ',' destroye ',' distroye ',' distruye ',' destroie ',' destoy '),' destroy '),((' destroye,',' distrie,'),' destroy,'),
                    (('destruccios',),'destructions'),(('destruccion','distruction'),'destruction'),(('destruccio ',),'destruction '),
            ((' determyne',),' determine'),
            ((' deuyces',),' devices'),
                ((' deuelis',' devylles',' deuylles',' devvyls',' deuils',' deuyls',' deuels',' diuels',' devyls'),' devils'),((' devyll',' deuell',' deuyll',' dyvell',' devill',' deuill',' deuel'),' devil'),
        ...
        (('Dyall ',),'Dial '),((' diall ',),' dial '), ((' diamonde',),' diamond'),
            ...
            ((' disalowing',),' disallowing'),((' dispoynted',),' disappointed'),(('disappointeth','dispoynteth'),'disappointeth/disappoints'),
                ...
                ((' desease',' disese',' dysease'),' disease'),
            ...
            ((' dyuerse ',' diverse ',' divers ',' dyvers ',' diuerse ',' diuers ',' dyuers '),' diverse/various '), ((' dyuersitee',' dyuersite'),' diversity'),
                ...
                (('devorsement','deuorcemet','diuorcement','devorcement'),'divorcement'), ((' diuorced',' divorsed',' deuorsed',' devorsed'),' divorced'),
        ((' doere',),' doer'), (('Dost ','Doest '),'Dost/Do '), ((' doeth',' doith',' doth'),' doeth/does'), (('Doe ','Doo '),'Do '),((' doo ',' doe '),' do '),((' doe,',),' do,'),((' doe.',),' do.'),((' doe?',),' do?'),((' doe:',),' do:'),
    ...
    (('Ech ',),'Each '),((' eche ',' ech '),' each '),((' ech,',),' each,'),
            ...
            ((' eeten',' eten'),' eaten'),((' eateth',' etith'),' eateth/eats'),((' eatinge',' etynge',' eatyng',' etyng'),' eating'),
                (('Eate ','Ete '),'Eat '),((' eate ',' eete ',' ete ',' eet '),' eat '),((' eate,',' ete,',' eet,'),' eat,'),((' eate.',' ete.',' eet.'),' eat.'),((' eate?',' ete?'),' eat?'),((' eate:',' ete:'),' eat:'),((' eate;',' ete;'),' eat;'),
        ((' effecte',),' effect'),
        ((' egge',),' edge'),
        ...
        ((' eiyetithe',' eiytethe',' eiytthe'),' eighth'), (('eighteene','eightene','eiytene'),'eighteen'), (('eiytetithe',),'eightieth'), ((' eiyti',),' eighty'), ((' eiyte',' eyght'),' eight'),
            (('Ethir ',),'Either '),((' eithir ',' eyther ',' ethir ',' ether '),' either '),
        ...
        ((' encampeth',' incampeth'),' encampeth/encamps'),((' encampe ',),' encamp '),
            ...
            ((' endid',),' ended'),((' endyng',),' ending'), ((' endes',' endis'),' ends'),((' eende ',' ende '),' end '),((' ende,',),' end,'),((' ende.',),' end.'),((' ende?',),' end?'),((' ende:',),' end:'),((' ende;',),' end;'),
                ...
                ((' indure',),' endure'),
            ((' enemyes',' enimies'),' enemies'),((' enemye ',' enemie ',' enimie '),' enemy '),((' enemie,',' enemye,'),' enemy,'),((' enemie.',' enemye.',' enimy.'),' enemy.'),((' enemie:',),' enemy:'),((' enemie?',' enemye?'),' enemy?'),
        ...
        ((' euidence',),' evidence'),((' euident',),' evident'),
            (('Euilmerodach','Euil-merodach','Euylmeradach'),'Evil-merodach'), ((' yuelis',),' evils'),((' evyll',' euell',' euill',' euil',' euyll',' euyl',' evell',' evill',' yvell',' yuell',' yuele',' yuel',' euel'),' evil'),
        ((' yowes',),' ewes'),
        ((' exalte ',),' exalt '),
                (('Examen',),'Examine'),((' examen',),' examine'),
            ((' exceaded',),' exceeded'), (('excedyngly','exceadingly','exceedyngly','exceadyngly','excedingly'),'exceedingly'),((' excedynge',' exceadinge',' exceadyng',' excedyng'),' exceeding'),((' exceede ',' exceade ',' excede '),' exceed '),((' exceede,',),' exceed,'),
        ...
        ((' iyen ',),' eyes '),((' iyen,',),' eyes,'),((' iyen.',),' eyes.'),((' iyen;',),' eyes;'),((' eies',),' eyes'),((' eie ',' iye '),' eye '),((' iye,',' eie,',' ey,'),' eye,'),((' iye?',),' eye?'),((' iye;',),' eye;'), # ((' eies:',),' eyes:'),
    ((' fablis',),' fables'),
        ((' facis',),' faces'),
        ...
        ((' failiden',' failide',' failid',' fayled'),' failed'),((' failest',' faylest'),' failest/fail'),((' faileth',' fayleth',' faeleth',' failith',' faylith'),' faileth/fails'),((' failinge',),' failing'), ((' fayle ',' faile '),' fail '),((' failen,',' fayll,',' faile,',' fayle,'),' fail,'),((' faile.',' fayle.'),' fail.'),((' faile:',),' fail:'),((' faile;',),' fail;'),
            ...
            ((' fallun',),' fallen'),((' falle:',),' fallen:'),((' falleth',' fallith'),' falleth/falls'),
                        ((' fallinge',' fallynge',' fallyng'),' falling'), ((' falles',),' falls'), (('Falle ',),'Fall '),((' faule ',' faull ',' falle ',' fal '),' fall '),((' falle,',' fal,'),' fall,'),
            ...
            ((' farthynge',' farthinge',' farthige',' farthyng',' ferthing'),' farthing'),
             ...
             (('fashioneth','facioneth'),'fashioneth/fashions'),((' facion',),' fashion'),
                ((' fastest',' fastist'),' fastest/fast'), ((' faste ',),' fast '),((' faste,',),' fast,'),((' faste.',),' fast.'),((' fastiden',' fastid'),' fasted'),((' fastynge',' fastyng',' fastinge'),' fasting'), (('fastnyde','fastned'),'fastened'),
        ...
        ((' feares',),' fears'), (('Feare ',),'Fear '),(('Feare,',),'Fear,'),((' feare ',),' fear '),((' feare,',),' fear,'),((' feare.',),' fear.'),((' feare?',),' fear?'),((' feare:',),' fear:'),
            ...
            ((' feble',),' feeble'),#((' feble,',),' feeble,'),((' feble;',),' feeble;'),
                ((' feedeth',' fedeth',' fedith'),' feedeth/feeds'),((' fedynge',' fedinge'),' feeding'), (('Feede ','Fede '),'Feed '),((' feede ',' fede '),' feed '),((' feede,',' fede,'),' feed,'),((' feede.',),' feed.'),
                ((' feele ',),' feel '),
                ((' feete',' fete'),' feet'),
        ...
        ((' fidelitie ',),' fidelity '),
                ...
                ((' fiends',' feendis',' fendis'),' fiends/devils'),((' fiend ',' fiende ',' feend ',' fende '),' fiend/devil '),((' fiend,',' fiende,',' feend,'),' fiend/devil,'),((' feend.',),' fiend/devil.'),
            ...
            ((' figges',' fygges',' fyges',' figis',' figus'),' figs'),((' fygge ',' fyge ',' figge ',' fige ',),' fig '),
            ...
            ((' finnes',),' fins'),
            ((' fyndyngis',),' findings'),((' fyndynge',' fynden'),' finding'), ((' findeth',' fyndeth',' fyndith',' findith'),' findeth/finds'), ((' fynde ',' finde '),' find '),((' fynde.',' fynd.'),' find.'),((' finde:',' fynde:'),' find:'),((' fynde;',),' find;'),
                ((' fyne',),' fine'),
            ...
            (('fischis','fisshes','fysshes','fyshes'),'fishes'),(('fisscheris','fischeris','fisshers','fysshers','fyshers','fy?shers'),'fishers'), ((' fysshe ',' fishe '),' fish '),((' fysshe,',' fische,',' fyshe,',' fishe,',),' fish,'),((' fisch',' fysh'),' fish'),
                ((' fistes',),' fists'),
            ((' fyt ',),' fit '),
        ...
        ((' foale',),' foal'),
            ...
            ((' foode ',),' food '),((' foode,',' fode,'),' food,'),((' foode:',),' food:'),
                ((' foolis ',' fooles '),' fools '),((' foolis,',' fooles,'),' fools,'),((' foolis.',' fooles.'),' fools.'),((' fooles:',),' fools:'),((' fooles;',),' fools;'), # Needs a trailing space coz of foolish
                        (('Foole','Fy'),'Fool'),((' foole ',' fole '),' fool '),((' foole,',),' fool,'),((' foole.',),' fool.'),((' foole?',),' fool?'),((' foole:',),' fool:'),
            ...
            ((' forbad ',),' forbade '),((' forbeare',),' forbear'), ((' forbydden',' forbodun'),' forbidden'), (('Forbede ','Forbyd '),'Forbid '),((' forbeed ',' forbede ',' forbyd '),' forbid '),
                ...
                (('Fornycacioun',),'Fornication'),(('fornicacioun','fornycacioun','fornicacion',),'fornication'),(('fornicacio ',),'fornication '),
            ...
            ((' fouler',),' fowler'),((' fowls',' fowles',' foules',' foulis'),' fowls/birds'),((' fowl ',' foule ',),' fowl/bird '),((' foule,',),' fowl/bird,'),((' foule.',),' fowl/bird.'),((' fowl:',' foule:'),' fowl/bird:'),((' fowl;',),' fowl/bird;'), # ((' foules,',),' fowls/birds,'),((' foules.',),' fowls/birds.'),((' foules:',),' fowls/birds:'),
        ...
        ((' fragmentes',),' fragments'), ((' fraile ',),' frail '),
            ...
            (('fruitfull ','frutefull ','fruytful ','fruteful '),'fruitful '),(('fruitfull,','frutefull,'),'fruitful,'),(('fruitfull.','fruitefull.','frutefull.','frutfull.'),'fruitful.'),(('fruitefull:',),'fruitful:'),
                (('fruites','fruitis','fruytis','frutes'),'fruits'),((' fruyt ',' frute ',' fruite ',' fruyte ',' frut '),' fruit '),((' fruite,',' frute,',' fruyt,'),' fruit,'),((' fruite.',' frute.',' fruyt.'),' fruit.'),((' fruite:',' frute:'),' fruit:'),((' fruite;',),' fruit;'),
            (('friynge ','friyng '),'frying '),
        ((' fewell',),' fuel'),
            ((' fugitiues',),' fugitives'),
            ((' fulleste',),' fullest'),((' fulli',),' fully'), ((' fulle ',' ful '),' full '),((' ful,',),' full,'),((' ful.',),' full.'),((' ful;',),' full;'), (('fulfillid','fulfylled'),'fulfilled'),(('fulfillynge','fulfyllyng'),'fulfilling'), ((' fulfille ',' fulfill ',' fulfull ',' fulfyll '),' fulfil '),((' fulfille.',' fulfill.',' fulfyll.'),' fulfil.'),
                ((' fulnesse ',' fulness ',' fulnes '),' fullness '),((' fulnesse,',' fulness,'),' fullness,'),((' fulnesse.',' fulness.'),' fullness.'),
            ((' furiousnes ',),' furiousness '),
                ((' fournace',' fornace',' furneis'),' furnace'),
    ...
    ((' gaine ',),' gain '),((' gaine,',),' gain,'),((' gaine.',),' gain.'), (('Gayus',),'Gaius'),
            ...
            ((' garmentes',' garmetes'),' garments'),((' garmente',' garmet'),' garment'),
                ...
                (('garison',),'garrison'),
            ((' gappes',),' gaps'),
            ((' yatis',),' gates'),((' yate',),' gate'), (('gaderiden','gadirid','gaderide','gaderid','gaddered','gadered','gaddred'),'gathered'),((' gathereth',' gaderith'),' gathereth/gathers'),((' gatheringe',' gaderynge',' gadering',' gaderen'),' gathering'), (('Gadere ',),'Gather '),((' gadere ',' gaddre ',' gadre ',' geder '),' gather '),((' gadere.',),' gather.'),
        ...
        ((' geare ',' geer ',' gere '),' gear '),
            ((' generall ',),' general '),
                ...
                (('Gentyles','Gentyls','Getiles'),'Gentiles'),((' gentyls',' getyls'),' gentiles'),
                    (('gentlenesse',),'gentleness'),(('gentlenes:',),'gentleness:'), ((' getly',),' gently'),
            (('Gett ',),'Get '),((' gett ',),' get '),
        ((' goost',' ghoste',' gost'),' ghost'),
        (('Gyant','Giante'),'Giant'),((' giaunti',' giaunte',' giaunt',' giaute',' gyant'),' giant'),
            (('giddines.',),'giddiness.'),
            ((' giftes',' gyftes',' yiftis'),' gifts'),((' gifte ',' yifte '),' gift '),((' gyfte.',' yifte.'),' gift.'),((' yifte;',),' gift;'),((' gyft',),' gift'),
            ((' ginne ',),' gin '),
            ...
            ((' yyueris',),' givers'),((' giuer',' yyuer'),' giver'),
                ((' givest',' giuest',' geuest',' gevest',' yyuest'),' givest/give'),((' giveth',' giueth',' yyueth',' yiueth',' geueth'),' giveth/gives'), ((' geven',' giuen',' geuen',' youun',' youe',' yyuen'),' given'),((' geve.',),' given_to.'), ((' giuing ',' geuynge ',' geuyng ',' geuing '),' giving '),
                (('Geue ','Giue ','Geve ','Yyue ','Yiue '),'Give '),((' geve ',' geue ',' giue ',' yyue ',' yiue '),' give '),((' geve,',' geue,',' giue,',' yyue,'),' give,'),((' giue?',' yyue?',' geue?',' geve?'),' give?'),
        ...
        ((' goates',' gotes'),' goats'),(('Goate',),'Goat'),((' goet ',' gote ',' geet '),' goat '),((' goate',),' goat'), # Take care with 'goeth'
            ...
            ((' goddesse ',),' goddess '), (('godlynesse',),'godliness'), (('Goddis','Goddes','Godis'),'God’s'),((' goddes',' goddis',),' gods'),
        ...
        ((' gratiouslye',),' graciously'), (('Gratious',),'Gracious'),((' gratious',),' gracious'),
            ...
            (('grettere','gretter'),'greater'),(('grettest',),'greatest'), (('greatlye','greetli','greetly','gretli'),'greatly'), (('greatnesse','greetnesse'),'greatness'),(('greatnes ',),'greatness '),(('greatnes.',),'greatness.'), (('Greate ',),'Great '),(('greate ','grete ','greet ','grett ','gret '),'great '),(('greate,','greet,'),'great,'),(('grett.','greate.','greet.'),'great.'),(('greate:',),'great:'),
                ...
                (('gretinge','gretten','greten'),'greeting'),((' greete ',),' greet '),
                ((' grewe',),' grew'),
            ((' griefe',' grefe'),' grief'),
            ...
            (('gronynge','gronyng','groning'),'groaning'),(('grone ',),'groan '),(('grone?',),'groan?'),
                ...
                (('groaue','groue',),'grove'),
                (('growinge',),'growing'), (('growne','growen'),'grown'), ((' grouth',),' growth'), ((' growe',),' grow'),#((' growe ',),' grow '),((' growe,',),' grow,'),((' growe.',),' grow.'),
        ((' guardeth',' gardeth'),' guardeth/guards'),((' garde ',),' guard '),
                ((' gardes',),' gardens'),((' gardyn',),' garden'), ((' garlande',),' garland'),
            ((' gessiden',' gesside'),' guessed'),((' guessest',' gessist'),' guessest/guess'), ((' gessinge',' gessen'),' guessing'), (('Gessist',),'Guess'),
    ...
    (('habitaciouns','habitacios'),'habitations'),(('habitacioun','habitacion','habitacio'),'habitation'),
            ...
            ((' halfe',' halue'),' half'), #((' halfe ',' halue '),' half '),((' halfe,',),' half,'),((' halfe.',),' half.'),((' halfe:',),' half:'),
                (('Halleluiah','Hallelujah','Alleluia'),'Halleluyah'),(('Halleluya.',),'Halleluyah.'),
                    ((' hallis',),' halls'),((' halle ',),' hall '),((' halle,',' hal,'),' hall,'),((' halle.',),' hall.'),((' halle;',),' hall;'),
                        (('Hallowed',),'Hallowed/Consecrated'),(('hallowed','halowed','halewide','halewid'),'hallowed/consecrated'),((' hallowing',' halewynge',' halewyng'),' hallowing/consecration'),((' hallow ',' halowe ',' halewe '),' hallow/consecrate '),
            ...
            ((' hatefull ',),' hateful '),((' hatefull.',),' hateful.'), ((' hatide ',),' hated '),((' hateth',' hatith'),' hateth/hates'),((' hatest',' hatidist',' hatist'),' hatest/hate'),((' hatinge',' hatiden',' haten'),' hating'),
                ((' hathe ',' hath '),' hath/has '),
                ((' hatrede',),' hatred'),
        ...
        (('Hee ',),'He '),((' hee ',),' he '),((' hee,',),' he,'),((' hee.',),' he.'),((' hee?',),' he?'),((' hee;',),' he;'),((' hee)',),' he)'),(('(hee ',),'(he '),
            ((' hedling',' heedlinges'),' headlong'), ((' heades',' heddes',' heedis'),' heads'),((' heade ',),' head '),((' heade,',),' head,'),((' heade.',),' head.'),
                ((' helide',' heelide',' heelid'),' healed'),((' healeth',' hilith'),' healeth/heals'),((' heelynge',' hilynge',' hilyng'),' healing'),((' heale ',),' heal '),((' heale:',),' heal:'),
                ...
                ((' heate ',' heete ',' heet '),' heat '),((' heete,',),' heat,'),((' heate?',),' heat?'),((' heate:',),' heat:'),((' heate;',),' heat;'), (('Hethene','Heythen','Heithen','Hethen','Heithe','Heythe'),'Heathen'),((' hethene',' heithen',' hethen',' hethe'),' heathen'),
                ((' heuenli',' heauely',' hevely'),' heavenly'), (('Heuenes',),'Heavens'),((' heauens',' heuenes',' heuenys',' heaues'),' heavens'), (('Heauen','Heuene','Heven'),'Heaven'),((' heauen',' heuene',' heuen',' heven'),' heaven'),((' heaue ',' heue '),' heaven '),((' heaue,',),' heaven,'),((' heaue.',' heue.'),' heaven.'),((' heaue:',),' heaven:'),
                        ((' heaued',),' heaved'),
        ...
        (('Hoorde',),'Hoard'), ((' hoar ',' hoare ',' hoore '),' hoar/grey '),
            ...
            ((' houndis',),' hounds'),
                ...
                ((' housis',' howsis'),' houses'),((' housse ',' hous ',' hows '),' house '),((' housse',),' house'),((' hous,',' hows,'),' house,'),((' hows.',' hous.'),' house.'),((' hous?',),' house?'),((' hows;',' hous;'),' house;'), (('houssholde ','householde ','housholde '),'household '),((' houshold',),' household'),
        ...
        (('Iacyncte','Iacinct'),'Hyacinth'),((' iacynt',' iacinct'),' hyacinth'),
            ...
            ((' hypocrisie',' ypocrisye',' ypocrisie',' ypocrisy'),' hypocrisy'),
                (('Ypocryte','Ipocrite'),'Hypocrite'),((' ypocrite',' ypocryte',' ypocriti',' ipocriti'),' hypocrite'),
    ...
    ((' Y ',),' I '),((' Y,',),' I,'),((' Y?',),' I?'),((' Y;',),' I;'),
        ...
        ((' ynne ',' yn '),' in '),((' ynne,',),' in,'),((' ynne?',),' in?'),
            ...
            (('inhabitours','inhabitauntes','inhabitaunts','inhabitantes','inhabitans'),'inhabitants'), (('enhabited',),'inhabited'),(('inhabite ','enhabite '),'inhabit '),
                (('enheritaunce','enheritauce','inheritaunce','inheritauce'),'inheritance'), ((' inheret ',' inherite ',' enherite ',' enheret ',' enerite '),' inherit '),((' inherite,',),' inherit,'),((' inherite.',),' inherit.'),
            ...
            (('integritie',),'integrity'),
                ((' intente ',),' intent '),
                (('interpretacion','interpretaeion'),'interpretation'),(('interprete ',),'interpret '),
    ...
    (('Keepers','Keperis',),'Keepers/Watchmen'),((' keepers',' keperis',),' keepers/watchmen'), ((' kepere',' keper'),' keeper'),((' keepest',' kepest',' kepist'),' keepest/keep'),((' keepeth',' kepith',' kepeth'),' keepeth/keeps'),((' kepynge',' kepyng',' keping'),' keeping'), ((' kepten',' kepte'),' kept'), (('Keepe ','Kepe '),'Keep '),((' kepen ',' keepe ',' kepe '),' keep '),((' keepe,',' kepe,'),' keep,'),((' kepe;',),' keep;'),
        ...
        ((' killeth',' kylleth'),' killeth/kills'),((' killidist',' killiden',' killide',' kylled',' kyllide',' kyllid',' killid'),' killed'),((' kyllinge',),' killing'), ((' kil ',),' kill '),((' kyll',),' kill'), #((' kyll,',),' kill,'),((' kyll.',),' kill.'),((' kyll:',),' kill:'),
            ...
            ((' kyndle',),' kindle'),((' kyndlide',' kyndelid',' kindeled',' kyndlid'),' kindled'), ((' kindenesse ',' kyndnesse ',' kindenes ',' kindnes ',' kyndnes '),' kindness '),((' kyndnesse,',' kindenesse,',' kindnesse,',' kindnes,',' kyndnes,'),' kindness,'),((' kyndnesse.',),' kindness.'),((' kyndnesse:',),' kindness:'),
                ...
                (('Kingdome',),'Kingdom'),(('kyngedome','kingdome','kyngdome','kigdome','kyngdoom','kyngdom','kingdam'),'kingdom'),
        ...
        (('kniues','knyues'),'knives'),(('knyfe',),'knife'),
            (('knocketh','knockith'),'knocketh/knocks'),(('knocke ',),'knock '),(('knocke,',),'knock,'),
    ...
    ((' labored',),' laboured'),((' labourest',),' labourest/labour'),((' labouringe',),' labouring'),((' laboures',),' labours'),((' laboure ',' labor '),' labour '),((' laboure,',' labor,'),' labour,'),((' laboure.',),' labour.'),((' laboure?',),' labour?'),
        ...
        ((' leeder',' ledere'),' leader'), (('leadest','laddest','leedist','ledest'),'leadest/lead'),(('leadeth','ledith','ledeth'),'leadeth/leads'), (('Leade ','Lede '),'Lead '),((' leade ',' leede ',' lede '),' lead '),((' leade,',' leed,',' lede,'),' lead,'),((' leed.',),' lead.'),
                ...
                ((' leaste',' leeste',' leest',),' least'),
                ((' leatherne',' leathern',' lethre'),' leather'),
                ((' leeuys',' leeues',' leaues',' leves'),' leaves'), ((' leaveth',' leaueth',' leeueth',' leeuith'),' leaveth/leaves'), (('Leaue ',),'Leave '),((' leeuen ',' leeue ',' leaue ',' leue ',' leve '),' leave '),((' leaue.',' leue.'),' leave.'),((' leaue:',),' leave:'),
                    ...
                    ((' leauing',),' leaving'),
            ((' ledden ',' ledde ',' leden ',' leed ',' ledd '),' led '),((' ledden,',' ledde,'),' led,'),
            ((' leften',' leffte',' leeft',' lefte',' lafte'),' left'),
            ...
            ((' lettir',),' letter'), ((' letten ',' leete ',' lete '),' let '),
        ...
        ((' lyers',' liers'),' liars'),((' lier',' lyer'),' liar'),
            ((' liberall ',),' liberal '), (('lyberte','libertie'),'liberty'),
                ((' librarie ',),' library '),
            ((' licke ',),' lick '),
                ((' lieden',' lyed'),' lied'),((' liest',' lyest'),' liest/lie'),((' lieth',' lyeth',' lyith'),' lieth/lies'),((' ligynge',' lyinge',' liynge',' lyenge',' lyege'),' lying'),((' lyes ',),' lies '),((' lyes,',),' lies,'),((' lyes.',),' lies.'),((' lyes?',),' lies?'),((' lyes:',),' lies:'),((' lyes)',),' lies)'),((' lye ',),' lie '),((' lye,',),' lie,'),((' lye.',),' lie.'),
            ...
            (('likenesse','licknesse','liknesse','licnesse'),'likeness'),((' likenes ',),' likeness '), (('Lykewyse','Likewyse'),'Likewise'),(('lykewyse','likewyse'),'likewise'),
                ((' licnede',' licned'),' likened'),((' licken',' likne'),' liken'), ((' likyng',),' liking'), (('Lyke ',),'Like '),((' lyke',' lijk',' lijc',' lich'),' like'),
            (('Lylies',),'Lilies'),((' lillies',' lilyes',' lylies'),' lilies'),((' lillie ',' lilie ',' lilye ',' lylie '),' lily '),((' lillie,',' lilie,',' lylie,',' lilye,'),' lily,'),((' lilie.',),' lily.'),
            ((' limites',),' limits'),
            ...
            ((' licour',),' liquor'),
            (('Litle',),'Little'),((' litil',' lytell',' lytle',' litle',' lytil',' litel'),' little'),
            (('lyuelode',),'livelihood'), (('liuely',),'lively'), ((' lyueden',' lyuede',' lyuyde',' livede',' liued',' lyued'),' lived'),((' liveth',' liueth',' lyueth',' luyeth'),' liveth/lives'),((' liues',' lyues'),' lives'),((' lyuynge',' livynge',' lyuinge',' lyunge',' lyuing',' lyuyng',' liuing',' lyuen'),' living'),((' liue ',' lyue ',' lyve '),' live '),((' liue,',' lyue,'),' live,'),((' liue.',' lyue.'),' live.'),((' liue?',' lyue?'),' live?'),((' liue:',' lyue:'),' live:'),((' liue;',' lyue;'),' live;'),
        ...
        ((' lucke ',),' luck '),
            ((' lumpe ',),' lump '),
            ((' lunaticke',' lunatyke',' lunatike',' lunatick'),' lunatic'),
            ((' lustfuli',),' lustfully'), ((' lustily',' lustyly'),' lustily/vigorously'), ((' lustinge',),' lusting'),((' lustes',),' lusts'),((' luste ',),' lust '),
    ((' madnesse',),' madness'),((' madnes ',),' madness '), ((' madde ',' madd '),' mad '),((' madde,',' madd,'),' mad,'),((' madde.',),' mad.'),
            ...
            ((' matche ',),' match '), ((' matrymony',),' matrimony'), ((' mattocke',),' mattock/pick/hoe'),
        ...
        (('Mee ',),'Me '),((' mee ',),' me '),((' mee,',),' me,'),((' mee.',),' me.'),((' mee?',),' me?'),((' mee:',),' me:'),((' mee;',),' me;'),
            ((' medowe',),' meadow'),
                ...
                ((' meetis',' metis',' meates'),' meats'),((' meate ',),' meat '),((' meate,',),' meat,'),((' meate.',),' meat.'),((' meate?',),' meat?'),((' meate:',),' meat:'),
            ...
            ((' membris',' membres',' mebres'),' members'),
        ...
        (('Michah ','Micha '),'Micah '),
            ...
            (('myldenesse',),'mildness'),((' mylde ',),' mild '),((' mylde;',),' mild;'), ((' myle',),' mile'),
        ...
        ((' moocked',),' mocked'),((' mocke ',),' mock '),
            ...
            (('Mardochee','Mardocheus'),'Mordecai'),
                (('Moreover','Moreoure','Moreouer','Morouer'),'Moreover/What’s_more'),(('moreover','moreoever','moreouer','morouer','moreuer'),'moreover/what’s_more'), ((' moore ',' moare ',' mowe ',' moe ',' mo '),' more '),
                ((' morninge',' mornynge',' mornyng',' morewe'),' morning'),
                ((' morowe',' morow',' morew'),' morrow'),
                ((' morsell',),' morsel'),
                ((' morter,',),' mortar,'),((' morter:',),' mortar:'), (('morgaged',),'mortgaged'),
            (('Moises','Moyses'),'Moses'), ((' moost ',' moste '),' most '),
            ((' mote',' moate',' moote'),' mote/speck/fleck'),
                ((' mothes',),' moths'),((' mouyte ',' mothe '),' moth '),
    ...
    ((' nailide',' naled'),' nailed'),((' nailis',' nailes',' nayles',' nales'),' nails'),((' naile ',' nayle ',' nale '),' nail '),((' naile,',),' nail,'),
            ...
            (('Nardus','Narde'),'Nard'),((' narde',),' nard'),
                ((' narower',),' narrower'),((' narowe',' narow',' narwy'),' narrow'),
        ...
        ((' neere ',' neare '),' near '),((' neere,',' neare,',' nye,'),' near,'),((' neere.',' neare.'),' near.'),((' neere:',' neare:'),' near:'),((' neere;',' niy;'),' near;'),
            ...
            ((' needeful ',' needfull ',' nedefull ',' nedeful '),' needful '),((' nedeful.',),' needful.'),
                ...
                ((' neded',),' needed'),((' needeth',' nedeth',' nedith'),' needeth/needs'), ((' needes',' nedes'),' needs'),((' neede ',' neade ',' nede '),' need '),((' neede,',' nede,'),' need,'),((' nede;',),' need;'),
            ((' neiyboresse',' neiyboris',' neghboures',' neghbours',' neyghbours',' neygbours'),' neighbours'),((' neiybore',' neyghbour',' neghboure',' neighbor',' neghbour'),' neighbour'),
                (('nethermost',),'lowest'), # Psa 86:13
                    (('Neyther ','Nether ','Nethir '),'Neither '),((' nenether',' neyther',' nether',' nethir',' nother'),' neither'),(('(nether',),'(neither'),
            ((' nephewes',),' nephews'),
            ((' nestes',),' nests'),((' neste ',),' nest '),((' neste:',),' nest:'),
            ((' nettes',' nettis'),' nets'),((' nette ',' nett ',' neet '),' net '),((' nette,',),' net,'), ((' netle',),' nettle'), ((' networkes',),' networks'),((' networke,',),' network,'),((' networke:',),' network:'),
            ...
            ((' nexte',),' next'),
        ((' neer ',' nyer ',' nier '),' nigher/nearer '),((' nyy ',' nye ',' niy '),' nigh/near '),((' neiye,',' niy,',' nyy,'),' nigh/near,'),((' nyy.',' nye.',' niy.'),' nigh/near.'),((' nye:',),' nigh/near:'),
        ...
        (('Nai,',),'No,'),((' noo ',),' no '),
            ...
            (('noothinge','nothyinge','nothinge','nothynge','nothyng'),'nothing'), ((' nott ',),' not '),
    ...
    ((' TO ',),' T_o_ '),(('I O N',),'I_O_N'),(('T O B I T',),'T_O_B_I_T'),(('ALSO ',),'ALSO_ '),(('O ',),'Oh '),(('ALSO_ ',),'ALSO '),(('T_O_B_I_T',),'T O B I T'),(('I_O_N',),'I O N'),((' T_o_ ',),' TO '),
        ...
        ((' of;',),' off;'),
                ((' offende ',),' offend '),((' offende,',),' offend,'),((' offende.',),' offend.'),
                    (('offryngis','offeringes','offrynges'),'offerings'),((' offerynge',' offrynge',' offeryng',' offeringe',' offringe',' offring',' offryng',' offren'),' offering'),
                        ((' offryden',' offriden',' offeride',' offride',' offrid',' offred'),' offered'),((' offerest',' offridist',' offrest',' offrist'),' offerest/offer'),((' offereth',' offreth',' offrith'),' offereth/offers'), (('Offre ',),'Offer '),((' offre ',' ofre '),' offer '),((' offre,',),' offer,'),
        ...
        ((' onne?',),' on?'),
            ((' onys,',),' once,'),
                ((' ons ',),' ones '), (('Oon ',),'One '),((' oon ',),' one '),((' oon.',),' one.'),((' oon,',),' one,'),((' oon;',),' one;'),
                (('Onely ','Oneli '),'Only '),((' onely ',' onlye ',' oneli ',' oonli '),' only '),((' onely,',' oneli,',' onlye,',' oonli,'),' only,'),((' onely.',),' only.'),((' onlye:',' onely:',),' only:'),
        ...
        ((' ouene,',' oue,'),' oven,'),((' ouene',' oueny',' ouen'),' oven'), # includes plural
                (('Ouer ',),'Over '),((' ouere ',),' over '),((' ouere,',),' over,'),((' ouer',),' over'),
        ...
        ((' owid ',),' owed '),((' oweth',' owith'),' oweth/owes'), ((' owest',' owist'),' owest/owe'),
            ...
            ((' awne ',' owne ',' owen '),' own '),((' owne,',' awne,'),' own,'),((' owne.',' awne.'),' own.'),((' owne:',),' own:'),((' owne;',),' own;'),
    ...
    ((' pacis',),' paces'),
            ...
            ((' pallace',' paleis',' pallys'),' palace'), ((' palat ',),' palate '),
                ((' pawmes',' palmes'),' palms'),(('Palme ',),'Palm '),((' paulme ',' palme '),' palm '),((' paulme,',),' palm,'), ((' palsied',),' palsied/paralysed'),((' palsy',' palesy',' palsey'),' palsy/paralysis'),((' palsy ',' paulsie ',' palesie ',' palsie ',' palsye '),' palsy/paralysis '),((' palsy,',' paulsie,',' palsie,'),' palsy/paralysis,'),((' palsy:',' palsie:'),' palsy/paralysis:'),
            ...
            (('Passeouer','Passouer','Pasouer'),'Passover'),(('passeouer','passouer'),'passover'),
                ...
                ((' pasturi',),' pasture'),
            ((' paththis',' pathhis',' pathes',' pathis',' paches'),' paths'), ((' pacience',),' patience'), ((' pacient',' paciet'),' patient'),
        ...
        ((' pesible',),' peaceable'),(('Pees',),'Peace'),((' pees',),' peace'),
            ...
            ((' pens,',),' pence,'),((' penne ',),' pen '),
                (('pennaunce','penaunce'),'penance'),
                    (('penniworth','penyworth'),'pennyworth'), ((' penie ',' peny '),' penny '),((' penie,',' peny,'),' penny,'),((' peny.',),' penny.'),((' penie?',' peny?'),' penny?'),((' peny;',),' penny;'),
            ...
            (('Peradventure','Perauenture'),'Peradventure/Perhaps'),(('peradventure','peraduenture','perauenture'),'peradventure/perhaps'),
                ...
                ((' perfitli',' perfitly'),' perfectly'),((' perfaicte ',' perfecte ',' perfit '),' perfect '),((' perfecte,',' perfit,',' parfit,'),' perfect,'),((' perfecte.',' perfite.',' parfit.'),' perfect.'), ((' performyden',' perfourmed'),' performed'),(('perfourmeth ','performeth '),'performeth/performs ' ),((' perfourme ',' performe '),' perform '),((' perfourme,',' performe,'),' perform,'),((' perfourme.',' performe.'),' perform.'),
                ((' periurie',),' perjury'),
                ((' perlous',),' perilous'), ((' perelis',' perels'),' perils'),((' parell ',' perel '),' peril '),((' perel.',),' peril.'),
                    ((' perischiden',' perischide',' perischid'),' perished'),((' perischyng',' perisching',' perischen'),' perishing'), ((' perischen ',' perische ',' perisshe ',' perishe '),' perish '),((' perische,',' perisshe,',' perissh,',' perishe,'),' perish,'),((' perische.',' perishe.'),' perish.'),((' perisshe?',' perishe?',' peryshe?'),' perish?'),((' perisshe:',' perishe:'),' perish:'),((' perische;',),' perish;'),
                (('Pherezites','Pheresites'),'Perizzites'),
                ((' perpetuall ',),' perpetual '),((' perpetuall.',),' perpetual.'), ((' perplexitie ',),' perplexity '),((' perplexitie.',),' perplexity.'),
                (('persecucioun','persecusioun','persecucion'),'persecution'), (('persecutours','persecuters'),'persecutors'), (('perceavaunce',),'perseverance'),
            ...
            ((' peticion',),' petition'),
        ((' fantum',),' phantom'),
            (('phisicians','physicions','physicias'),'physicians'),(('Physition','Physicion','Phisician'),'Physician'),(('phisition','phisicion'),'physician'),
        ...
        (('preisiden','praysed','preiside','preisid','preysid'),'praised'),(('preisynge','praysinge','praysing','praysyng','preysyng','preisyng'),'praising'),(('Prayse',),'Praise'),(('prayse','preise','preyse'),'praise'),
                ...
                (('preyeden','preieden','preiede','preyede','praied','prayde','prayd'),'prayed'), (('preieris','preyeris'),'prayers'), (('Praier ','Preier '),'Prayer '),(('preier','praier','preyer'),'prayer'),(('prayinge','preiynge','preiden','preynge','preiyng','preyng','preyen'),'praying'),
                    (('Praye ',),'Pray '),((' preye ',' praye ',' preie '),' pray '),((' preye,',' preie,',' praye,'),' pray,'),((' praye.',' preye.'),' pray.'),((' praye?',),' pray?'),((' praye:',' praie:'),' pray:'),((' praye)',),' pray)'),
            ...
            (('pryce ','prijs '),'price '),
                ...
                (('priuey',),'privacy'),(('priuately','pryuately','pryuatly','pryuely'),'privately'), ((' privy ',' priuie ',' pryuei ',' priuy ',' pryuy ',' preuy ',' prevy '),' privy/private '),((' privy,',' priuie,',' pryuey,'),' privy/private,'), ((' privily',' priuilye',' priuily',' preuely',' priuilie',' priuely',' priueli',' pryueli',' prevely'),' privily/secretly'),
            (('proceedeth','proceadeth'),'proceedeth/proceeds'),(('proceaded',),'proceeded'),(('proceede ','proceade ','procede '),'proceed '),
                ...
                (('Prophesie.',),'Prophesy.'),(('Prophecie:',),'Prophesy:'),(('profesie ','profecie '),'prophecy '),(('profesie,',),'prophecy,'),
                    ...
                    (('Prophetesse',),'Prophetess'),(('prophetesse',),'prophetess'), (('Prophetes ',),'Prophets '),(('Prophetes,',),'Prophets,'),(('Prophettes.','Prophetes.'),'Prophets.'),(('Prophetes:',),'Prophets:'), (('prophetis','profetis','prophetes'),'prophets'),(('prophetis.','prophetes.'),'prophets.'),(('prophetis,','profetis,','prophetes,'),'prophets,'),
        ...
        (('Publicans','Publicanes'),'Publicans/Tax_collectors'),((' publicans',' pupplicans',),' publicans/tax_collectors'), ((' publique ',' publike ',' publick '),' public '), (('Publicane',),'Publican'), (('puplischid','publysshed','publesshed'),'published'),(('Publishe',),'Publish'),(('publyshe ','publisshe ','puplishe ','publishe '),'publish '),
            ((' puft',),' puffed'),
            ((' pulle ',),' pull '),
            ((' punyshedst',' punyschid'),' punished'),((' punishe ',' punysche '),' punish '),((' punishe,',),' punish,'),((' punysh',),' punish'),
            ((' pureste',),' purest'), ((' purenes ',),' pureness '),
                ((' purgeth',' purgith',' porgeth'),' purgeth/purges'),((' pourge',),' purge'),
    ...
    (('quailes',),'quails'),
        ...
        (('quike',),'quick/alive'), (('quickely','quicklye'),'quickly'),(('quyck','quik'),'quick'),(('quicke ',),'quick '),(('quicke,',),'quick,'),(('quicke:',),'quick:'),
            (('quyetnesse',),'quietness'),(('quiete ','quyete '),'quiet '),
            (('quiuer','quyuer'),'quiver'),
    (('Rabi',),'Rabbi'),
            ((' ragige',),' raging'), ((' ragges',),' rags'),
            ((' raile ',' rayle '),' rail '),
                ((' raiment',' raymeut',' rayment',' raymet'),' raiment/clothing'),
        ...
        ((' reache ',),' reach '),
                ...
                ((' repyng',),' reaping'),((' repen,',),' reaping,'), ((' reape ',' reepe ',' repe '),' reap '),((' reape,',' reepe,'),' reap,'),((' reape:',' repe:'),' reap:'),
                ((' reare ',),' rear '),
            ...
            ((' receiveth',' resseyueth',' receaveth',' receaueth',' receiueth'),' receiveth/receives'),((' resseyueden',' resseyuede',' receauedst',' receaved',' receaued',' receiued'),' received'),(('receiuing',),'receiving'),(('Receiue ','Receaue '),'Receive '),((' resseiue',' resseyue',' receave',' receaue',' receiue'),' receive'),
                ...
                (('recompence','recopence'),'recompense'), (('recounselid','reconcyled'),'reconciled'),((' reconcyle',' recocile',),' reconcile'), ((' recorde ',),' record '),
            ...
            (('regardest',),'regardest/regard'),((' regarde ',),' regard '),((' regarde,',),' regard,'),
                ...
                ((' regester ',),' register '),
            ((' rehersid',),' rehearsed'),
            ((' regnyden',' regnyde',' regnede',' regnide',' raigned',' regned'),' reigned'),(('reigneth','raigneth','reyneth'),'reigneth/reigns'),((' reigne ',' raygne ',' regne ',' raigne ',' raign '),' reign '),((' reigne,',' raigne,',' regne,'),' reign,'),((' reigne.',' raigne.',' regne.'),' reign.'),((' reigne:',),' reign:'), ((' reine',' reyne'),' rein'),
            ((' reiect',),' reject'),
            ...
            ((' reparelid',' repayred'),' repaired'),((' repairinge',),' repairing'),((' repaire ',' repayre ',' reparele '),' repair '),
                ((' repeate,',),' repeat,'),
                    (('repentaunce',),'repentance'), ((' repeted',),' repented'),(('repenteth',),'repenteth/repents'), (('Repet ',),'Repent '),((' repente ',' repet '),' repent '),((' repente:',),' repent:'),
        ...
        ((' ribbes',),' ribs'),
            ...
            ((' rifeled',),' rifled'),
            (('Righteousnesse','Rightuousnesse'),'Righteousness'),(('Righteousnes ','Rightuousnes '),'Righteousness '),(('riytwisnesse','righteousnesse','rightousnesse','rightuousnesse','rightuosnesse','ryghteousnesse'),'righteousness'),(('righteousnes ','rightuousnes ','ryghteousnes ','rightewesnes ','righetewesnes ','rightwesnes ','rightwisnes '),'righteousness '),(('rightewesnes,','righteousnes,','rightuousnes,'),'righteousness,'),(('Righteousnes.',),'Righteousness.'),(('righteousnes.','rightuousnes.','rightwesnes.'),'righteousness.'), (('rightewesnes:','righteousnes:','rightuousnes:'),'righteousness:'),(('righteousnes;',),'righteousness;'),
        ...
        ((' rored',),' roared'),((' roaringe',),' roaring'),((' roare ',' rore '),' roar '),((' roare,',' rore,'),' roar,'),
            ...
            ((' roouys',),' rooves'),
            ((' rowes',),' rows'),((' rowe ',),' row '),
            ((' royaltie',' royalte'),' royalty'),((' royall ',),' royal '),((' royall.',),' royal.'),
        ((' ruddy',' ruddie',' rodi'),' ruddy/reddish'),
            ...
            ((' russhed',),' rushed'),((' russhinge',' russhing'),' rushing'),((' rushe ',),' rush '), ((' ruste',),' rust'),
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabboth',' saboth',' sabat'),' sabbath'),
            ...
            ((' seidist',' saydest',' seyden',' seiden',' seide',' seid',' sayde',' sayed',' saide', ' seien',' sayd',' seyd'),' said'),(('(sayde ','(sayd '),'(said '),(('(sayde:',),'(said:'),
                (('Saincts','Saintes'),'Saints'),((' saynctes',' sayntes',' saintes',' seyntis'),' saints'),((' saynte',),' saint'),
            ((' saltnes ',),' saltiness '),((' saltnes,',),' saltiness,'),((' saltness',),' saltiness'),((' saltid',),' salted'),((' salte ',),' salt '),
            ...
            ((' sattest ',' satten ',' saten ',' sate ',' sete '),' sat '),((' sate,',),' sat,'),((' sate:',),' sat:'),
            ...
            ((' sauede',' sauyde',' sauyd',' saued',' savyd',' sauid'),' saved'),((' savest',' sauest'),' savest/save'),((' saveth',' saueth'),' saveth/saves'), ((' sauyng',' sauinge',' sauing',' savinge'),' saving'),#(('>sauing',),'>saving'),
                ...
                ((' sauery',),' savoury'),(('savourest','sauourest','sauerest','sauerist','saverest'),'savourest/savour'),((' sauoures',' sauours'),' savours'), ((' sauoure ',),' savour '),((' sauour',),' savour'),
            ...
            ((' sayest',' saiest',' seist'),' sayest/say'),((' sayinge',' seiynge',' seyinge',' sayenge',' sayege',' saynge',' sainge',' sayng'),' saying'), ((' saith',' saieth',' sayeth',' seyeth',' seith',' sayth',' seyth'),' saith/says'),(('(saith','(saieth','(sayeth',),'(saith/says'), (('(saye ',),'(say '),(('Seie ','Saye ','Sei '),'Say '),((' seie ',' seye ',' saye ',' saie ',' saiy '),' say '),((' seie,',' saie,',' saye,'),' say,'),((' seie:',' saie:',' saye:'),' say:'),((' seie;',),' say;'),((' saye)',' saie)'),' say)'),
        ((' scabbe',),' scab'),
        ...
        ((' sealeth',),' sealeth/seals'),((' seelide',),' sealed'),((' seale ',),' seal '),((' seale,',),' seal,'),
                ...
                ((' seetis',' seates'),' seats'),((' seete ',' seet ',' seate '),' seat '),((' seate,',' seete,'),' seat,'),((' seate.',' seete.'),' seat.'),((' seate:',),' seat:'),((' seete;',),' seat;'),
            ...
            (('Seest','Seist'),'Seest/See'),((' seest ',' siest ',' seyst '),' seest/see '),((' seeth ',' seeeth ',' seyth '),' seeth/sees '), (('Seynge','Seinge','Seyng'),'Seeing'),((' seynge',' seinge',' seyng',' seing', ' sien'),' seeing'),
                ...
                (('Seekest ',),'Seekest/Seek '),((' seekest',' sekest'),' seekest/seek'), ((' seeketh',' seketh',' sekith'),' seeketh/seeks'),((' sekinge',' sekynge',' sekyng'),' seeking'),(('Seeke','Seke'),'Seek'),((' seken ',' secke ',' seeke ',' seke '),' seek '),((' seeke,',' seke,'),' seek,'),((' seken.',' seeke.',' seke.'),' seek.'),((' seeke:',' seke:'),' seek:'),
            ...
            ((' sermoun',),' sermon'),
                (('serpents','serpentis','serpetes',),'serpents/snakes'),((' serpente',' serpet'),' serpent/snake'),
        ...
        ((' shaddowed',),' shadowed'),((' shadowe ',),' shadow '),((' schadewi',' shadewi',' schadewe',' schadowe',' shadewe',' schadow'),' shadow'),
                ...
                (('Shal ',),'Shall '),((' shulen ',' schall ',' schal ',' shal '),' shall '),((' shalte ',' shalt ',' schalt ',),' shalt/shall '),
            ...
            ((' schod',' shood'),' shod'),
                ((' shooes',' schoon'),' shoes'),((' shooe',' schoo',' shue'),' shoe'),
                ((' shooke',' shoke'),' shook'),
                ((' chepyng',),' shopping'),
                ...
                ((' shewest',' schewist'),' shewest/show'),((' sheweth',),' sheweth/shows'),(('shewyng','shewinge','shewing'),'showing'),(('schewide','schewid','shewide','shewed'),'showed'),(('Schewe ','Shewe ','Shew '),'Show '),((' schewe ',' shewe ',' shew '),' show '),((' shewe,',),' show,'),
        ...
        ((' syckle',' syccle',' syckell',' sikil',' sykell'),' sickle'),
                (('sickenes',),'sicknes'),(('sijknessis','syknessis','syknesses'),'sicknesses'),((' sijknesse ',' syknesse ',' sicknesse ',' sekenesse ',' sikenesse ',' sicknes '),' sickness '),((' sicknesse,',' sikenesse,',' siknes,'),' sickness,'),((' sicknesse.',' sijknesse.',' siknesse.',' sicknes.'),' sickness.'),((' sijknesse;',),' sickness;'),
            ...
            ((' sinneth',' synneth'),' sinneth/sins'),((' synnynge',),' sinning'), ((' synnefull ',' sinnefull ',' sinfull '),' sinful '), (('sinnemoney','sinne money','sin money'),'sin-money'),(('Synay',),'Sinai'),
                ((' syngeris',' singeris',' singgers',' syngers'),' singers'),((' synger',),' singer'),((' syngynge',' syngen'),' singing'),
                        ((' syngle',),' single'),
                        (('Synge ','Syng '),'Sing '),((' synge ',' syng '),' sing '),((' synge,',),' sing,'),((' synge.',),' sing.'),
                    ((' synguler',' singuler'),' singular'),
                ((' sinke',' syncke'),' sink'),
        ...
        ((' slacke',),' slack'),
                ...
                (('sclaundrid',),'slandered/disgraced'),(('slandereth','slaundereth','slaundreth'),'slandereth/slanders'),((' sclaundren',),' slandering'), ((' sclaundre',' sclaundir',' slaunder',' slauder'),' slander'),
        ...
        ((' spak ',),' spake '),((' spak.',),' spake.'),((' spak;',),' spake;'),
            ...
            ((' spyces',),' spices'),((' spyce',),' spice'),
                ...
                ((' spynnen',),' spinning'),((' spinne',' spynne'),' spin'),
        ...
        ((' stabli ',),' stably '),((' stabli.',),' stably.'),
                ...
                ((' standerde',' standerd'),' standard'),
                    (('stondynge','stondinge','standyng','stodinge'),'standing'),((' standest',' stondest'),' standest/stand'), (('Stondeth',),'Standeth/Stands'),((' standeth',' stondith',' stondeth'),' standeth/stands'), (('Stonde ','Stande '),'Stand '),((' stande ',' stonde ',' stond '),' stand '),((' stande,',' stonde,'),' stand,'),((' stonde.',),' stand.'),((' stonde?',),' stand?'),((' stonde;',),' stand;'),
            ...
            (('stidefast','stidfast','stedfast'),'steadfast'),(('steade',),'stead'),
                    ((' stelen',),' stealing'),((' steale ',),' steal '),((' steale,',),' steal,'),((' steale.',),' steal.'),((' steale?',),' steal?'),((' steale:',),' steal:'),
            ...
            ((' stockis',),' stocks'), ((' stocke',),' stock'),
                ...
                ((' stoare',),' store'),
                    ...
                    ((' storie ',),' story '),
                ((' stoutnes ',),' stoutness '),
            (('straitnesse','straytnesse'),'straightness'), (('straitened','straitned'),'straightened'),(('strayght','streyght','streight','straite','strayte','streiyt','strate','streit','streyt'),'straight'),
                        ((' straytly',),' straitly'),
    ...
    ((' tabering',' tabring'),' tabering/beating'), (('tabernaclis',),'tabernacles/tents'),
                ((' tablis',),' tables'),
            ((' taile',),' tail'),
            ((' takun',),' taken'),((' takest',' takist'),' takest/take'), (('Taketh','Takith'),'Taketh/Take'),((' taketh',' takith'),' taketh/takes'), (('Takyng',),'Taking'),((' takynge',' takyng'),' taking'),
            ((' tayle ',),' tale '), ((' talentis',' talentes'),' talents'),
                ((' talketh',),' talketh/talks'),((' talkinge',' talkynge',' talkyng',' talkige'),' talking'),((' talke ',),' talk '),((' talke,',),' talk,'),((' talke.',),' talk.'),
            ((' tarried',' taried'),' tarried/waited'),((' tarrieth',' tarieth',' tarryeth',' taryeth'),' tarrieth/tarries/waits'),((' tarryings',' tariyngis'),' tarryings/waitings'),((' tarrying',' taryinge',' tarynge',' tarienge',' tariege',' tarying'),' tarrying/waiting'), (('Tarry','Tarye','Tarie','Tary'),'Tarry/Wait'),((' tarry ',' tarie ',' tary '),' tarry/wait '),((' tarry,',' tarie,',' tary,'),' tarry/wait,'),((' tarry.',' tarie.',' tary.'),' tarry/wait.'),
        ...
        ((' techere',' techeri'),' teacher'),(('teachinge','techinge','techynge','techyng','teching'),'teaching'), (('teachest','techist'),'teachest/teach'),(('teacheth','techith'),'teacheth/teaches'),(('Teache ',),'Teach '),((' teache ',' techen ',' teche '),' teach '),((' teache:',),' teach:'),
            ...
            ((' temperid',),' tempered'),((' tempre ',),' temper '), ((' tepest',),' tempest'),
                ...
                (('temptacioun','temptacion','teptacion','tentation','tentacion'),'temptation'), ((' tepter',),' tempter'),
                    ((' temptiden',' temptid',' temped'),' tempted'),((' temptinge',' tempten'),' tempting'), ((' tempte ',' tepte '),' tempt '),
            ((' tenne ',),' ten '),((' tenne,',),' ten,'), ((' tennauntes',' tenauntes'),' tenants'),
                ((' tendre',' tendir',' teder'),' tender'),((' tendeth',' teendith'),' tendeth/tends'),
                ((' tenthe',),' tenth'),
                ((' tentis',' tentes',' tetes'),' tents'),((' tente ',),' tent '),
            ((' termes',),' terms'),((' terme ',),' term '), ((' terrour',),' terror'),
            (('Testamente',),'Testament'),((' testamente',),' testament'), (('testifie ','testifye ','testyfye '),'testify '), (('testimoniall','testymonyall'),'testimonial'), (('Testimonie,',),'Testimony,'),(('testimonie ',),'testimony '),(('testimonie,',),'testimony,'),
        ((' thankfull ',),' thankful '),(('thankefull.','thankfull.'),'thankful.'),
            ...
            ((' y<sup>t</sup>',),' that'),((' y<sup>e</sup> ',),' the '),
                ...
                (('Ther ',),'There '),((' ther ',),' there '), ((' therafter',),' thereafter'), ((' thereat',' therat'),' thereat/there'),((' therby',),' thereby'),((' therof',),' thereof'),((' theron',),' thereon'),
            ...
            (('Thi ',),'Thy '),
                ...
                ((' thynne ',' thinne '),' thin '),
                    ...
                    ((' thystle',),' thistle'), (('Thys ',),'This '),((' thys ',),' this '),((' thys,',),' this,'),
        ...
        (('Tydinges',),'Tidings'),((' tidings',' tidinges',' tydynges',' tidynges',' tydinges',' tydings'),' tidings/news'), ((' tyde',),' tide'),
            ...
            ((' tippe ',),' tip '),
            ((' tithis',),' tithes'),((' tythe',),' tithe'), ((' titil ',' tytle '),' title '),((' tyttle',' titel'),' tittle'),
        (('togedder','togidir','togidere','togydere','togidre','togider','togeder'),'together'),
            ((' toil ',' toile ',),' toil/work '),
            ...
            ((' tookest',' tokest',' tokist'),' tookest/took'),((' bitoken ',' bitok ',' tokun ',' tooke ',' toke '),' took '), ((' toole ',),' tool '), ((' tothe ',' toth '),' tooth '),((' tothe.',' toth.'),' tooth.'),
            ((' toppes',),' tops'),((' toppe ',),' top '),
            ((' turmentiden',' turmentid'),' tormented'),((' tormenteth',' turmentith'),' tormenteth/torments'),((' turmentis',),' torments'),((' turmente ',),' torment '),((' turment',),' torment'),
        ...
        (('tradicioun','tradicion'),'tradition'),((' traditio ',),' tradition '),
            ...
            ((' treden ',' trode ',' trood '),' trod '),((' troden',' troade'),' trodden'),
    ...
    ((' vagabounde',' vagabunde'),' vagabond'),
            ...
            (('vanisshed','vanysshed'),'vanished'),((' vanysche',),' vanishes'),((' vanishe ',),' vanish '),
        ...
        (('Uaile',),'Veil'),((' vayle',' vaile',' vail'),' veil'),
            ((' vengeaunce',' veniaunce',' vengeauce',' avengaunce'),' vengeance'), ((' venym',),' venom'),
            (('Uery ',),'Very '),
        ...
        ((' vyce ',),' vice '), ((' victorie ',),' victory '),((' victorie,',' victorye,',),' victory,'),
            ...
            ((' vynes',),' vines'), (('Uine',),'Vine'),((' vyne ',' vyn '),' vine '),((' vyne,',),' vine,'),((' vyne.',),' vine.'),((' vyne:',),' vine:'),((' vyne;',),' vine;'),
                ...
                ((' vyneris',),' vineries/vineyards'),(('vyneyerdis','vinyardes','vynyaydes'),'vineyards'),(('vynyearde','vineyarde','vyneyarde','vnieyarde','vynyarde','vyniarde','vinyarde','vynyerd','vyneyerd','vyner'),'vineyard'),
            ((' vyndage',),' vintage'),
            ((' violece',),' violence'),
    ...
    ((' wagginge',),' wagging'),((' wagge ',),' wag '),
            ...
            (('walkynge','walkinge'),'walking'),((' walkide',' walkid'),' walked'),(('Walke ',),'Walk '),((' walke ',),' walk '),((' walke,',),' walk,'),((' walke.',),' walk.'),((' walke?',),' walk?'),((' walke:',),' walk:'),
        ...
        (('whalfishes',),'whales'),
            ...
            ((' wheete',' wheate',' whete',' wheet'),' wheat'),
                ...
                (('Wher ',),'Where '),(('Wheras ',),'Whereas '),((' wheras ',),' whereas '), ((' wherby',' wherbi'),' whereby'), (('Wherfore','Wherfor'),'Wherefore'),((' wherfore ',' wherfor '),' wherefore '), ((' whereynne ',' wherynne ',' wherin '),' wherein '), (('Wherof ',),'Whereof '),(('wherof ',),'whereof '),
            ...
            (('Whiche ','Whyche '),'Which '),((' whiche ',' whyche ',' whis ',' wich '),' which '),((' whiche,',),' which,'),(('(whiche ',),'(which '),
                ((' whilst',' whilest',' whylest',' whiles',' whyles'),' whilst/while'), (('Whyle ','Whyll ','Whill '),'While '),((' whill ',' whyll ',' whyle '),' while '),((' whyle,',),' while,'),
                ((' whippes',),' whips'),
            ...
            ((' wholy',),' wholly'), ((' holsome',),' wholesome'), (('Hoole ',),'Whole '),((' whoale',' whoole',' hoole',' hool'),' whole'),
                ...
                (('Whosoeuer',),'Whosoever'),(('whosoeuer',),'whosoever'), (('Whos ',),'Whose '),((' whos ',),' whose '),
            (('Whi ',),'Why '),((' whi ',),' why '),
        ((' wickidli',),' wickedly'), (('wickidnessis','wickednessis','wyckidnessis'),'wickednesses'), (('Wickednesse ','Wickednes '),'Wickedness '),(('wickidnesse ','wickednesse ','wyckednes ','wickednes '),'wickedness '),(('wickidnesse,','wickednesse,','wickednes,'),'wickedness,'),(('wickidnesse.','wickednesse.','wickednes.'),'wickedness.'),(('wickidnesse?','wickednes?'),'wickedness?'),(('wickednesse:','wickednes:'),'wickedness:'),(('wickidnesse;','wickednesse;','wickednes;'),'wickedness;'), ((' wycked',' wickid',' wickyd'),' wicked'),
            ...
            ((' winne ',' wynne '),' win '),((' wynne,',),' win,'),
                ...
                ((' winneth',' wynneth'),' winneth/wins'),((' wynnynge',),' winning'),
                    ((' wyndewid',),' winnowed/blown'),((' wynewing',),' winnowing'),
        ...
        (('Woo ','Wo '),'Woe '),(('Wo.',),'Woe.'),((' wo ',),' woe '),((' wo.',),' woe.'),((' wo!',),' woe!'),
            ((' woolues',' woolfes',' wolues'),' wolves'),((' wolfe',),' wolf'),
        ...
        ((' wrapt ',),' wrapped '),
            ...
            ((' wryngeris',),' wringers'),((' wringe ',),' wring '), ((' wryncles',' wrinckles'),' wrinkles'),
                ((' writere',' wryter'),' writer'), ((' writest',' wrytest'),' writest/write'),((' writeth',' wryteth'),' writeth/writes'),
                    ((' wrytynge',' wrytinge',' writynge',' writyng',' wryting',' wrytyng'),' writing'),((' wryte ',),' write '), (('wrytten','wrytte','writun','wrytun'),'written'),((' writte ',' writt '),' written '),((' writte:',),' written:'),
    ...
    (('Iaakob','Iacob'),'Yacob'), (('Iah,',),'Yah,'),(('Jah<',),'Yah<'), (('Iames','James'),'Yames/Yacob'), ((' yarne',),' yarn'), (('Iauan',),'Yavan'),
        (('Yee ','Ye '),'Ye/You_all '),((' ye ',' yee ',' yi '),' ye/you_all '),((' ye,',' yee,'),' ye/you_all,'),((' ye.',' yee.'),' ye/you_all.'),((' ye?',' yee?',),' ye/you_all?'),((' ye:',' yee:'),' ye/you_all:'),((' ye;',' yee;'),' ye/you_all;'),(('(yee ',),'(ye/you_all '), (('Thy ',),'Thy/Your '),((' thi ',' thy '),' thy/your '),#(('>thy ',),'>thy/your '),
            (('Yhe,',),'Yea/yes,'),((' yhe,',),' yea/yes,'),((' yhe;',),' yea/yes;'), ((' yeres',' yeeris',' yeris'),' years'),((' yeare',' yeere',' yeer',' yere'),' year'), ((' yerned',),' yearned'),
    ...
    ((' abak',),' aback'),((' abac.',),' aback.'), # Psa 55:10, 113:3
        ...
        ((' adoun ',),' down '),((' adoun;',),' down;'), # wycl Mrk 15:30, Mat 4:6
        ...
        (('amendynge',),'mending'), # Wycl Mat 4:21
        ...
        (('at male ese',),'sick/suffering/diseased'), # Wycl Mat 4:24
    ...
    ((' babe ',),' infant '),((' babe,',),' infant,'),((' babe:',),' infant:'), # Gnva Mat 2:8-9
        ...
        ((' besyngle',),' be_clear'), # TNT Mat 6:22
        ...
        ((' bithenkist',),' remembers/realises/considers'), # Wycl 5:23
        ((' bitook',),' betook/entrusted'), # Sng 8:11
        ((' betwixte',' bitwixe',' bitwix',),' between'), # Wycl Deu 1:1
        ...
        ((' bryres',' breris'),' briars/thorn_bushes'), # TNT, Wycl Mat 7:16
    ...
    ((' dalf ',),' dug '), # Wycl 12:1
        ...
        ((' deluen',),' delve/dig/excavate'), # Wycl Mat 6:19
        (('Deme ',),'Judge '), # Hos 2:2
    ...
    ((' earthtilieris',),' earth-tillers'), # original was 'erthetilieris' Wycl Mrk 12:7
        ((' eddri',' edder'),' adder'), # Wycl Mat 3:7, 7:10 ((' eddris',),' adders'),
    ...
    ((' fallyngis',' fallingis'),' ruins'), # Psa 109:6 The second entry is coz it already gets partially changed above
        ...
        ((' forswear ',' forsweare ',' forsuere ',' forswere '),' forswear/perjure ' ),((' forswere,',),' forswear/perjure,' ), # Mat 5:33
    ...
    ((' geet,',),' goats,'), # Sng 6:4
        ...
        (('grypynges','gripinges'),'seizures'), # Mat 4:24
    ...
    ((' hantch',),' haunch/butcher'), # Psa 7:2
        ...
        ((' hiddils',' hidils',' hidlis'),' secrecy'), # Wycl Mat 6:3-4,18
        ...
        (('honeysoukis',),'honeysuckles/locusts/grasshoppers'), # 'hony' is already changed to 'honey' above. Wycl Mat 3:4
    ...
    ((' kids',' kiddes',' kidis'),' kids/young_goats'),((' kid ',' kidde '),' kid/young_goat '),((' kid?',' kidde?'),' kid/young_goat?'), # Sng 1:7, Tob 2:13
        ...
        ((' knowleche ',),' acknowledge '),(('knowlechiden',),'acknowledging'),((' knoulechyng',),' acknowledging'), # Psa 51:11, 110:3, Mrk 3:6
        (('knyytis','kniytis'),'knights/warriors'), # Hos 1:7
        (('knyythod',),'knighthood/army'), # Wycl 2Chr 33:3
        ((' kunnen',),' can'), # Wycl Mat 7:11
    ((' languores',),' illnesses/diseases'), # Wycl Mat 4:24
    ...
    ((' manasside',),' menaced/threatened'), # Wycl Mrk 4:39
        ...
        (('margaritis',),'pearls'), # Wycl Mat 7:6
        ((' mattokkis',),' mattocks/adzes'),
        ((' maundementis',),' commandments'),((' maundement',),' commandment'), # Wycl Mat 5:19, Mrk 7:8
        ((' mawe',),' stomach/innards'), # Wycl Tob 6:5
        ((' meede',' mede'),' reward/merit'), # Wycl Mat 5:12,46
        ((' mentil',' mantil'),' mantle'), # Wycl Num 4:6, Mat 5:40
    ...
    (('nativity','natyuyte','natiuitie'),'nativity/birth'),
        (('neiyidist','neiyede'),'came_near'),((' neiye ',),' come_near '),((' neiye.',),' come_near.'), # Wycl Lam 3:57, 4:18, Tob 6:8, Mat 3:2
        ...
        (('Nyle','Nile'),'Not/Don’t'),((' nyle',),' won’t'), # Psa 74:5, Mat 7:1, 1 Cor 10:1
    ((' obeschen',),' obeys'), # Wycl Mrk 4:40
        ...
        ((' outtakun',' outakun',),' out-taken/except'), # Hos 13:4, Mat 5:32
    ...
    ((' salewis',),' willows'), # Wycl Isa 15:7
        ...
        ((' sleeresse',),' slayers'),((' sleere',' sleeri'),' slayer'),((' slee;',),' slay/kill;'), # Hos 9:13, Eze 21:14, Mat 5:21
        ...
        ((' spedith ',),' benefits '), # Wycl Mat 5:29
    ...
    ((' tabrets',' tabrettes',),' tabrets/tambourines'), # Jer 31:4
        ...
        (('to-tere',),'to_tear_apart'), # Wycl Mat 7:6
        ((' tofore',),' before'), # Wycl Mat 6:2
        ...
        ((' travelen',),' travailing/working'), # Wycl Mat 6:28 original was 'trauelen'
        ...
        (('Twei ',),'Twain/Two_or_both '), ((' twain ',' twei ',' tweyne ',' tweyn ',' twey ',' twaine ',' twayne '),' twain/two_or_both '),(('twain,','twaine,','twayne,','tweyne,'),'twain/two_or_both,'),(('twain.','twaine.','twayne.','tweyne.'),'twain/two_or_both.'),
    ...
    ((' warpe',),' warp'),((' warp',),' warp/weave'), # Lev 13:59
        ...
        ((' waxed',' wexed'),' waxed/grew'),((' waxeth',' waxith',' wexith'),' waxeth/waxes/grows'),((' waxing',' wexen'),' waxing/growing'),((' wexe ',),' wax/grow '), # Psa 89:6, Mrk 4:32, Mat 6:28
        ...
        ((' withall',' withal'),' also/fully'), # Mrk 10:39 but protect 'wherewithall'
        (('withinforth',),'inwardly'), # Wycl Mat 7:5 originally 'withynneforth'
        (('withoutforth',),'out_and_about'), # Wycl Eze 34:21
        (('wlappide','wlappid'),'wrapped'), # Wycl 16:4
        ((' wode.',),' forest/grove.'), # Wycl Mat 3:4
    ...
    (('Hester',),'Esther'),
    (('Esayas','Ysaie','Esay'),'Isaiah'), # Mrk 7:6, Mat 3:3
    ...
    (('Petre','Petir'),'Peter'),
    (('Pharao ','Farao '),'Pharaoh '),(('Pharao,','Farao,'),'Pharaoh,'),
    (('Pharises','pharisees','pharises','Fariseis','Farisees','Farysees'),'Pharisees'), # Mat 3:7
    (('Philippe',),'Philip'),
    (('Philistim','Philistyne','Filistei'),'Philistine'),
    ...
    (('Samarie',),'Samaria'),
    (('Sare',),'Sara'),
    (('Sata.',),'Satan.'),(('Sata:',),'Satan:'), # Bshps Mrk 8:33
    (('Siria','Sirie'),'Syria'), # Mat 4:24
    (('Sydon',),'Sidon'), # Mrk 7:24
    (('Syon','Sion'),'Zion'),
    (('Thaddeus','Taddeus','Thadee'),'Thaddaeus'), # Mrk 3:18
    (('Tichicus',),'Tychicus'),
    (('Tigrys',),'Tigris'),
    (('Zabulon','zabulon','Sabulon'),'Zebulun'), # Mat 4:5
...
for wordMapEntry in ENGLISH_WORD_MAP:
    ...
    if newWord not in (' 40 ',' 60',
                       ...
                       ' diamond', 'ed ',
                       ' feeding',' fragments',
                       ' girls/young_women','grape-gatherers', ' herd', 'immediately',' judging',' loved',
