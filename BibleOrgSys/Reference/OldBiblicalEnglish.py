...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' kab ',),' cab '),
        ...
        ((' claymed',),' claimed'),
            ...
            ((' cloake',' cloke'),' cloak'),
                ...
                (('clothide','cloathed','clothid'),'clothed'), ((' clothinge',' clothyng'),' clothing'), (('cloothis','clothis','cloathes'),'clothes'),((' cloutes',),' cloths'),
        ...
        ((' dekenes',),' deacons'),
            ...
            ((' decaye ',),' decay '),((' decaye.',),' decay.'),((' decaye:',),' decay:'),
                (('deceitfull ','disceatfull ','disceatful ','deceytfull ','deceiptfull '),'deceitful '),(('deceitfull.',),'deceitful.'),(('disceatfull:',),'deceitful:'), ((' deceite',' deceipt',' disceate',' disceipt'),' deceit'),
                    (('disseyueden','disseyued'),'deceived'),(('deceiveth','deceiueth','disceaueth','disseyueth'),'deceiveth/deceives'),(('disseyve','disceaue','deceave','deceiue','deceaue','disseyue'),'deceive'),
                (('discided',),'decided'),
    ...
    (('Ech ',),'Each '),((' eche ',' ech '),' each '),((' ech,',),' each,'),
        ...
        ((' ere ',' yer '),' ere/before '),
            ((' erryden',),' erred'),((' erreth',' errith'),' erreth/errs'), ((' erre ',),' err '),((' erre,',),' err,'), ((' erroure',' errour'),' error'),
        ...
        (('Woo ','Wo '),'Woe '),(('Wo.',),'Woe.'),((' wo ',),' woe '),((' wo.',),' woe.'),
            ...
            ((' wordis',' wordys',' woordes',' wordes'),' words'),((' woorde',' worde',),' word'),
                ((' woorker',),' worker'), ((' workemen',),' workmen'),((' workeman',),' workman'), ((' woorkes',' workes',' workis',' werkis'),' works'),
                    ((' worketh',' worchith'),' worketh/works'),((' worchen',' workyng'),' working'),((' worche ',' woorke ',' worke ',' werke ',' werk '),' work '),((' worke,',' werk,'),' work,'),((' worche.',' worke.',' werk.'),' work.'),((' worke?',' werk?'),' work?'),((' worke:',),' work:'),
