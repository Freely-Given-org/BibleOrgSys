        ...
        (('Dyall ',),'Dial '),((' diall ',),' dial '), ((' diamonde',),' diamond'),
            ...
            ((' disalowing',),' disallowing'),((' dispoynted',),' disappointed'),(('disappointeth','dispoynteth'),'disappointeth/disappoints'),
                ...
                (('dispatche ',),'dispatch '),
                    ...
                    (('disputacio?',),'disputation?'),(('disputyng',),'disputing'), ((' dispuyte',),' dispute'),
    ...
    ((' tabering',' tabring'),' tabering/beating'), (('tabernaclis',),'tabernacles/tents'),
        ...
        ((' techere',' techeri'),' teacher'),(('teachinge','techinge','techyng','teching'),'teaching'), (('teachest','techist'),'teachest/teach'),(('teacheth','techith'),'teacheth/teaches'),(('Teache ',),'Teach '),((' teache ',' techen ',' teche '),' teach '),((' teache:',),' teach:'),
            ...
            ((' temperid',),' tempered'),((' tempre ',),' temper '), ((' tepest',),' tempest'),
                ((' templis',),' temples'),
                (('temptacioun','temptacion','teptacion','tentation','tentacion'),'temptation'), ((' temptiden',' temptid',' temped'),' tempted'),((' temptinge',),' tempting'), ((' tempte ',' tepte '),' tempt '),
...
for wordMapEntry in ENGLISH_WORD_MAP:
    ...
    if newWord not in (' 40 ',' 60',
                       ...
                       ' baskets',' between',' burial', ' can ',' cattle',' covered',' cut ',
                       ' diamond', 'ed ',
