...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' backes',' backis'),' backs'),((' backe ',' bak '),' back '),((' backe,',' bak,'),' back,'),((' backe.',),' back.'),((' backe?',),' back?'),((' backe:',),' back:'),((' bak;',),' back;'),
        ...
        ((' boket',' bokat'),' bucket'), ((' buckis',),' bucks'),((' bucke ',' buc ',' buk '),' buck '),
            ...
            ((' busshell',' busshel',' bushell',' buschel'),' bushel'),
...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
        ...
        ((' claymed',),' claimed'),
            ...
            ((' clenli',),' cleanly'), ((' cleannesse ',' cleannes ',' clenesse '),' cleanness '), (('clensiden','clensed','clensid'),'cleansed'),(('clensyng','clensing'),'cleansing'),((' clense',),' cleanse'), ((' cleane ',' cleene ',' clene '),' clean '),((' cleane,',' cleene,',' clene,'),' clean,'),((' cleane.',' cleene.',' clene.'),' clean.'),((' cleane?',' clene?'),' clean?'),((' cleane:',' clene:'),' clean:'),((' cleene;',),' clean;'),
    ...
    ((' dayly',' daylie'),' daily'),
            ...
            ((' daies',' dayes',' dais',' daes'),' days'), (('Daye',),'Day'),((' daye ',' daie ',' dai '),' day '),((' daye,',' daie,',' dai,'),' day,'),((' daye.',' daie.',' dai.'),' day.'),((' daye?',' dai?'),' day?'),((' daye:',' daie:',' dai:'),' day:'),((' dai;',),' day;'),
        ((' dekene',),' deacon'),
                ((' deedly',' dedly'),' deadly'),
    ...
    ((' gaine ',),' gain '),((' gaine,',),' gain,'),((' gaine.',),' gain.'), (('Gayus',),'Gaius'),
        ...
        ((' goates',' gotes'),' goats'),(('Goate',),'Goat'),((' goate ',' goet ',' gote ',' geet '),' goat '),((' goate,',),' goat,'),((' goate.',),' goat.'),((' goate:',),' goat:'), # Take care with 'goeth'
    ...
    (('Keepers','Keperis',),'Keepers/Watchmen'),((' keepers',' keperis',),' keepers/watchmen'), ((' kepere',' keper'),' keeper'),((' keepest',' kepest',' kepist'),' keepest/keep'),((' keepeth',' kepith',' kepeth'),' keepeth/keeps'),((' kepynge',' kepyng',' keping'),' keeping'), ((' kepten',' kepte'),' kept'), (('Keepe ','Kepe '),'Keep '),((' kepen ',' keepe ',' kepe '),' keep '),((' keepe,',' kepe,'),' keep,'),
        ...
        ((' killeth',' kylleth'),' killeth/kills'),((' killidist',' killiden',' killide',' kylled',' kyllide',' kyllid',' killid'),' killed'),((' kyll ',' kil '),' kill '),((' kyll.',),' kill.'), ((' kilne',' kylne'),' kiln'),
    ...
    ((' labored',),' laboured'),((' labourest',),' labourest/labour'),((' labouringe',),' labouring'),((' laboures',),' labours'),((' laboure ',' labor '),' labour '),((' laboure,',' labor,'),' labour,'),((' laboure.',),' labour.'),((' laboure?',),' labour?'),
            ...
            ((' lambes',' lambren'),' lambs'), (('Lambe',),'Lamb'),((' lomb ',' lambe ',' labe '),' lamb '),((' lambe,',' lomb,',' labe,'),' lamb,'),((' lambe.',' lomb.'),' lamb.'),((' lambe?',),' lamb?'),((' lambe:',),' lamb:'),((' lomb;',),' lamb;'),
    ...
    ((' nailide',' naled'),' nailed'),((' nailis',' nailes',' nayles',' nales'),' nails'),((' naile ',' nale '),' nail '),((' naile,',),' nail,'),
            ((' nakid',),' naked'), (('nakednesse','nakidnesse'),'nakedness'),(('nakednes ',),'nakedness '),(('nakednes,',),'nakedness,'),
            ((' nameli',),' namely'),
            (('Naomy','Naemi'),'Naomi'),
            ((' nappe,',),' nap,'),
    ...
    ((' paiede',' payde',' payed',' payd'),' paid'),
        ...
        ((' pesible',),' peaceable'),(('Pees',),'Peace'),((' pees',),' peace'),
            ...
            (('peradventure','peraduenture','perauenture'),'peradventure/perhaps'),
                (('perseyuede','perceyued','perceiued','perceaved','perceaued'),'perceived'),(('Perceaue','Perceave','Perceiue'),'Perceive'),((' witen',' perceiue',' perseyue',' perceaue',' perseiue',' perceave'),' perceive'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
        ...
        ((' sealeth',),' sealeth/seals'),((' seelide',),' sealed'),((' seale ',),' seal '),((' seale,',),' seal,'),
            ...
            ((' separateth',),' separateth/separates'),((' seperate',),' separate'), ((' seperation',),' separation'),
        ...
        ((' syckle',' syccle',' syckell',' sikil',' sykell'),' sickle'),
                (('sijknessis','syknessis'),'sicknesses'),((' sijknesse ',' syknesse ',' sickenesse ',' sicknesse ',' sikenesse ',' sickeness ',' sickenes ',' sicknes '),' sickness '),((' sicknesse,',' sikenesse,',' sickeness,',' sickenes,'),' sickness,'),((' sicknesse.',' sijknesse.',' siknesse.',' sicknes.'),' sickness.'),((' sijknesse;',),' sickness;'),
        ...
        ((' sokettes',' sockettes'),' sockets'),((' sokett',),' socket'),
            ...
            ((' souyten',' souyte',' souyt'),' sought'),
                ...
                ((' soundnesse',),' soundness'), ((' sownyng',),' sounding'), ((' sounde ',' sownde '),' sound '),((' sounde,',),' sound,'),
                ((' soure',' sowre',),' sour'),
        ...
        ((' stabli ',),' stably '),((' stabli.',),' stably.'),
            ...
            (('stidefast','stidfast','stedfast'),'steadfast'),(('steade',),'stead'), ((' steale ',),' steal '),((' steale,',),' steal,'),((' steale.',),' steal.'),
    ...
    ((' tabering',' tabring'),' tabering/beating'), (('tabernaclis',),'tabernacles/tents'),
        ...
        ((' thankfull ',),' thankful '),(('thankefull.','thankfull.'),'thankful.'), (('Thankes',),'Thanks'),(('thanckes','thankes','thakes'),'thanks'),(('thanke ',),'thank '),
            ...
            (('thwong',),'thong'),
                ((' thorne',),' thorn'), 
                ((' thoo ',' tho '),' those '),((' tho,',),' those,'),((' tho.',),' those.'),
            ...
            ((' threede',' threed'),' thread'), (('thretenede',),'threatened'),(('threatning',),'threatening'), ((' thre ',),' three '),((' thre,',),' three,'),((' thre:',),' three:'),
                ...
                ((' throtes',),' throats'),((' throate ',' throte '),' throat '),((' throte,',),' throat,'),((' throte.',),' throat.'),((' throte?',),' throat?'),((' throte:',),' throat:'),
                    ...
                    ((' throughly',),' thoroughly'), (('thorowout',),'throughout'), (('Thorowe ','Thorow '),'Through '),(('thorouy ','thorowe ','thorow ','thorou ','thoruy '),'through '),(('thorow,',),'through,'),(('thorow.',),'through.'),(('thorowe:',),'through:'),((' thorou;',),' through;'),
    ...
    (('vnauenged',),'unavenged'), (('vnaduisedly',),'unadvisedly'), (('vnawarres','vnwares'),'unawares'),
        ...
        (('vncerteyn',),'uncertain'),
            ...
            (('vncircumcized','vncircumcidid'),'uncircumcised'),
                (('vncleannesse','vnclennesse','vncleannes','vnclennes'),'uncleanness'), #(('vncleannesse.',),'uncleanness.'),(('vncleannes,','vnclennes,'),'uncleanness,'),
            ...
            (('vndefyled',),'undefiled'),
                    ...
                    (('understandeth','vnderstandeth','vndirstondith','vndurstondith','vnderstondeth'),'understandeth/understands'),(('vnderstondynge','vndirstondynge','vnderstondyng','vndurstondyng','vnderstanding','vnderstading'),'understanding'), (('Vndurstonde',),'Understand'),((' vndirstonde',' vnderstande',' vnderstand'),' understand'),
                        (('Vnderstonde',),'Understood'),(('vnderstonde','vndurstonde','vnderstoode','vndurstoden','vnderstode','vndirstood'),'understood'),
                    (('vndertoke',),'undertook'), (('Vnder',),'Under'),((' vnder',' vndir',' vndur'),' under'),
                ((' vndon.',),' undone.'),((' vndoe ',),' undo '),
            (('vnfaithfully',),'unfaithfully'),(('vnfeithfulnesse','vnfeithfulnes'),'unfaithfulness'),(('vnfeithful ','unfaithfull '),'unfaithful '), (('vnfensed',),'unfenced'),
        ...
        (('Woo ','Wo '),'Woe '),(('Wo.',),'Woe.'),((' wo ',),' woe '),((' wo.',),' woe.'),((' wo!',),' woe!'),
            ...
            ((' wordis',' wordys',' woordes',' wordes'),' words'),((' woorde',' worde',),' word'),
                ((' woorker',),' worker'), ((' workemen',),' workmen'),((' workeman',),' workman'), ((' woorkes',' workes',' workis',' werkis'),' works'),
                    ((' worketh',' worchith'),' worketh/works'),((' worching',' worchen',' workyng'),' working'),((' worche ',' woorke ',' worke ',' werke ',' werk '),' work '),((' worche,',' worke,',' werk,'),' work,'),((' worche.',' worke.',' werk.'),' work.'),((' worke?',' werk?'),' work?'),((' worke:',),' work:'),
