...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
    ...
    ((' labored',),' laboured'),((' labourest',),' labourest/labour'),((' labouringe',),' labouring'),((' laboures',),' labours'),((' laboure ',' labor '),' labour '),((' laboure,',' labor,'),' labour,'),((' laboure.',),' labour.'),((' laboure?',),' labour?'),
        ...
        (('Loe,',),'Lo,'),
            ...
            ((' lokide',' loked'),' looked'),((' looketh',' loketh',' lokith'),' looketh/looks'),((' lykynge',' lokynge',' lokinge',' lokyng',' loking'),' looking'),(('Lokyng ',),'Looking '),((' lookes',' lokes'),' looks'),
                ...
                ((' loosed',' loosid'),' loosed/released'),((' looseth',' lowseth'),' looseth/looses/releases'), ((' loosing',' loosyng',' loosinge'),' loosing/releasing'), ((' lowse ',),' loose '),
    ...
    ((' paiede',' payde',' payed',' payd'),' paid'),
        ...
        (('preisiden','praysed','preiside','preisid','preysid'),'praised'),(('preisynge','praysinge','praysing','praysyng','preysyng','preisyng'),'praising'),(('Prayse',),'Praise'),(('prayse','preise','preyse'),'praise'),
                ...
                (('preyeden','preieden','preiede','preyede','praied','prayde','prayd'),'prayed'), (('preieris',),'prayers'), (('Praier ','Preier '),'Prayer '),(('preier','praier','preyer'),'prayer'),(('preiden','preyng',),'praying'),((' preye ',' praye ',' preie '),' pray '),((' preye,',' praye,'),' pray,'),((' praye.',' preye.'),' pray.'),((' praye:',),' pray:'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabat',' saboth'),' sabbath'),
        ...
        ((' stabli ',),' stably '),((' stabli.',),' stably.'),
            ...
            (('stidefast','stidfast','stedfast'),'steadfast'),(('steade',),'stead'), ((' steale ',),' steal '),((' steale,',),' steal,'),((' steale.',),' steal.'),((' steale:',),' steal:'),
    ...
    (('vnauenged',),'unavenged'), (('vnaduisedly',),'unadvisedly'), (('vnawarres','vnwares'),'unawares'),
        ...
        (('vncerteyn',),'uncertain'),
            ...
            (('vncircumcized','vncircumcidid'),'uncircumcised'),
                    ...
                    (('vncleannesse ','vnclennesse ','vncleannes ','vnclennes '),'uncleanness '),(('vncleannes,','vnclennes,'),'uncleanness,'),(('vncleannesse.',),'uncleanness.'),
