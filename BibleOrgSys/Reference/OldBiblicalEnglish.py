    ...
    ((' backes',' backis'),' backs'),((' backe ',' bak '),' back '),((' backe,',' bak,'),' back,'),((' backe.',),' back.'),((' backe?',),' back?'),((' backe:',),' back:'),((' bak;',),' back;'),
        ...
        ((' bracelette',),' bracelet'),
            ...
            (('brickkiln','bricke-kill','brickyll'),'brick-kiln'), (('brycke','bricke','bryck'),'brick'),
                ...
                ((' brimme ',),' brim '),
                (('bringest','bryngest'),'bringest/bring'),(('bringeth','bryngeth','bringith','bryngith'),'bringeth/brings'),(('brynginge','bryngynge','bringige','bryngyng','bringyng','bryngen'),'bringing'), (('Brynge ','Bringe ','Bryng '),'Bring '),((' brynge ',' bryng ',' bringe '),' bring '),
                ((' brinke ',),' brink '),
        ...
        ((' boket',' bokat'),' bucket'), ((' buckis',),' bucks'),((' bucke ',' buc ',' buk '),' buck '),
            ...
            ((' burthen',' birthun',' burthe'),' burden'),
                ...
                ((' burnynge',' burnyng',' brennynge',' brennyng',' burnige'),' burning'),((' burned',' brenten',' brente',' brent',' bnrnt'),' burnt'),((' bret ',),' burnt '),((' burne ',' brenne '),' burn '),((' burne.',),' burn.'),((' burne:',),' burn:'),
...
((' catels',),' chattels'), # Tob 1:19 Must go above 'cattle'
    ...
    (('Rabi',),'Rabbi'),
        ...
        ((' reache ',),' reach '),
            ...
            ((' retaine ',),' retain '),
                (('Returne',),'Return'),((' returne ',),' return '),((' returne.',),' return.'),((' returne,',),' return,'),((' returne?',),' return?'),((' returne:',),' return:'),
    ...
    (('Sabbathes',),'Sabbaths'),((' sabatys',' sabatis'),' sabbaths'),(('Sabboth','Saboth'),'Sabbath'),((' sabboth',' saboth',' sabat'),' sabbath'),
        ...
        (('subiection','subieccion'),'subjection'),((' subiect',' suget',),' subject'),
            ...
            ((' successe ',),' success '), ((' succour',' sucoure'),' succour/support/assistance'),
                ...
                ((' suclynges',),' sucklings'),
            ((' sodainlye',' suddainly',' sodeynly',' sodeynli',' sodainly',' sodaynely',' sodenly',' sodely',' sudenli'),' suddenly'), ((' sodayne ',' sodane '),' sudden '),((' sodayne:',),' sudden:'),
        ...
        ((' thankfull ',),' thankful '),(('thankefull.','thankfull.'),'thankful.'), (('Thankes',),'Thanks'),(('thanckes','thankes','thakes'),'thanks'),(('thanke ',),'thank '),
            ...
            ((' threede',' threed'),' thread'), (('thretenede',),'threatened'),(('threatning',),'threatening'), ((' thre ',),' three '),((' thre,',),' three,'),((' thre:',),' three:'),
                ...
                ((' throtes',),' throats'),((' throate ',' throte '),' throat '),((' throte,',),' throat,'),((' throte.',),' throat.'),((' throte?',),' throat?'),((' throte:',),' throat:'),
                    ...
                    ((' throughly',),' thoroughly'), (('thorowout',),'throughout'), (('Thorowe ','Thorow '),'Through '),(('thorouy ','thorowe ','thorow ','thorou ','thoruy ','thorw '),'through '),(('thorow,',),'through,'),(('thorow.',),'through.'),(('thorowe:',),'through:'),((' thorou;',),' through;'),
