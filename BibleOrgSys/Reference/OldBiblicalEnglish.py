...
ENGLISH_WORD_MAP = ( # Place longer words first,
    ...
    ((' kab ',),' cab '),
        ...
        (('chaffe',),'chaff'),
                ...
                (('chaumbers','chambres','chabers'),'chambers/rooms'),(('chamber ','chaumber ','chaumbre ','chambre ','chabre '),'chamber/room '),((' chambre.',),' chamber/room.'),((' chaumber:',' chambre:'),' chamber/room:'),
    ...
    ((' dayly',' daylie'),' daily'),
        ...
        ((' doere',),' doer'), ((' doth',' doeth',' doith'),' doth/does'), (('Doe ',),'Do '),((' doe ',),' do '),((' doe,',),' do,'),((' doe.',),' do.'),((' doe?',),' do?'),((' doe:',),' do:'),
            ...
            ((' doublid',),' doubled'),((' dubble',),' double'), ((' doubtlesse',' doutlesse',' doutles'),' doubtless'), ((' doute,',),' doubt,'),((' doute)',),' doubt)'),
    ...
    (('schaplynesse',),'shapeliness/beauty'),
        ...
        ((' sleere',' sleeri'),' slayer'), # Hos 9:13, Eze 21:14
