...
from Formats.theWordBible import handleRTFLine
...
def createMySwordModule( self, outputFolder, controlDict ):
    ...
    from Formats.theWordBible import theWordOTBookLines, theWordNTBookLines, theWordBookLines, theWordHandleIntroduction, theWordComposeVerseLine
...
def testMySwB( indexString, MySwBfolder, MySwBfilename ):
    ...
    #testFolder = BibleOrgSysGlobals.PARALLEL_RESOURCES_BASE_FOLDERPATH.joinpath( '../../../../Data/Work/Bibles/MySword modules/' ) # Must be the same as below
...
def demo():
    ...
    if 1: # individual modules in the test folder
        testFolder = BibleOrgSysGlobals.PARALLEL_RESOURCES_BASE_FOLDERPATH.joinpath( '../../../../Data/Work/Bibles/MySword modules/' )
