                ...
                if vplType == 1:
                    ...
                    if bookCodeText != lastBookCodeText: # We've started a new book
                        ...
                        if bookCodeText == 'Le' and lastBBB == 'GEN': BBB = 'LEV'
                            ...
                            if not BBB: BBB = bos_books_codes_py.english_name_to_reference_abbrev( bookCodeText )  # Try to guess
                        if not BBB:
                    ...
                    if bookCodeText != lastBookCodeText: # We've started a new book
                        ...
                        bnDict = { 67:'TOB', 68:'JDT', 69:'ESG', 70:'WIS', 71:'SIR', 72:'BAR', 73:'LJE', 74:'PAZ', 75:'SUS',
                                ...
                                85:'PSS', 86:'ODE', }
                        if 1 <= bookCodeText <= 66: BBB = bos_books_codes_py.get_bbb_from_reference_number( bookCodeText )
                    ...
                    if line.count( '\t' ) != 1:
                        ...
                        if not newBBB: newBBB = bos_books_codes_py.english_name_to_reference_abbrev( refB )  # Try to guess
                        if not newBBB:
