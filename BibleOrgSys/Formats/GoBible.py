...
class GoBible( Bible ):
    ...
    def preload( self ):
        ...
        if foundFolders:
            ...
            for folderName in foundFolders:
                ...
                if folderNameLower.endswith( 'sfm' ): # .sfm or .usfm
                    ...
                    #BBB = bos_books_codes_py.osis_abbrev_to_reference_abbrev( bookCode )
        ...
        if numBooks == 66:
            self.bookList = [bos_books_codes_py.get_bbb_from_reference_number(x) for x in range(1,66+1)]
        elif numBooks == 27:
            self.bookList = [bos_books_codes_py.get_bbb_from_reference_number(x) for x in range(40,66+1)]
        else:
            ...
            for n in range( numBooks ):
                ...
                BBB1 = bos_books_codes_py.english_name_to_reference_abbrev( self.bookNames[n] )
                BBB2 = bos_books_codes_py.english_name_to_reference_abbrev( self.filenameBases[n] )
                ...
                if BBB1 and (BBB2==BBB1 or BBB2 is None): BBB = BBB1
                    ...
                    BBB = bos_books_codes_py.get_bbb_from_reference_number(n)
