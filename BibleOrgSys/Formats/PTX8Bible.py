...
def demo():
    ...
    specificTestFolder = BibleOrgSysGlobals.PARALLEL_RESOURCES_BASE_FOLDERPATH.joinpath( '../../../../Data/Work/VirtualBox_Shared_Folder/My Paratext 8 Projects Latest/MBTV/' )
    ...
    if 0 and debuggingThisModule: # Test statistics discovery and creation of BDB stats page
        testFolders = (
                    ...
                    ( 'MBTV', BibleOrgSysGlobals.PARALLEL_RESOURCES_BASE_FOLDERPATH.joinpath( '../../../../Data/Work/VirtualBox_Shared_Folder/My Paratext 8 Projects/MBTV' ) ),
                    ( 'MBTBT', BibleOrgSysGlobals.PARALLEL_RESOURCES_BASE_FOLDERPATH.joinpath( '../../../../Data/Work/VirtualBox_Shared_Folder/My Paratext 8 Projects/MBTBT' ) ),
                    ( 'MBTBC', BibleOrgSysGlobals.PARALLEL_RESOURCES_BASE_FOLDERPATH.joinpath( '../../../../Data/Work/VirtualBox_Shared_Folder/My Paratext 8 Projects/MBTBC' ) ),
    ...
    if 1:
        ...
        searchFolderName = BibleOrgSysGlobals.PARALLEL_RESOURCES_BASE_FOLDERPATH.joinpath( '../../../../Data/Work/VirtualBox_Shared_Folder/' )
