...
def loadPTX7ProjectData( BibleObject, ssfFilepath, encoding='utf-8' ):
    ...
    if BibleOrgSysGlobals.debugFlag or BibleOrgSysGlobals.verbosityLevel > 2:
        print( exp("Loading Paratext 7 SSF data from {!r} ({})").format( ssfFilepath, encoding ) )
    ...
    if BibleOrgSysGlobals.verbosityLevel > 2:
        print( "  " + exp("Got {} PTX7 SSF entries:").format( len(PTXSettingsDict) ) )
    ...
    def loadPTXComments( self ):
        ...
        for commentFilename in commentFilenames:
            ...
            if self.tree.tag=='CommentList':
                treeLocation = "PTX7 {} file for {}".format( self.tree.tag, commenterName )
                BibleOrgSysGlobals.checkXMLNoAttributes( self.tree, treeLocation )
                BibleOrgSysGlobals.checkXMLNoText( self.tree, treeLocation )
                BibleOrgSysGlobals.checkXMLNoTail( self.tree, treeLocation )
    ...
    def loadPTXBiblicalTermRenderings( self ):
        ...
        for BiblicalTermsFilename in BiblicalTermsFilenames:
            ...
            if self.tree.tag=='TermRenderingsList':
                treeLocation = "PTX7 {} file for {}".format( self.tree.tag, versionName )
                BibleOrgSysGlobals.checkXMLNoAttributes( self.tree, treeLocation )
                BibleOrgSysGlobals.checkXMLNoText( self.tree, treeLocation )
                BibleOrgSysGlobals.checkXMLNoTail( self.tree, treeLocation )
    ...
    def loadPTXPrintConfig( self ):
        ...
        for printConfigFilename in printConfigFilenames:
            ...
            if self.tree.tag=='PrintDraftConfiguration':
                treeLocation = "PTX7 {} file for {}".format( self.tree.tag, printConfigType )
                BibleOrgSysGlobals.checkXMLNoAttributes( self.tree, treeLocation )
                BibleOrgSysGlobals.checkXMLNoText( self.tree, treeLocation )
                BibleOrgSysGlobals.checkXMLNoTail( self.tree, treeLocation )
        ...
        if self.maximumPossibleFilenameTuples:
            ...
            and not BibleOrgSysGlobals.alreadyMultiprocessing: # Get our subprocesses ready and waiting for work
                ...
                if BibleOrgSysGlobals.verbosityLevel > 1:
                    print( exp("Loading {} PTX7 books using {} processes…").format( len(self.maximumPossibleFilenameTuples), BibleOrgSysGlobals.maxProcesses ) )
