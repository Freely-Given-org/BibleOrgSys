...
class USFM3Markers:
    ...
    def loadData( self, XMLFilepath=None ):
        ...
        if not self.__DataDict: # We need to load them once -- don't do this unnecessarily
            ...
            standardXMLFilepath = os.path.join( dataFilepath, "USFM3Markers.xml" )
            standardPickleFilepath = os.path.join( dataFilepath, "DerivedFiles", "USFM3Markers_Tables.pickle" )
            ...
            and os.stat(standardPickleFilepath)[9] > os.stat(standardXMLFilepath)[9]: # There's a newer pickle file
                ...
                from USFM3MarkersConverter import USFM3MarkersConverter
    ...
    def getMarkerListFromText( self, text, includeInitialText=False, verifyMarkers=False ):
        ...
        """
        #if BibleOrgSysGlobals.verbosityLevel > 2: print( "USFM3Markers.getMarkerListFromText( {}, {} )".format( repr(text), verifyMarkers ) )
        if not text: return []
