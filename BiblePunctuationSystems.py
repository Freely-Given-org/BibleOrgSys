...
class BiblePunctuationSystems:
    ...
    def loadData( self, XMLFolder=None ):
        ...
        if self.__DataDict is None or not self.__DataDict: # Don't do this unnecessarily
            ...
            self.__DataDict = self.__bpsc.importDataToPython() # Get the various dictionaries organised for quick lookup
