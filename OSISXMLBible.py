...
class OSISXMLBible( Bible ):
    ...
    def __loadFile( self, OSISFilepath, loadErrors ):
        ...
        if self.tree.tag == OSISXMLBible.treeTag:
            ...
            if len(self.tree)==1 and (self.tree[0].tag == OSISXMLBible.textTag or (not BibleOrgSysGlobals.strictCheckingFlag and self.tree[0].tag == 'osisText')):
            ...
            if element.tag == OSISXMLBible.OSISNameSpace+'revisionDesc':
                ...
                for subelement in element:
                    ...
                    if subelement.tag == OSISXMLBible.OSISNameSpace+'title':
                        ...
                        if descriptionType or self.suppliedMetadata['OSIS']['Description'] and BibleOrgSysGlobals.verbosityLevel > 2:
                ...
                if subelement.tag == OSISXMLBible.OSISNameSpace+'reference': # cross-references
                    ...
                    for sub2element in subelement:
                        if sub2element.tag == OSISXMLBible.OSISNameSpace+'transChange':
                            ...
                            validateTransChange( sub2element, sublocation, verseMilestone ) # Also handles the tail
                        else:
...
########### W
                ...
                validateWord( element, location, verseMilestone )
########### Left-overs!
            else:
                ...
                if BibleOrgSysGlobals.debugFlag: print( element.tag ); halt
