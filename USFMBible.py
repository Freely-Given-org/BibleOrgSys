...
class USFMBible( Bible ):
    ...
    def _loadBookMP( self, BBB_Filename_tuple ):
        ...
        """
        if BibleOrgSysGlobals.verbosityLevel > 3: print( t("loadBookMP( {} )").format( BBB_Filename_tuple ) )
        ...
        if self.maximumPossibleFilenameTuples:
            if BibleOrgSysGlobals.maxProcesses > 1: # Load all the books as quickly as possible
                ...
                if BibleOrgSysGlobals.verbosityLevel > 1:
                    print( t("Loading {} USFM books using {} CPUs...").format( len(self.maximumPossibleFilenameTuples), BibleOrgSysGlobals.maxProcesses ) )
